    ...
    jQuery(document).ready(function () {
        ...
        ********************************/
        jQuery(document).on('click', '.mobile-nav-controller', function () {
            jQuery('#mobile-menu').slideFadeToggle("slow");
        });
         jQuery(document).on('click', '#mostrar', function () {
            jQuery('#conteudo').slideFadeToggle("slow");
        });

          jQuery(document).on('click', '.saibamais', function () {
            jQuery('.depoimento').slideFadeToggle("slow");
        });
          
           jQuery(document).on('click', '.saiba', function () {
            jQuery('.aquila').slideFadeToggle("slow");
        });

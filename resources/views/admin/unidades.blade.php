    ...
    function carregar(){
        table = $('#tabela').DataTable({
            ...
            columns: [
                ...
                {data: 'unidade_status', width: "80px", className: 'dt-body-center dt-head-center',
    ...
    function consultar(id){
        request = $.ajax({
            ...
            success: function(data, textStatus, xhr){
                ...
                $('#formEditar select[name="unidade_status"] option[value="'+data.unidade_status+'"]').prop("selected", true);
            },

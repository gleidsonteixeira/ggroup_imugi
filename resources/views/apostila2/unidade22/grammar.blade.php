    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade22" data-etapa="grammar">
            ...
            <table class="metade left-align">
                <tr>
                    <td>
                        <h5 class="barlow">CAN</h5>
                    </td>
                    <td>
                        <p>Used to express the general idea of <b>possibility and present ability</b></p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <h5 class="barlow">COULD</h5>
                    </td>
                    <td>
                        <p>Used to express the idea of <b>remote possibility and ability in the past.</b></b></p>
                    </td>
                </tr>
            </table>
            ...
            <table class="metade center-align">
                ...
                <tr>
                    <td>
                        <p>I<b> can draw</b> very well</p>
                    </td>
                    <td>
                        <p>I<b> could sing</b> when I was younger.</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p>In NY<b> you can go</b> to central park.</p>
                    </td>
                    <td>
                        <p>You<b> could visit</b> many good friends.</p>
                    </td>
                </tr>
            </table>

    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade3" data-etapa="grammar">
            ...
            <table class="metade center-align">
                <tr>
                    <td colspan="2">
                        <h5 class="barlow">HE – SHE – IT (3rd person) (+)</h5>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td colspan="2">
                        <h5 class="barlow">HAS</h5>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <p>For (-) and (?) use <b>DOES</b>.</p>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <p>(+) She studies Vusual Art.</p>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <p>(?) <b>Does</b> she study Visual Art?</p>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <p>(-) She <b>does</b> not study Visual Art.</p>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <p>*does + not = <b>doesn’t</b></p>
                    </td>
                </tr>
            </table>
            ...
            <table class="metade center-align" style="margin-top:16px">
                <tr>
                    <td></td>
                    <td>
                        <h5 class="barlow">BEFORE VOWEL SOUND</p>
                    </td>
                    <td>
                        <h5 class="barlow">BEFORE VOWEL SOUND</p>
                    </td>
            ...
            <table class="metade center-align barlow bordered">
                <tr class="bordered">
                    <td></td>
                    <td colspan="2">
                        <h5 class="barlow">Monday</h5>
                    </td>
                    <td colspan="2">
                        <h5 class="barlow">Tuesday</h5>
                    </td>
                    <td colspan="2">
                        <h5 class="barlow">Wednesday</h5>
                    </td>
                    <td colspan="2">
                        <h5 class="barlow">Thursday</h5>
                    </td>
                    <td colspan="2">
                        <h5 class="barlow">Friday</h5>
                    </td>
                </tr>
                <tr class="bordered">
                    <td>
                        <h5 class="barlow"><b>ACTIONS<b></h5>
                    </td>
                    <td>
                        <p>Tom</p>
                    </td>
                ...
                <tr class="bordered">
                    <td>
                        <h5 class="barlow">Watch anime</h5>
                    </td>
                    <td>
                        <p></p>
                    </td>
                ...
                <tr class="bordered">
                    <td>
                        <h5 class="barlow">Read Comic Books</h5>
                    </td>
                    <td>
                        <p></p>
                    </td>
                ...
                <tr class="bordered">
                    <td>
                        <h5 class="barlow">Play video games</h5>
                    </td>
                    <td>
                        <p>*</p>
                    </td>
                ...
                <tr class="bordered">
                    <td>
                        <h5 class="barlow">Study new tool</h5>
                    </td>
                    <td>
                        <p></p>
                    </td>
                ...
                <tr class="bordered">
                    <td>
                        <h5 class="barlow">Listen to music</h5>
                    </td>
                    <td>
                        <p></p>
                    </td>
                ...
                <tr class="bordered">
                    <td>
                        <h5 class="barlow">Go to workshops</h5>
                    </td>
                    <td>
                        <p></p>
                    </td>

...
@section('titulo','Unit 35 | Grammar')
@section('conteudo')
<!-- WRAPPER ALL -->
    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade35" data-etapa="grammar">
            ...
            <audio controls="" controlslist="nodownload" class="suave">
                <source src="{{ asset('assets/audio/apostila2/UNIT 35/3. GRAMMAR/GRAMMAR.ogg') }}" type="audio/ogg">
            </audio>
            <div class="clear"></div>
            ...
            <table class="metade center-align">
                <tr>
                    <td>
                        <h5 class="barlow">TO BE SUPPOSED TO</h5>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p>Doctors <b>are supposed to</b> take care of their patients</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p><b>I´m supposed to be</b> in the client´s office before 10 am.</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p>Cinema 4D <b>is supposed to be</b> very efficient for making animations.</p>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <p>(+) We <b>are supposed to</b> watch as many animations as we can</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p>(-) We <b>are not supposed to watch</b> as many animations as we can.</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p>(?) <b>Are</b> we <b>supposed to watch</b> as many animations as we can?</p>
                    </td>
                </tr>
            </table>
            <br>

...
<main>
    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade4" data-etapa="grammar">
            <h3 class="barlow">UNIT 4</h3>
            <h5 class="barlow">3 – GRAMMAR</h5>

            <span class="play-audio">( Aperte o play )</span>
            <audio controls="" controlslist="nodownload" class="suave">
                <source src="{{ asset('assets/audio/apostila2/UNIT 4/3. GRAMMAR/GRAMMAR.ogg') }}" type="audio/ogg">
            </audio>
            <div class="clear"></div>
            ...
            <table class="center-align metade">
                <tr>
                    ...
                    <td>
                        <h5 class="barlow">Object Pronoun</h5>
                    </td>
                </tr>
                <tr>
                    <td>
            ...
            <table class="center-align metade">
                ...
                <tr>
                    <td>
                        <p><b>Turn on</b> the computer.</p>
                    </td>
                    <td>
                        <p><b>Don´t Turn on</b> the computer.</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p><b>Changer</b> the font.</p>
                    </td>
                    <td>
                        <p><b>Don´t Changer</b> the font.</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p><b>Open</b> the file.</p>
                    </td>
                    <td>
                        <p><b>Don´t open</b> the file.</p>
                    </td>
                </tr>

...
@section('titulo','Unit 42 | Grammar')
@section('conteudo')
<!-- WRAPPER ALL -->
    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade42" data-etapa="grammar">
            ...
            <audio controls="" controlslist="nodownload" class="suave">
                <source src="{{ asset('assets/audio/apostila2/UNIT 42/3. GRAMMAR/GRAMMAR.ogg') }}" type="audio/ogg">
            </audio>
            <div class="clear"></div>
            ...
            <figure class="esquerda metade">
                <img src="{{ asset('assets/img/dominating/unit42/grammar1.png') }}" alt="Garotos festejando">
            </figure>
            <figure class="direita metade">
                <img src="{{ asset('assets/img/dominating/unit42/grammar2.png') }}" alt="Garotos festejando">
            </figure>
            <div class="clear"></div>

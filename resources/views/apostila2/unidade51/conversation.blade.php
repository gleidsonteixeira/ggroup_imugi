...
@section('titulo','Unit 51 | Conversation')
@section('conteudo')
<!-- WRAPPER ALL -->
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade51" data-etapa="conversation">
			...
			<audio controls="" controlslist="nodownload" class="suave">
				<source src="{{ asset('assets/audio/apostila2/UNIT 51/2. CONVERSATION/CONVERSATION.ogg') }}" type="audio/ogg">
			</audio>
			...
			<div style="margin-top: 36px">
				<figure>
					<img src="{{ asset('assets/img/dominating/unit51/conversation.png') }}" alt="Home office">
				</figure>
			</div>
		</div>
	</div>

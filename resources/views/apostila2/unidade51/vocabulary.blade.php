...
@section('titulo','Unit 51 | Vocabulary')
@section('conteudo')
<!-- WRAPPER ALL -->
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade51" data-etapa="vocabulary">
			...
			<audio controls="" controlslist="nodownload" class="suave">
				<source src="{{ asset('assets/audio/apostila2/UNIT 51/1. VOCABULARY/1. VOCABULARY.ogg') }}" type="audio/ogg">
			</audio>
			<h5 class="barlow" style="margin-top: 16px">A - WORDS AND EXPRESSIONS</h5>
			<div class="espacamento">
				<p><b>TO AGREE </b>/ with something / with somebody / to do something</p>
				<p><b>TO KNOW </b>/ a person /something / by heart</p>
				<p><b>TO NEED </b>/ help / attention / to do something</p>
			</div>
			...
			<audio controls="" controlslist="nodownload" class="suave">
				<source src="{{ asset('assets/audio/apostila2/UNIT 51/1. VOCABULARY/2. VOCABULARY.ogg') }}" type="audio/ogg">
			</audio>

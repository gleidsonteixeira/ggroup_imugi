    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila3" data-unidade="unidade10" data-etapa="grammar">
            ...
            <audio controls="" controlslist="nodownload" class="suave">
                <source src="{{ asset('assets/audio/apostila3/LESSON 10/03_GRAMMAR/GRAMMAR_10.mp3') }}" type="audio/mp3">
            </audio>
            <div class="clear"></div>
            ...
            <p>
                <b>YES/NO question</b> – Questions aimed at checking simple information. The answer can
                be YES or NO, followed or not by extra information.
            </p>
            <table class="espacamento left-align bordered" style="margin-top:32px;">
                <tr>
                    <td><h5 class="barlow center-align">Verb Tense</h5></td>
            ...
            <p style="margin-top:32px"><b>CONTENT Questions</b> - Questions aimed at getting as much information as you can
            ...
            <table class="espacamento left-align bordered" style="margin-top:32px;">
                <tr>
                    <td><h5 class="barlow center-align">Wh-word</h5></td>
                    <td><h5 class="barlow center-align">Questions about …</h5></td>
                    <td><h5 class="barlow center-align">Examples</h5></td>
                </tr>
                <tr class="bordered">
                    <td><p>What</p></td>
                ...
                <tr class="bordered">
                    ...
                    you going to buy this computer? </p></td>
                </tr>
                <tr class="bordered">
                    <td><p>Which</p></td>
            ...
            <table class="espacamento left-align bordered" style="margin-top:32px;">
                <tr>
                    <td><h5 class="barlow center-align">WH-expression</h5></td>
                    <td><h5 class="barlow center-align">Questions about …</h5></td>
                    <td><h5 class="barlow center-align">Examples</h5></td>
                </tr>
                <tr class="bordered">
            ...
            <h5 class="barlow">1 – Making good questions.</h5>
            <p><b>Question 1</b></p>
            <ul class="lista-inline">
                <li><p>A - How often do you</p></li>
                <li><p>B - How often do you</p></li>
            ...
            <ul class="lista-inline">
                ...
                <li><p>B - What Shirley and Dana is</p></li>
            ...
            <ul class="lista-inline">
                ...
                <li><p>B - What your mother was</p></li>
            ...
            <p><b>Question 5</b></p>
            <ul class="lista-inline">
                <li><p>A - How much countries you</p></li>
                <li><p>B - How many countries Have you</p></li>
                <li><p>C - What countries you have</p></li>
            </ul>
            <form id= "unidade10grammar556" method="post">
                ...
                <p>“Four - Mexico, Argentina, Uruguay, and Chile.”</p>
                <input type="hidden" name="_token" value="{{csrf_token()}}">
                <input type="hidden" name="resposta_id" value="0">
                <input type="hidden" name="unidade_id" value="10">
            ...
            <p><b>Question 6</b></p>
            <ul class="lista-inline">
                <li><p>A - Where are you</p></li>
                <li><p>B - When you will</p></li>
                <li><p>C - When will you</p></li>
            </ul>
            ...
            <p><b>Question 7</b></p>
            <ul class="lista-inline">
                <li><p>A - Where are we</p></li>
                <li><p>B - Where we</p></li>
                <li><p>C - Where will we</p></li>
            </ul>
            ...
            <p><b>Question 8</b></p>
            <ul class="lista-inline">
                <li><p>A - Why someone</p></li>
                <li><p>B - Why would anyone</p></li>
                <li><p>C - Why anyone does</p></li>
            </ul>
            ...
            <div style="margin-top:36px">
				<figure>
					<img src="{{ asset('assets/img/masteroflanguage/unit10/grammar.jpg') }}" alt="conversa">
				</figure>
            </div>
            <div class="clear"></div>
            <h5 class="barlow" style="margin-top:32px">2 - In pairs or trios, pretend you are going to interview a famous Youtuber. Prepare a
            questionnaire with 5 yes/no questions and 5 Content questions. Be ready to answer some

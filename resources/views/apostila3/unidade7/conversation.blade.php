	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila3" data-unidade="unidade7" data-etapa="conversation">
			...
			<audio controls="" controlslist="nodownload" class="suave">
                <source src="{{ asset('assets/audio/apostila3/LESSON 07/02_CONVERSATION/CONVERSATION_07.mp3') }}" type="audio/mp3">
            </audio>
			<div class="clear"></div>
			...
			<figure class="metade esquerda">
				<img src="{{ asset('assets/img/masteroflanguage/unit7/conversation1.png') }}" alt="ronaldinho gaucho">
			</figure>
			<figure class="metade direita">
				<img src="{{ asset('assets/img/masteroflanguage/unit7/conversation2.png') }}" alt="Elon musk">
			</figure>
		</div>
	</div>
</main>

...
@section('titulo','Unit 07 | Grammar')
@section('conteudo')
<!-- WRAPPER ALL -->
...
<main>
    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila3" data-unidade="unidade7" data-etapa="grammar">
            <h3 class="barlow">UNIT 7 </h3>
            <h5 class="barlow">3 - GRAMAR</h5>
            <span class="play-audio">( Aperte o play )</span>
            <audio controls="" controlslist="nodownload" class="suave">
                <source src="{{ asset('assets/audio/apostila3/LESSON 07/03_GRAMMAR/GRAMMAR_07.mp3') }}" type="audio/mp3">
            </audio>
            <div class="clear"></div>
            ...
            <table class="espacamento center-align bordered" style="margin-top:32px;">
                ...
                <tr class="bordered center-align">
                    <td><p>Past continuous</p></td>
                    <td><p>A progressive action in the past.</p></td>
                    <td><p>Akira, was preparing the content for his blog on movie making.</p></td>
                </tr>
                <tr class="bordered center-align">
                    <td><p>Used to</p></td>
                ...
                <tr class="bordered center-align">
                    ...
                    <td><p>An action that happened in an indefinite time in the past and that affects our present in a relevance or continuity context.</p></td>
                    <td><p>The new software have boosted movies quality lately.</p></td>
                </tr>
                <tr class="bordered center-align">
                    <td><p>Past Perfect</p></td>
                    <td><p>An action that happened in a specific time in the past, before some other action in the past.</p></td>
            ...
            <form id="unidade7grammar531" method="post">
                ...
                <input type="hidden" name="atividade_id" value="531">
                <div class="clear"></div>
            ...
            <form id="unidade7grammar532" method="post">
                ...
                <input type="hidden" name="resposta_id" value="0">
                <input type="hidden" name="unidade_id" value="7">
                <input type="hidden" name="atividade_id" value="532">
                <div class="clear"></div>
                <button type="submit" class="mini-title suave click suave">Salvar resposta</button>
            </form>
            ...
            <form id="unidade7grammar533" method="post">
                ...
                <input type="hidden" name="resposta_id" value="0">
                <input type="hidden" name="unidade_id" value="7">
                <input type="hidden" name="atividade_id" value="533">
                <div class="clear"></div>
                <button type="submit" class="mini-title suave click suave">Salvar resposta</button>
            </form>
        </div>
...
<script>
    ...
    $("#unidade7grammar531").submit(function(e){
            e.preventDefault();
            $(this).find('button').prop('disabled', true);
            var respostas = '{';
            $('#unidade7grammar531 input[type="text"]').each(function(index){
                if(($('#unidade7grammar531 input[type="text"]').length - 1) == index){
                    respostas += '"'+$(this).attr("name")+'":"'+$(this).val()+'"}';
                }else{
                    respostas += '"'+$(this).attr("name")+'":"'+$(this).val()+'",';
                }
            });
            if($('#unidade7grammar531 input[name="resposta_id"').val() != 0){
                atualizarAtividade($('#unidade7grammar531'), respostas);
            }else{
                enviarAtividade($('#unidade7grammar531'), respostas);
            }
        });
    $("#unidade7grammar532").submit(function(e){
            e.preventDefault();
            $(this).find('button').prop('disabled', true);
            var respostas = '{';
            $('#unidade7grammar532 input[type="text"]').each(function(index){
                if(($('#unidade7grammar532 input[type="text"]').length - 1) == index){
                    respostas += '"'+$(this).attr("name")+'":"'+$(this).val()+'"}';
                }else{
                    respostas += '"'+$(this).attr("name")+'":"'+$(this).val()+'",';
                }
            });
            if($('#unidade7grammar532 input[name="resposta_id"').val() != 0){
                atualizarAtividade($('#unidade7grammar532'), respostas);
            }else{
                enviarAtividade($('#unidade7grammar532'), respostas);
            }
        });
    $("#unidade7grammar533").submit(function(e){
            e.preventDefault();
            $(this).find('button').prop('disabled', true);
            var respostas = '{';
            $('#unidade7grammar533 input[type="text"]').each(function(index){
                if(($('#unidade7grammar533 input[type="text"]').length - 1) == index){
                    respostas += '"'+$(this).attr("name")+'":"'+$(this).val()+'"}';
                }else{
                    respostas += '"'+$(this).attr("name")+'":"'+$(this).val()+'",';
                }
            });
            if($('#unidade7grammar533 input[name="resposta_id"').val() != 0){
                atualizarAtividade($('#unidade7grammar533'), respostas);
            }else{
                enviarAtividade($('#unidade7grammar533'), respostas);
            }
        });
        ...
        request.done(function(response) {
            if (response == 0) {
                ...
                for (j = 0; j < respostas.length; j++) {
                    $('#unidade7grammar' + atividade_id + ' textarea[name="' + chaves[j] + '"]').val(respostas[j]);
                    $('#unidade7grammar' + atividade_id + ' textarea[name="' + chaves[j] + '"]').attr("value", respostas[j]);

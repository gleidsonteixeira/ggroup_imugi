		...
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade1" data-etapa="sistema_informacao">
			...
			<div>
                <figure class="otimizarimagem">
                    <img src="{{ asset('assets/img/games_and_animation/unit1/imagem_unit1_04.png') }}" alt="guia4">
                </figure>
			</div>
			<br>
			<h5>Plugins</h5>
			...
			<div>
                <figure class="caixa2">
                    <img src="{{ asset('assets/img/games_and_animation/unit1/imagem_unit1_05.png') }}" alt="guia5">
                </figure>
			</div>
			<br>
        </div>

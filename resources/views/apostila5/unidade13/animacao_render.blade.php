...
@section('titulo','Unit 13 | Animação para render')
@section('conteudo')
<!-- WRAPPER ALL -->
		...
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade13" data-etapa="animacao_render">
			...
			<div class="container">
				...
				<div class="tresquarto direita">
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit13/imagem_unit13_1.png') }}" alt="guia1">
					</figure>
				</div>
			</div>
			<div class="clear"></div>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit13/imagem_unit13_2.png') }}" alt="guia2">
				</figure>
			</div>
			<p>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit13/imagem_unit13_3.png') }}" alt="guia3">
				</figure>
			</div>
			<p>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit13/imagem_unit13_4.png') }}" alt="guia4">
				</figure>
			</div>
			<div class="clear"></div>
			<div class="tresquarto esquerda">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit13/imagem_unit13_5.png') }}" alt="guia5">
				</figure>
			</div>

...
@section('titulo','Unit 15 | Simulação de materiais')
@section('conteudo')
<!-- WRAPPER ALL -->
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade15" data-etapa="simulacao_materiais">
			...
			<div class="tresquarto esquerda">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit15/imagem_unit15_1.png') }}" alt="guia1">
				</figure>
			</div>
			...
			<div>
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit15/imagem_unit15_2.png') }}" alt="guia2">
				</figure>
			</div>
			<p>
			...
			<div>
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit15/imagem_unit15_3.png') }}" alt="guia3">
				</figure>
			</div>
			<p>

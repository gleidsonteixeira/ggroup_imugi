...
@section('titulo','Unit 18 | Animação e render - Renderização')
@section('conteudo')
<!-- WRAPPER ALL -->
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade18" data-etapa="renderizacao">
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit18/imagem_unit18_1.png') }}" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit18/imagem_unit18_2.png') }}" alt="guia2">
				</figure>
			</div>
			<p>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit18/imagem_unit18_3.png') }}" alt="guia3">
				</figure>
			</div>
			<p>

	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade2" data-etapa="apresentacao">
			...
			<div class="container">
				...
				<div>
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit2/imagem_unit2_06.png') }}" alt="guia6">
					</figure>
				</div>
				<p>Uma timeline com todas as opções decorrentes com zoon independente localizada na base da janela.</p>
				<div>
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit2/imagem_unit2_07.png') }}" alt="guia7">
					</figure>
				</div>
				<p>Painel de propriedades permitindo acesso rápido as configurações avançadas do objeto	selecionado.</p>
				<div>
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit2/imagem_unit2_08.png') }}" alt="guia8">
					</figure>
				</div>
				<p>Painel de objetos no canto direito superior da janela facilitando o acesso a bibliotecas	e presets.</p>
				<div>
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit2/imagem_unit2_09.png') }}" alt="guia9">
					</figure>
				</div>
			</div>
		</div>

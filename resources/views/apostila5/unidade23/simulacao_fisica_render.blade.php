...
@section('titulo','Unit 23 | Simulação, físicas e render')
@section('conteudo')
<!-- WRAPPER ALL -->
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade23" data-etapa="simulacao_fisica_render">
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit23/imagem_unit23_1.png') }}" alt="guia1">
				</figure>
			</div>
			<p>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit23/imagem_unit23_2.png') }}" alt="guia2">
				</figure>
			</div>
			<p>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit23/imagem_unit23_3.png') }}" alt="guia3">
				</figure>
			</div>
			<p>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit23/imagem_unit23_4.png') }}" alt="guia4">
				</figure>
			</div>
			<p>

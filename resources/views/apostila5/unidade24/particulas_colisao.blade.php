...
@section('titulo','Unit 24 | Camera passiva')
@section('conteudo')
<!-- WRAPPER ALL -->
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade24" data-etapa="particulas_colisao">
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit24/imagem_unit24_1.png') }}" alt="guia1">
				</figure>
			</div>
			<p>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit24/imagem_unit24_2.png') }}" alt="guia2">
				</figure>
			</div>
			<p>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit24/imagem_unit24_3.png') }}" alt="guia3">
				</figure>
			</div>
			<p>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit24/imagem_unit24_4.png') }}" alt="guia4">
				</figure>
			</div>
			<p>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit24/imagem_unit24_5.png') }}" alt="guia5">
				</figure>
			</div>
			<p>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit24/imagem_unit24_6.png') }}" alt="guia6">
				</figure>
			</div>
			<p>

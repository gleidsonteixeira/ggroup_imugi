...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade26" data-etapa="maping">
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit26/imagem_unit26_1.png') }}" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit26/imagem_unit26_2.png') }}" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit26/imagem_unit26_3.png') }}" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit26/imagem_unit26_4.png') }}" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit26/imagem_unit26_5.png') }}" alt="guia1">
				</figure>
			</div>

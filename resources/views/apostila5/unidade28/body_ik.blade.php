...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade28" data-etapa="body_ik">
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit28/imagem_unit28_1.png') }}" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit28/imagem_unit28_2.png') }}" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit28/imagem_unit28_3.png') }}" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit28/imagem_unit28_4.png') }}" alt="guia1">
				</figure>
			</div>

...
@section('titulo','Unit 31 | Player Modeling')
@section('conteudo')
<!-- WRAPPER ALL -->
		...
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade31" data-etapa="player_modeling">
			...
			<h5 class="barlow upper">Aula 31 – Player Modeling</h5>
				<div class="container">
							...
							<figure>
								<img src="{{ asset('assets/img/games_and_animation/unit31/imagem_unit31_1.png') }}" alt="guia1">
							</figure>
				</div>
				<div class="container">
					<h5>Estilos</h5>
					...
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit31/imagem_unit31_2.png') }}" alt="guia2">
					</figure>
					...
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit31/imagem_unit31_3.png') }}" alt="guia3">
					</figure>
				</div>
				<div class="container">
					<h5>Steam punk</h5>
					<p>É muito mais um conceito do que um estlo de personagem, a forma humana sendo
								...
								personagem.</p>
					<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit31/imagem_unit31_4.png') }}" alt="guia4">
					</figure>
				</div>
				<div class="container">
					...
					<figure>
					<img src="{{ asset('assets/img/games_and_animation/unit31/imagem_unit31_5.png') }}" alt="guia5">
					</figure>
				</div>
			</div>
    </div>

...
@section('titulo','Unit 5 | Model Mode')
@section('conteudo')
<!-- WRAPPER ALL -->
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade5" data-etapa="model_mode">
			...
			<div class="container">
				...
				<div>
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit5/imagem_unit5_02.png') }}" alt="guia2">
					</figure>
				</div>
				<div class="clear"></div>
				<div class="elemento2">
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit5/imagem_unit5_03.png') }}" alt="guia3">
					</figure>
				</div>
				<div class="elemento">
					<p>
				...
				<div>
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit5/imagem_unit5_04.png') }}" alt="guia4">
					</figure>
				</div>
				<div class="clear"></div>
				<div>
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit5/imagem_unit5_05.png') }}" alt="guia5">
					</figure>
				</div>
				<div class="elemento2">
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit5/imagem_unit5_06.png') }}" alt="guia6">
					</figure>
				</div>
				<div class="elemento">
					<p>

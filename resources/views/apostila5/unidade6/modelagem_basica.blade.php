...
@section('titulo','Unit 6 | Modelagem Básica')
@section('conteudo')
<!-- WRAPPER ALL -->
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade6" data-etapa="modelagem_basica">
			...
			<div class="container">
				...
				<div>
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit6/imagem_unit6_01.png') }}" alt="guia1">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit6/imagem_unit6_02.png') }}" alt="guia2">
					</figure>
				</div>
				<div>
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit6/imagem_unit6_03.png') }}" alt="guia3">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit6/imagem_unit6_04.png') }}" alt="guia4">
					</figure>
				</div>
				<p>

...
@section('titulo','Unit 9 | Desenho técnico')
@section('conteudo')
<!-- WRAPPER ALL -->
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade9" data-etapa="apresentacao">
			...
			<div class="container">
				...
				<div>
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit9/imagem_unit9_01.png') }}" alt="guia1">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit9/imagem_unit9_02.png') }}" alt="guia2">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit9/imagem_unit9_03.png') }}" alt="guia3">
					</figure>
				</div>
				...
				<div>
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit9/imagem_unit9_04.png') }}" alt="guia4">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit9/imagem_unit9_05.png') }}" alt="guia5">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit9/imagem_unit9_06.png') }}" alt="guia6">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit9/imagem_unit9_07.png') }}" alt="guia7">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit9/imagem_unit9_08.png') }}" alt="guia8">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit9/imagem_unit9_09.png') }}" alt="guia9">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="{{ asset('assets/img/games_and_animation/unit9/imagem_unit9_10.png') }}" alt="guia10">
					</figure>
				</div>

...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila6" data-unidade="unidade12" data-etapa="cinema_4d">
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/video_edition/unit12/imagem_unit12_1.png') }}" alt="guia1">
				</figure>
			</div>
			<p>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/video_edition/unit12/imagem_unit12_2.png') }}" alt="guia1">
				</figure>
			</div>

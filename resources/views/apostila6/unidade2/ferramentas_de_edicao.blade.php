...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila6" data-unidade="unidade2" data-etapa="ferramentas_de_edicao">
			...
			<h5>
				Slip Edit
				<img style="display: inline-block;" src="{{ asset('assets/img/video_edition/unit2/imagem_unit2_37.png') }}" alt="guia"> 
			</h5>

			<div class="container">
				<figure>
				<img src="{{ asset('assets/img/video_edition/unit2/imagem_unit2_38.png') }}" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
				<img src="{{ asset('assets/img/video_edition/unit2/imagem_unit2_39.png') }}" alt="guia1">
				</figure>
			</div>

			<h5>
				Slide Edit
				<img style="display: inline-block;" src="{{ asset('assets/img/video_edition/unit2/imagem_unit2_40.png') }}" alt="guia"> 
			</h5>

			<div class="container">
				<figure>
				<img src="{{ asset('assets/img/video_edition/unit2/imagem_unit2_41.png') }}" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/video_edition/unit2/imagem_unit2_42.png') }}" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/video_edition/unit2/imagem_unit2_43.png') }}" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/video_edition/unit2/imagem_unit2_44.png') }}" alt="guia1">
				</figure>
			</div>

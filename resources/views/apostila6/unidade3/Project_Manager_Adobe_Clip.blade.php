...
@section('titulo','Unit 3 | Project Manager e Adobe Clip')
@section('conteudo')
<!-- WRAPPER ALL -->
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila6" data-unidade="unidade3" data-etapa="Project_Manager_Adobe_Clip">
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/video_edition/unit3/imagem_unit3_9.png') }}" alt="L – Cut">
				</figure>
			</div><br>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/video_edition/unit3/imagem_unit3_10.png') }}" alt="L – Cut">
				</figure>
			</div><br>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/video_edition/unit3/imagem_unit3_11.png') }}" alt="L – Cut">
				</figure>
			</div><br>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/video_edition/unit3/imagem_unit3_12.png') }}" alt="L – Cut">
				</figure>
			</div><br>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/video_edition/unit3/imagem_unit3_13.png') }}" alt="L – Cut">
				</figure>
			</div><br>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/video_edition/unit3/imagem_unit3_14.png') }}" alt="L – Cut">
				</figure>
			</div><br>

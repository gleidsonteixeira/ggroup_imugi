...
@section('titulo','Unit 5 |  Exportação de Arquivos')
@section('conteudo')
<!-- WRAPPER ALL -->
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila6" data-unidade="unidade5" data-etapa="exportacao_arquivos">
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/video_edition/unit5/imagem_unit5_1.png') }}" alt="guia1">
				</figure>
			</div>
			<p>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/video_edition/unit5/imagem_unit5_2.png') }}" alt="guia1">
				</figure>
			</div>
			<p>
			...
			<div class="container">
				<figure>
					<img src="{{ asset('assets/img/video_edition/unit5/imagem_unit5_3.png') }}" alt="guia1">
				</figure>
			</div>
			<p>
				...
				Para concluir a exportação, basta clicar no botão Start Queue
				 <span style="display: inline-block"><img src="{{ asset('assets/img/video_edition/unit5/imagem_unit5_4.png') }}" alt="guia1"></span>
			</p>

...
<main>
	...
	<div class="dashboard">
		...
		<p>Caixa de diálogo Create Multi-Camera Source Sequence</p>
			<div class="container">
					<figure>
							<img src="{{ asset('assets/img/video_edition/unit5/imagem_unit5_5.png') }}" alt="guia1">
					</figure>
			</div>
			...
			<div class="container">
					<figure>
							<img src="{{ asset('assets/img/video_edition/unit5/imagem_unit5_6.png') }}" alt="guia1">
					</figure>
			</div>
			<p>
			...
			<p>
				...
				<div class="container">
					<figure>
							<img src="{{ asset('assets/img/video_edition/unit5/imagem_unit5_7.png') }}" alt="guia1">
					</figure>
			</div>
		</div>
    </div>

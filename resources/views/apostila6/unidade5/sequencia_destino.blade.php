...
@section('titulo','Unit 5 |  Multicamera e Estabilização')
@section('conteudo')
<!-- WRAPPER ALL -->
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila6" data-unidade="unidade5" data-etapa="sequencia_destino">
			...
			<div class="container">
					<figure>
							<img src="{{ asset('assets/img/video_edition/unit5/imagem_unit5_8.png') }}" alt="guia1">
					</figure>
			</div>
			<div class="container">
					<figure>
							<img src="{{ asset('assets/img/video_edition/unit5/imagem_unit5_9.png') }}" alt="guia1">
					</figure>
			</div>
			...
			<ul class="unidade_6_5">
				...
				<p>
					...
					<div class="container">
					<figure>
							<img src="{{ asset('assets/img/video_edition/unit5/imagem_unit5_10.png') }}" alt="guia1">
					</figure>
			</div>
				<div class="container">
					<figure>
							<img src="{{ asset('assets/img/video_edition/unit5/imagem_unit5_11.png') }}" alt="guia1">
					</figure>
			</div>
				...
				<p>Depois que o efeito é adicionado, a análise do clipe começa imediatamente em segundo plano. Quando a análise começa, o primeiro de dois banners é exibido no painel Projeto, indicando que a análise está sendo executada. Quando a análise é concluída, o segundo banner exibe
					...
					<div class="container">
						<figure>
								<img src="{{ asset('assets/img/video_edition/unit5/imagem_unit5_12.png') }}" alt="guia1">
						</figure>
					</div>
				<p>
					...
					<div class="container">
						<figure>
								<img src="{{ asset('assets/img/video_edition/unit5/imagem_unit5_13.png') }}" alt="guia1">
						</figure>
					</div>
			<h5>Mercalli V4</h5>
			...
			<div class="container">
					<figure>
							<img src="{{ asset('assets/img/video_edition/unit5/imagem_unit5_14.png') }}" alt="guia1">
					</figure>
				</div>
				<h5>ATIVIDADES</h5>
				<ol class="unidade_6_5">

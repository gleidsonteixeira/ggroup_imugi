                                    ...
                                    <div style="margin-top:80px;">
                                        ...
                                        <form method="POST" action="{{ route('register') }}">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-12">
                                                        <input id="matricula" type="text" class="form-control bg-transparent text-white border-color-medium-dark-gray medium-input @error('matricula') is-invalid @enderror" name="matricula" value="{{ old('matricula') }}" 
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-12">
                                                        <input id="name" type="text" class="form-control bg-transparent text-white border-color-medium-dark-gray medium-input @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" 
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-12">
                                                        <input id="password" type="password" class="form-control bg-transparent text-white border-color-medium-dark-gray medium-input @error('password') is-invalid @enderror" name="password" 
                                        ...
                                        <br>
                                        <span class="mt-4 mostrar">Já possue conta? <a href="{{url('login')}}" class="ocultar" style="background:none; border:none; color:#fff;">Login</a> </span>
                                        <br>

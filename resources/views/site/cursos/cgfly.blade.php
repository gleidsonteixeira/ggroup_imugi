...
<section class="wow fadeIn bem_vindo_img"  id="matricula" style="background-image: url({{asset('assets/site/images/bg-curso.png')}}); background-repeat:no-repeat; background-position: center;">
                <div class="container">
...
internacional
        ...
        <section class="p-0 wow fadeIn" style="padding-top:80px!important;">
                <div class="container">
                    <div class="row"> 
                            <div class="col-12 col-lg-6 cover-background md-height-400px wow fadeInRight" style="background-image:url({{asset('assets/site/images/cg.png')}});"></div>

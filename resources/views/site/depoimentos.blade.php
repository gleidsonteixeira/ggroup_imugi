...
<main>
    ...
    <section id="depoimentos-banner">
        ...
        <div class="item" data-aos="fade-right" data-aos-once="true">
            <img src="{{ asset('assets/site/images/aluna-imugi.png') }}" alt="aluna imugi" />
        </div>
    </section>
    ...
    <section id="depoimentos-video">
        ...
        <div class="item">
            <img src="{{ asset('assets/site/images/prev.png') }}" alt="Anterior" class="suave click prev" />
            <ul>
            ...
            <img src="{{ asset('assets/site/images/next.png') }}" alt="Próximo" class="suave click next" />
        </div>
    </section>

...
<main>
    ...
    <section id="unidades-banner">
        <img src="{{ asset('assets/site/images/banner-franqueado.png') }}" alt="Bem-vindo" />
        <div class="content">
            <img src="{{ asset('assets/site/images/logo-franqueado.png') }}" alt="Franqueado" />
    ...
    <section id="franqueado-sec1">
        <div class="item">
            ...
            <div class="content">
                <div>
                    <img src="{{ asset('assets/site/images/franqueado-bg2.png') }}" alt="">
                </div>
                <div>
                    <h3>Franqueado</h3>
        ...
        <div class="imagem">
            <img src="{{ asset('assets/site/images/franqueado-bg.png') }}" alt="">
        </div>
    </section>
    
    <section id="franqueado-sec2">
        <div class="imagem">
            <img src="{{ asset('assets/site/images/franqueado-bg3.png') }}" alt="">
        </div>
        <div class="item">
            ...
            <div class="content">
                ...
                <div>
                    <img src="{{ asset('assets/site/images/franqueado-bg5.png') }}" alt="">
                </div>
            </div>
            <div class="content">
                <div>
                ...
                <div>
                    <img src="{{ asset('assets/site/images/franqueado-bg6.png') }}" alt="">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="franqueado-sec3">
        <div class="item">
            <div class="content">
                <div>
                    <img src="{{ asset('assets/site/images/franqueado-bg9.png') }}" alt="">
                </div>
                <div>
                    <h3>Investimento</h3>
            ...
            <div class="sub-content">
                <div>
                    <img src="{{ asset('assets/site/images/franqueado-bg10.png') }}" alt="">
                </div>
                <div>
        ...
        <div class="imagem">
            <img src="{{ asset('assets/site/images/franqueado-bg8.png') }}" alt="">
        </div>
    </section>
    ...
    <section id="franqueado-royalties">
        <div class="item">
            <div>
                <img src="{{ asset('assets/site/images/franqueado-bg11.png') }}" alt="">
            </div>
            <div>
        ...
        <div class="item">
            <div>
                <img src="{{ asset('assets/site/images/franqueado-bg12.png') }}" alt="">
            </div>
            <div>
    ...
    <section id="franqueado-diferenciais">
        ...
        <ul>
            ...
            <li data-aos="fade-left" data-aos-delay="1200" data-aos-once="true">
                <img src="{{ asset('assets/site/images/diferencial5.png') }}" />

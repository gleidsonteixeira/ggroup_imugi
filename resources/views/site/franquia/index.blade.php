...
<section class="wow fadeIn bg_cota_img"
    style="background-image: url({{asset('assets/site/images/socio-cota.png')}}); background-repeat:no-repeat; background-position: center top;">
    <div class="container">
        <div class="row">
...
<div style="height:80px;"></div>
<section class="wow fadeIn bg_cota_img"
    style="background-image: url({{asset('assets/site/images/bg-modalidade.png')}}); background-repeat:no-repeat; background-size: cover;">
    <div class="container">
        <div class="row">
            <div class="md-margin-50px-bottom sm-margin-30px-bottom">
                <div class="md-no-padding-lr">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12 sm-margin-30px-bottom text-center text-md-left wow fadeInUp last-paragraph-no-margin"
                            ...
                            <div class="row m-0">
                                <div
                                    ...
                                    <img src="{{asset('assets/site/images/icones/previsao_faturamento.png')}}" alt=""
                                        class="mt-4">
                                </div>
                                <div class="col-12 col-lg-9 col-md-8 p-0">
                        ...
                        <div class="col-12 col-md-12 sm-margin-30px-bottom text-center text-md-left wow fadeInUp last-paragraph-no-margin"
                            ...
                            <div class="row m-0">
                                <div
                                    class="col-12 col-lg-2 col-md-4 pl-0 sm-no-padding-lr float-left sm-margin-15px-bottom">
                                    <img src="{{asset('assets/site/images/icones/faturamento.png')}}" alt=""
                                        class="mt-4">
                                </div>
                                <div class="col-12 col-lg-9 col-md-8 p-0">
                ...
                <div class="width-75 lg-width-100">
                    <div class="row m-0">
                        <div class="col-12 col-lg-2 col-md-4 pl-0 sm-no-padding-lr float-left sm-margin-15px-bottom">
                            <img src="{{asset('assets/site/images/icones/franqueado-1.png')}}" alt=""
    ...
    <div class="container">
        ...
        <div class="row margin-100px-top md-margin-70px-top sm-margin-50px-top">
            <div class="col-12 col-lg-4 col-md-6  last-paragraph-no-margin wow fadeInUp">
                <div>
                    <div>
                        <img src="{{asset('assets/site/images/razoes/1.png')}}" alt=""
            ...
            <div class="col-12 col-lg-4 col-md-6 last-paragraph-no-margin wow fadeInUp">
                <div>
                    <div>
                        <img src="{{asset('assets/site/images/razoes/2.png')}}" alt=""
                            class="width-40 vantagens_suporte">
                    </div>
                    <div class="post-details">
            ...
            <div class="col-12 col-lg-4 col-md-6  last-paragraph-no-margin wow fadeInUp">
                <div>
                    <div>
                        <img src="{{asset('assets/site/images/razoes/3.png')}}" alt=""
                            class="width-40 vantagens_suporte">
                    </div>
                    <div class="post-details">
        ...
        <div class="row margin-100px-top md-margin-70px-top sm-margin-50px-top">
            <div
                ...
                <div>
                    <div>
                        <img src="{{asset('assets/site/images/razoes/4.png')}}" alt=""
                            class="width-40 vantagens_suporte">
                    </div>
                    <div class="post-details">
            ...
            <div
                ...
                <div>
                    <div>
                        <img src="{{asset('assets/site/images/razoes/6.png')}}" alt=""
                            class="width-40 vantagens_suporte">
                    </div>
                    <div class="post-details">

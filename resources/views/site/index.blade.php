...
<main>
    ...
    <section id="home">
        <img src="{{ asset('assets/site/images/banner-home.png') }}" alt="Bem-vindo" />
        <div class="content">
            <h1>Bem vindo a</h1>
    ...
    <section id="vantagens">
        <div class="item" data-aos="fade-up" data-aos-delay="500" data-aos-once="true">
            <img src="{{ asset('assets/site/images/vantagem-icon1.png') }}" alt="Computação gráfica">
        ...
        <div class="item" data-aos="fade-up" data-aos-delay="700" data-aos-once="true">
            <img src="{{ asset('assets/site/images/vantagem-icon2.png') }}" alt="Inglês">
        ...
        <div class="item" data-aos="fade-up" data-aos-delay="900" data-aos-once="true">
            <img src="{{ asset('assets/site/images/vantagem-icon3.png') }}" alt="Programa aprimorar">
    ...
    <section id="ser-aluno">
        ...
        <div class="item">
            <img src="{{ asset('assets/site/images/vantagens-bg.png') }}" class="bg" alt="bg">
            <img src="{{ asset('assets/site/images/ser-aluno.png') }}" class="icon" alt="icone" data-aos="fade-left" data-aos-once="true">
        </div>
    </section>
    ...
    <section id="cursos">
        ...
        <ul>
            <li data-aos="fade-up" data-aos-delay="500" data-aos-once="true">
                <img class="suave" src="{{ asset('assets/site/images/curso-cgfly.png') }}" alt="CG Fly" />
                <a class="arista suave click" pp="cgfly">saiba mais</a>
            </li>
            <li data-aos="fade-up" data-aos-delay="750" data-aos-once="true">
                <img class="suave" src="{{ asset('assets/site/images/curso-code-block.png') }}" alt="Code Block" />
                <a class="arista suave click" pp="codeblock">saiba mais</a>
            </li>
            <li data-aos="fade-up" data-aos-delay="900" data-aos-once="true">
                <img class="suave" src="{{ asset('assets/site/images/curso-gamer-dev.png') }}" alt="Gamer DEV" />
        ...
        <div class="popup cgfly suave">
            ...
            <div class="content">
                <h5>Curso</h5>
                <img src="{{ asset('assets/site/images/cgfly-logo-color.png') }}" alt="CG Fly">
        ...
        <div class="popup codeblock suave">
            ...
            <div class="content">
                <h5>Curso</h5>
                <img src="{{ asset('assets/site/images/codeblock-logo.png') }}" alt="Code Block">
                <p><b>Aborda as possibilidades espetaculares da criação </b><br>para o mundo da <b>Programação, Game e Robótica</b> <br>desenvolvendo o raciocínio lógico.</p>
            </div>
            <div class="content">
                <a class="suave click popup-cadastro">Quero Agendar minha <span class="arista upper">aula</span></a>
        ...
        <div class="popup gamerdev suave">
            ...
            <div class="content">
                <h5>Curso</h5>
                <img src="{{ asset('assets/site/images/gamerdev-logo-color.png') }}" alt="Gamer Dev">
    ...
    <section id="portal">
        <div class="item video" data-aos="fade-right" data-aos-once="true">
            <img src="{{ asset('assets/site/images/video-bg.jpg') }}" alt="Portal de alunos" />
    ...
    <section id="fp">
        <div class="content">
            ...
            <img src="{{ asset('assets/site/images/centro-logo-fp.png') }}" alt="Centro Autorizado" data-aos="fade-right" data-aos-delay="300" data-aos-once="true" />
        </div>
        <img src="{{ asset('assets/site/images/fp-bg.png') }}" alt="FP" />
    </section>

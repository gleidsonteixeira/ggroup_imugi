...
<?php $__env->startSection('titulo','Unit 10 | Formas Simétricas'); ?>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade10" data-etapa="formas_simetricas">
			...
			<div class="container">
				...
				<div>
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit10/imagem_unit10_1.png')); ?>" alt="guia1">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit10/imagem_unit10_2.png')); ?>" alt="guia2">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit10/imagem_unit10_3.png')); ?>" alt="guia3">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit10/imagem_unit10_4.png')); ?>" alt="guia4">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit10/imagem_unit10_5.png')); ?>" alt="guia5">
					</figure>
				</div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade10/formas_simetricas.blade.php ENDPATH**/ ?>
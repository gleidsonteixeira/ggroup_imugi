...
<?php $__env->startSection('titulo','Unit 4 | Navegação'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade4" data-etapa="navegacao">
			...
			<div>
                <figure>
                    <img src="<?php echo e(asset('assets/img/games_and_animation/unit4/imagem_unit4_01.png')); ?>" alt="guia1">
                </figure>
			</div>
			<p><b>Vamos ao assunto...</b></p>
			<div class="esquerda">
                <figure>
                    <img src="<?php echo e(asset('assets/img/games_and_animation/unit4/imagem_unit4_02.png')); ?>" alt="guia2">
                </figure>
			</div>
			<p class="direita">
			...
			<div>
                <figure>
                    <img src="<?php echo e(asset('assets/img/games_and_animation/unit4/imagem_unit4_03.png')); ?>" alt="guia3">
                </figure>
			</div>
		</div>
    </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade4/navegacao.blade.php ENDPATH**/ ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade21" data-etapa="camera_passiva">
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit21/imagem_unit21_1.png')); ?>" alt="guia1">
				</figure>
			</div>
			<p>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit21/imagem_unit21_2.png')); ?>" alt="guia2">
				</figure>
			</div>
			<p>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit21/imagem_unit21_3.png')); ?>" alt="guia3">
				</figure>
			</div>
			<p><b>Lentes</b></p>
			<p>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit21/imagem_unit21_4.png')); ?>" alt="guia4">
				</figure>
			</div>
			<p><b>Zoom e foco</b></p>
			<p>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade21/camera_passiva.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('titulo','Unit 51 | Grammar'); ?>
    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade51" data-etapa="grammar">
            ...
            <figure class="umterco">
                <img src="<?php echo e(asset('assets/img/dominating/unit51/grammar1.png')); ?>" alt="esporte aereo">
            </figure>
            <figure class="umterco">
                <img src="<?php echo e(asset('assets/img/dominating/unit51/grammar2.png')); ?>" alt="esporte aereo">
            </figure>
            <figure class="umterco">
                <img src="<?php echo e(asset('assets/img/dominating/unit51/grammar3.png')); ?>" alt="esporte aereo">
            </figure>
        </div>
</main>
<script>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila2/unidade51/grammar.blade.php ENDPATH**/ ?>
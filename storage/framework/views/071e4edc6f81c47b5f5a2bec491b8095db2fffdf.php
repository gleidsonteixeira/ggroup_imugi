...
<?php $__env->startSection('titulo','Unit 06 | Conversation'); ?>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila3" data-unidade="unidade6" data-etapa="conversation">
			...
			<audio controls="" controlslist="nodownload" class="suave">
                <source src="<?php echo e(asset('assets/audio/apostila3/LESSON 06/02_CONVERSATION/CONVERSATION_06.mp3')); ?>" type="audio/mp3">
            </audio>
			<div class="clear"></div>
			...
			<div style="margin-top: 36px">
				<figure>
					<img src="<?php echo e(asset('assets/img/masteroflanguage/unit6/conversation.png')); ?>" alt="lousa">
				</figure>
			</div>
		</div>
	</div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila3/unidade6/conversation.blade.php ENDPATH**/ ?>
...
<!-- WRAPPER ALL -->
	...
	<main>
		...
		<div class="dashboard">
			<div id="unidade" class="box" data-apostila="apostila3" data-unidade="unidade2" data-etapa="listening">
				<h3 class="barlow">UNIT 2</h3>
                <h5 class="barlow">5 - LISTENING</h5>
                <span class="play-audio">( Aperte o play )</span>
				<audio controls="" controlslist="nodownload" class="suave">
					<source src="<?php echo e(asset('assets/audio/apostila3/LESSON 02/06_LISTENING/LISTENING_02.mp3')); ?>" type="audio/mp3">
				</audio>
                <div class="clear"></div>
    ...
    <script>
        ...
        $("#unidade2listening507").submit(function(e){
            e.preventDefault();
            $(this).find('button').prop('disabled', true);
            var respostas = '{"'+$('#unidade2listening507 textarea').attr("name")+'":"'+$('#unidade2listening507 textarea').val()+'"}';
            if($('#unidade2listening507 input[name="resposta_id"').val() != 0){
                atualizarAtividade($('#unidade2listening507'), respostas);
            }else{
                enviarAtividade($('#unidade2listening507'), respostas);
            }
        });
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila3/unidade2/listening.blade.php ENDPATH**/ ?>
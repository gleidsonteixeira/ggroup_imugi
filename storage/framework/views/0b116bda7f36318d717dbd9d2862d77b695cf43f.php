...
<?php $__env->startSection('titulo','Unit 17 | Animação engine II Reativos'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade17" data-etapa="animacao_engineReativos">
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit17/imagem_unit17_1.png')); ?>" alt="guia1">
				</figure>
			</div>
			<p>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit17/imagem_unit17_2.png')); ?>" alt="guia1">
				</figure>
			</div>
			<p>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade17/animacao_engineReativos.blade.php ENDPATH**/ ?>
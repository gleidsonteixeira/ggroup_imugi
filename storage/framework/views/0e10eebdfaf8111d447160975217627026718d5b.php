...
<?php $__env->startSection('titulo','Unit 29 | Grammar'); ?>
...
<main>
    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade29" data-etapa="grammar">
            ...
            <figure>
                <img src="<?php echo e(asset('assets/img/dominating/unit29/grammar.png')); ?>" alt="paciente feliz">
            </figure>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila2/unidade29/grammar.blade.php ENDPATH**/ ?>
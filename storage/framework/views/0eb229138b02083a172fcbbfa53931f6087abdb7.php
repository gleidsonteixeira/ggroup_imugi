...
<?php $__env->startSection('titulo','Unit 8 | Visão e Navegação'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade8" data-etapa="visao_navegacao">
			...
			<div>
                <figure>
                    <img src="<?php echo e(asset('assets/img/games_and_animation/unit8/imagem_unit8_01.png')); ?>" alt="guia1">
                </figure>
			</div>
			<p>
			...
			<div>
                <figure>
                    <img src="<?php echo e(asset('assets/img/games_and_animation/unit8/imagem_unit8_02.png')); ?>" alt="guia2">
                </figure>
			</div>
			<p>
			...
			<div>
                <figure>
                    <img src="<?php echo e(asset('assets/img/games_and_animation/unit8/imagem_unit8_03.png')); ?>" alt="guia3">
                </figure>
			</div>
			<p>
			...
			<div>
                <figure>
                    <img src="<?php echo e(asset('assets/img/games_and_animation/unit8/imagem_unit8_04.png')); ?>" alt="guia4">
                </figure>
			</div>
			<p>
			...
			<div>
                <figure>
                    <img src="<?php echo e(asset('assets/img/games_and_animation/unit8/imagem_unit8_05.png')); ?>" alt="guia5">
                </figure>
			</div>
			<p>
			...
			<div>
                <figure>
                    <img src="<?php echo e(asset('assets/img/games_and_animation/unit8/imagem_unit8_06.png')); ?>" alt="guia6">
                </figure>
			</div>
			<p>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade8/visao_navegacao.blade.php ENDPATH**/ ?>
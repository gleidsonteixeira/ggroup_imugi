...
<?php $__env->startSection('titulo','Unit 6 | Atividades'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade6" data-etapa="atividades">
			<h3 class="barlow">UNIT 6</h3>
			<h5 class="barlow upper">Aula 1 – Atividades</h5>
			<form method="post" class="metade">
				<p>1 - Crie os objetos planejando o movimento. Se fizer uma geladeira, um mesh novo deve
					ser usado para cada parte que desejar que seja móvel. 
					<input type="text" class="full left-align" placeholder="Atividade Prática" disabled="true">
				</p>
				<p>2 - Crie objetos compostos por mais de um forma, de preferência com partes móveis.
					<input type="text" class="full left-align" placeholder="Atividade Prática" disabled="true"> 
				</p>
			</form>
        </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade6/atividades.blade.php ENDPATH**/ ?>
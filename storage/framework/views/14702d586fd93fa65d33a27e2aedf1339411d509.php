    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade18" data-etapa="grammar">
            ...
            <figure class="umterco">
                <img src="<?php echo e(asset('assets/img/dominating/unit18/grammar1.png')); ?>" alt="Garotos festejando">
            </figure>
            <figure class="umterco">
                <img src="<?php echo e(asset('assets/img/dominating/unit18/grammar2.png')); ?>" alt="Garotos festejando">
            </figure>
            <figure class="umterco">
                <img src="<?php echo e(asset('assets/img/dominating/unit18/grammar3.png')); ?>" alt="Garotos festejando">
            </figure>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila2/unidade18/grammar.blade.php ENDPATH**/ ?>
<?php $__env->startSection('titulo','Corel Draw | Aula 13 – Estilos e conjuntos de estilos'); ?>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="photoshop-corel" data-unidade="unidade2" data-etapa="aula30">
            ...
            <div class="metade esquerda">
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula13/imagem1.jpg')); ?>" alt="guia" style="width:95%!important;" >
                </figure>
            </div>
            ...
            <div class="clear"></div>
                ...
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula13/imagem2.jpg')); ?>" alt="guia" style="width:75%!important; margin:0 auto;" >
                </figure> 
            <div style="margin-top:16px">
...
<p>Abaixo temos o painel de propriedades e configurações de página e layout</p>
               <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula13/imagem3.jpg')); ?>" alt="guia" style="width:75%!important; margin:0 auto;" >
                </figure>
            </div>
            <div style="margin-top:16px">
            <div class="metade esquerda">
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula13/imagem4.jpg')); ?>" alt="guia" style="width:65%!important;" >
                </figure>
            </div>
            <div class="metade direita">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/corel-draw/aula30.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('titulo','Unit 32 | Atividades'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade32" data-etapa="atividades">
          ...
          <p>2 - Para que as funções de render sejam atvadas eu devo atvar qual modifcador de render?
						<input type="text" name="atividade826-2" class="full left-align" placeholder="Responda aqui" required>
					</p>
					<p>3 - Que tpo de conexão pode ser utlizada para simular uma porta?
						<input type="text" name="atividade826-3" class="full left-align" placeholder="Responda aqui" required>
					</p>
					<p>4 - O que é level designer?
						<input type="text" name="atividade826-4" class="full left-align" placeholder="Responda aqui" required>
					</p>
					<p>5 - Por que a fase é tão importante no jogo?
						<input type="text" name="atividade826-5" class="full left-align" placeholder="Responda aqui" required>
					</p>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade32/atividades.blade.php ENDPATH**/ ?>
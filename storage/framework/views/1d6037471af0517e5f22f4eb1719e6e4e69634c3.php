...
<?php $__env->startSection('titulo','Unit 2 | Aula 04 – Camadas e seleção com a caneta Layers Panel (Painel de camadas)'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila4" data-unidade="unidade2" data-etapa="aula4">
			<h3 class="barlow">UNIT 2</h3>
			<h5 class="barlow upper">Aula 04 – Camadas e seleção com a caneta Layers Panel (Painel de camadas)</h5>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem50.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem51.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem52.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem53.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem54.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem55.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem56.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem57.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem58.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem59.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem60.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem61.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem62.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem63.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem64.PNG')); ?>" alt="guia">
                </figure>
            </div>
            <p>b. No menu principal Layer, escolher a opção New – Layer</p>
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem65.PNG')); ?>" alt="guia">
                </figure>
            </div>
            <p>c. Clicando no botão Creaté New Layer do painel de camadas.</p>
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem66.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem67.PNG')); ?>" alt="guia">
                </figure>
            </div>
            <p>II. Move da barra de ferramentas e habilitando a opção Show Transform Controls.</p>
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem68.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem69.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem70.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            que este não interfira na edição do conteúdo de outra camada. Para bloquear uma camada podemos clicar no ícone do cadeado<img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit2/imagem71.PNG')); ?>" alt="guia"> localizado no painel de camadas.</p>
            <p>Assim, ao tentarmos arrastar o conteúdo de uma camada bloqueada, veremos a seguinte mensagem:</p>
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem72.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            a Pentool (caneta).<img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit2/imagem73.PNG')); ?>" alt="guia"></p>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem74.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem75.PNG')); ?>" alt="guia">
                </figure>
            </div>
            <p>II. Para ligar dois nós basta clicar em outra área que um caminho em linha reta será criado.</p>
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem76.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem77.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem78.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem79.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem80.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem81.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem82.PNG')); ?>" alt="guia">
                </figure>
            </div>
            <p>II. Combinar as teclas CTRL+ENTER.</p>
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem83.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem84.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem85.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem86.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem87.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem88.PNG')); ?>" alt="guia">
                </figure>
            </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/unidade2/aula4.blade.php ENDPATH**/ ?>
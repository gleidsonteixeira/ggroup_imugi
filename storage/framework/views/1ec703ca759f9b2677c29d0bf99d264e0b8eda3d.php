<?php $__env->startSection('titulo','Unit 9 | Understanding'); ?>
...
<!-- WRAPPER ALL -->
    ...
    <script>
        ...
        $("#unidade9understanding30").submit(function(e){
            e.preventDefault();
            $(this).find('button').prop('disabled', true);
            var respostas = '{';
            $('#unidade9understanding30 input[type="text"]').each(function(index){
                if(($('#unidade9understanding30 input[type="text"]').length - 1) == index){
                    respostas += '"'+$(this).attr("name")+'":"'+$(this).val()+'"}';
                }else{
                    respostas += '"'+$(this).attr("name")+'":"'+$(this).val()+'",';
                }
            });
            if($('#unidade9understanding30 input[name="resposta_id"').val() != 0){
                atualizarAtividade($('#unidade9understanding30'), respostas);
            }else{
                enviarAtividade($('#unidade9understanding30'), respostas);
            }
        });
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila1/unidade9/understanding.blade.php ENDPATH**/ ?>
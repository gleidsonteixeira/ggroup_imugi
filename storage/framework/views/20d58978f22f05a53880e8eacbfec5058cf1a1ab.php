<?php $__env->startSection('titulo','Corel Draw | Aula 17 – Códigos de Barra e QR'); ?>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="photoshop-corel" data-unidade="unidade2" data-etapa="aula34">
            ...
            <p><strong> Texto simples: </strong> permite incluir texto simples (não formatado).</p>    
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula17/imagem1.jpg')); ?>" alt="guia" style="width:55%!important; margin: 0 auto;" >
                </figure>
...
informações consulte os orgãos responsáveis.</p>
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula17/imagem2.jpg')); ?>" alt="guia" style="width:75%!important; margin: 0 auto;" >
                </figure>
                <p>Exemplos de códigos de barras fora da curva para atrair clientes e uma bela inovação das empresas criadoras</p>
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula17/imagem3.jpg')); ?>" alt="guia" style="width:55%!important; margin: 0 auto;" >
                </figure>
            <div class="clear"></div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/corel-draw/aula34.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('titulo','Unit 11 | Understanding'); ?>
...
<!-- WRAPPER ALL -->
	...
	<main>
		...
		<div class="dashboard">
			<div id="unidade" class="box" data-apostila="apostila1" data-unidade="unidade11" data-etapa="understanding">
                ...
                <div class="metade">
                    <form id="unidade11understanding34" method="post">
                        ...
                        <input type="hidden" name="atividade_id" value="34">
    ...
    <script>
        ...
        $("#unidade11understanding34").submit(function(e){
            e.preventDefault();
            $(this).find('button').prop('disabled', true);
            var respostas = '{';
            $('#unidade11understanding34 input[type="text"]').each(function(index){
                if(($('#unidade11understanding34 input[type="text"]').length - 1) == index){
                    respostas += '"'+$(this).attr("name")+'":"'+$(this).val()+'"}';
                }else{
                    respostas += '"'+$(this).attr("name")+'":"'+$(this).val()+'",';
                }
            });
            if($('#unidade11understanding34 input[name="resposta_id"').val() != 0){
                atualizarAtividade($('#unidade11understanding34'), respostas);
            }else{
                enviarAtividade($('#unidade11understanding34'), respostas);
            }
        });
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila1/unidade11/understanding.blade.php ENDPATH**/ ?>
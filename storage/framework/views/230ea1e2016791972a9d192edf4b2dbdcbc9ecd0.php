...
<section class="wow fadeIn bg_cota" style="background-image: url(<?php echo e(asset('assets/site/images/bg-socio-investidor.png')); ?>); background-repeat:no-repeat; background-size: cover; padding:50px 0px 50px 0px;">
<div class="container">
                    <div class="row align-items-center">
                        <div class="col-12 col-lg-6 text-center md-margin-50px-bottom sm-margin-30px-bottom">
                            <div class="text-center text-lg-left md-no-padding-lr">
                                <img src="<?php echo e(asset('assets/img/logo_imugi.png')); ?>" alt="" class="logo-land">
                                ...
                                <div class="card-body">
                                    <p class="titulo_socio">Comece a Investir <br>
                                     <span class="sub_socio"> O jeito mais fácil de faturar $$$ </span>
                                        ...
                                        <form method="POST" action="<?php echo e(route('contatoSocio')); ?>">
...
equipe entrar em contato com você</p>
                        ...
                        <img src="<?php echo e(asset('assets/site/images/seta.png')); ?>" alt="" class="seta_socio">
                    </div>
                </div>
</section>
...
Um novo mundo cria novas oportunidades! 
                    ...
                    <div class="col-12 col-md-6 sm-margin-30px-bottom text-center text-md-left wow fadeInUp last-paragraph-no-margin" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp; padding-left:0px!important;">
                        <div class="row m-0">
                            ...
                            <img src="<?php echo e(asset('assets/site/images/icones/franqueado.png')); ?>" alt="" class="img-franqueado">
                            </div>
...
e divisão dos lucros. 
            ...
            <section class="wow fadeIn bg_cota_img" style="background-image: url(<?php echo e(asset('assets/site/images/bg-land.png')); ?>); background-repeat:no-repeat; background-size: cover; padding:80px 0px;">
                <div class="container">
                    <div class="row">
            ...
            <div class="container">
                ...
                <div class="row margin-50px-top md-margin-70px-top sm-margin-50px-top">
                    <div class="col-lg-6 col-md-6  last-paragraph-no-margin wow fadeInUp">
                        <div>
                            <div>
                                    <img src="<?php echo e(asset('assets/site/images/razoes/1.png')); ?>" alt="" class="width-60 vantagens_suporte">
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 last-paragraph-no-margin wow fadeInUp">
                            <img src="<?php echo e(asset('assets/site/images/razoes/2.png')); ?>" alt="" class="width-60 vantagens_suporte">
                            <div class="post-details">
                ...
                <div class="row margin-50px-top md-margin-70px-top sm-margin-50px-top">
                    <div class="col-lg-6 col-md-6  last-paragraph-no-margin wow fadeInUp">
                        <div>
                            <div>
                                    <img src="<?php echo e(asset('assets/site/images/razoes/4.png')); ?>" alt="" class="width-60 vantagens_suporte">
                            </div>
                            <div class="post-details">
                    ...
                    <div class="col-lg-6 col-md-6 last-paragraph-no-margin wow fadeInUp">
                            <img src="<?php echo e(asset('assets/site/images/razoes/6.png')); ?>" alt="" class="width-60 vantagens_suporte">
                            <div class="post-details">
                ...
                <div class="row margin-50px-top md-margin-70px-top sm-margin-50px-top">
                    <div class=" col-lg-6 col-md-6  last-paragraph-no-margin wow fadeInUp">
                        <div>
                            <div>
                                    <img src="<?php echo e(asset('assets/site/images/razoes/3.png')); ?>" alt="" class="width-60 vantagens_suporte">
                            </div>
                            <div class="post-details">
                    ...
                    <div class=" col-lg-6 col-md-6 last-paragraph-no-margin wow fadeInUp">
                            <img src="<?php echo e(asset('assets/site/images/razoes/5.png')); ?>" alt="" class="width-60 vantagens_suporte">
                            <div class="post-details">
	...
	<!-- Wrapper for carousel items -->
	 <div class="carousel-inner">		
		    <div class="carousel-item active">
			       <div class="img-box">
                        <img src="<?php echo e(asset('assets/site/images/michell.png')); ?>" alt=""></div>
            ...
            <div class="container-fluid position-relative">
                <div class="row align-items-center"> 
                    <div class="col-12 col-lg-6 text-center wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
                        <img src="<?php echo e(asset('assets/site/images/investimento2.png')); ?>" alt="" class="investimento">
                    </div>  
                </div>
            </div>
        </section>
 <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.site.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/site/socio-investidor/index.blade.php ENDPATH**/ ?>
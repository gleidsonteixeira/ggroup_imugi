<?php $__env->startSection('titulo','Unit 33 | Criando um novo projeto 2D'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade33" data-etapa="novo_projeto">
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit33/imagem1.png')); ?>" alt="guia1" style="width:75%; margin: 0 auto;">
				</figure>
			</div>
...
de navegação [...].</p>
			...
			<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit33/imagem2.png')); ?>" alt="guia1" style="width:65%;">
			</figure>
			<p style="margin-top:20px;">A captura de tela a seguir mostra o que veremos na tela:</p>
			<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit33/imagem3.png')); ?>" alt="guia1" style="width:65%;">
			</figure>
...
Scene View, como mostrado na imagem a seguir:</p>
            <figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit33/imagem4.png')); ?>" alt="guia1" style="width:65%;">
			</figure>
...
Mode </strong> padrão, conforme mostrado na seguinte imagem:</p>
            <figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit33/imagem5.png')); ?>" alt="guia1" style="width:65%;">
			</figure>
		</div>
    </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade33/novo_projeto.blade.php ENDPATH**/ ?>
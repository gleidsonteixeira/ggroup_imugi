...
<?php $__env->startSection('titulo','Unit 7 | Conceitos Visuais'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade7" data-etapa="conceitos_visuais">
			...
			<div>
                <figure>
                    <img src="<?php echo e(asset('assets/img/games_and_animation/unit7/imagem_unit7_01.png')); ?>" alt="guia1">
                </figure>
			</div>
			<div>
                <figure>
                    <img src="<?php echo e(asset('assets/img/games_and_animation/unit7/imagem_unit7_02.png')); ?>" alt="guia2">
                </figure>
			</div>
			<p>
			...
			<div>
                <figure>
                    <img src="<?php echo e(asset('assets/img/games_and_animation/unit7/imagem_unit7_03.png')); ?>" alt="guia3">
                </figure>
			</div>
			<p>
			...
			<div>
                <figure>
                    <img src="<?php echo e(asset('assets/img/games_and_animation/unit7/imagem_unit7_04.png')); ?>" alt="guia4">
                </figure>
			</div>
			<p>
			...
			<div>
                <figure>
                    <img src="<?php echo e(asset('assets/img/games_and_animation/unit7/imagem_unit7_05.png')); ?>" alt="guia5">
                </figure>
			</div>
			<p>
			...
			<div>
                <figure>
                    <img src="<?php echo e(asset('assets/img/games_and_animation/unit7/imagem_unit7_06.png')); ?>" alt="guia6">
                </figure>
			</div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade7/conceitos_visuais.blade.php ENDPATH**/ ?>
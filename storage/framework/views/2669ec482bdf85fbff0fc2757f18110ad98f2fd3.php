...
<section class="wow fadeIn bem_vindo_img"  id="matricula" style="background-image: url(<?php echo e(asset('assets/site/images/bg_home.jpg')); ?>); background-repeat:no-repeat; background-position: center;">
                <div class="container">
                        ...
                        <div class="col-12 col-lg-6 text-center md-margin-50px-bottom sm-margin-30px-bottom">
                            <div class="text-center text-lg-left md-no-padding-lr">
                                <h5 class="educacao text-white-2">
                                    ...
                                    <span class="titulo_3"> e Inglês </span></h5>
        ...
        <section class="wow fadeIn bg_bvd" style="background-image: url(<?php echo e(asset('assets/site/images/bg-bemvindo.png')); ?>);  background-repeat: no-repeat; background-position: bottom; background-size: 100% 18%;">
            <div class="container ">
                <div class="row align-items-center"> 
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-12 col-lg-4 col-md-6 text-center md-margin-50px-bottom sm-margin-30px-bottom wow fadeInUp last-paragraph-no-margin">
                        <img src="<?php echo e(asset('assets/site/images/icone-cg.png')); ?>" alt="" width="200">
                        <div class=" text-uppercase font-weight-600 titulo_vantagens margin-5px-bottom mt-4">Computação Gráfica</div>
                        <p class="">
                    ...
                    <div class="col-12 col-lg-4 col-md-6 text-center md-margin-50px-bottom sm-margin-30px-bottom wow fadeInUp last-paragraph-no-margin">
                            ...
                            <p class="">ferramenta de orientação e <br> encaminhamento ao mercado de trabalho <br> exclusiva para os alunos imugi.</p>
                        </div>
                    <!-- end features box item -->
                </div>
        ...
        <section class="p-0 wow fadeIn bg-light-gray" id="curso">
                <div class="container-fluid">
                    <div class="row"> 
                            <div class="col-12 col-lg-6 cover-background md-height-400px wow fadeInRight" style="background-image:url(<?php echo e(asset('assets/site/images/bg-cg-fly.jpg')); ?>);"></div>
        ...
        <section class="p-0 wow fadeIn bg-light-gray">
            <div class="container-fluid">
                <div class="row"> 
                    <div class="col-12 col-lg-6 wow fadeInLeft padding-four-all md-padding-eight-all md-padding-15px-lr sm-padding-50px-tb">
                        <div class="row m-0">
                            <div style="margin-left: 240px;"  class="col-12 col-xl-10 code_b margin-six-bottom lg-margin-six-bottom md-margin-30px-bottom sm-no-margin-bottom">
                    ...
                    <div class="col-12 col-lg-6 cover-background md-height-400px wow fadeInRight" style="background-image:url(<?php echo e(asset('assets/site/images/bg-code-block.jpg')); ?>)"></div>
                </div>
            </div>
        </section>
        <!-- start parallax feature box -->
        <section class="p-0 wow fadeIn bg-light-gray" id="curso">
                <div class="container-fluid">
                    <div class="row"> 
                            <div class="col-12 col-lg-6 cover-background md-height-400px wow fadeInRight" style="background-image:url(<?php echo e(asset('assets/site/images/game-dev.png')); ?>);"></div>
                        <div class="col-12 col-lg-6 wow fadeInLeft padding-four-all md-padding-eight-all md-padding-15px-lr sm-padding-50px-tb">
                            <div class="row m-0">
                                <div class="col-12 col-xl-10 margin-six-bottom lg-margin-six-bottom md-margin-30px-bottom sm-no-margin-bottom">
                                 <img src="<?php echo e(asset('assets/site/images/logo-dev.png')); ?>" alt="" width="360">
                                 <p>
                                 Um curso voltado para profissionais na área de desenvolvimento <br>
                                 de jogos digitais, amplificando seus conhecimentos e também  <br> 
                                para iniciantes que desejam ingressar nessa  área que a cada dia <br>
                                cresce no país. Esse é o curso, onde  o aluno aprenderá a planejar <br>
                                e desenvolver jogos com as mais atuais ferramentas do mercado, <br>
        ...
        <!-- start section -->
        <section class="wow fadeIn" style="background-image: url(<?php echo e(asset('assets/site/images/bg_portal_aluno.jpg')); ?>); background-repeat:no-repeat;">
            <div class="container"> 
                <div class="row align-items-center">
        ...
        <section class="wow fadeIn" style="background-image: url(<?php echo e(asset('assets/site/images/depoimentos.png')); ?>); background-repeat:no-repeat; background-position: bottom; background-position-x: top;">
            <div class="container">
                <div class="row">
...
<?php echo $__env->make('layouts.site.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/site/home/aprovar.blade.php ENDPATH**/ ?>
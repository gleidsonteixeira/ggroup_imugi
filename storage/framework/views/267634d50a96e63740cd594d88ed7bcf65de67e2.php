...
<?php $__env->startSection('titulo','Unit 50 | Grammar'); ?>
    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade50" data-etapa="grammar">
            ...
            <h5 class="barlow" style="margin-top:32px"><b>EXERCISES</b></p>
                ...
                <figure>
                    <img src="<?php echo e(asset('assets/img/dominating/unit50/grammar.png')); ?>" alt="desenhista">
                </figure>
                <div class="clear"></div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila2/unidade50/grammar.blade.php ENDPATH**/ ?>
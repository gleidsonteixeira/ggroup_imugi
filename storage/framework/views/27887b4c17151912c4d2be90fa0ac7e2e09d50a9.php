<?php $__env->startSection('titulo','Unit 44 | Poses Dinâmicas'); ?>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit44/imagem06.png')); ?>" alt="guia1" style="width:100%;">
</figure>
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit44/imagem07.png')); ?>" alt="guia1" style="width:70%;">
</figure>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit44/imagem08.png')); ?>" alt="guia1" style="width:70%;">
</figure>
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit44/imagem09.png')); ?>" alt="guia1" style="width:100%;">
</figure>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade44/poses_dinamicas.blade.php ENDPATH**/ ?>
<?php $__env->startSection('titulo','Unit 1 | Aula 20 – Animação Quadro-a-Quadro'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila4" data-unidade="unidade1" data-etapa="aula1">
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit1/imagem1.png')); ?>" alt="guia">
                </figure>
            </div>
            <p style="margin-top: 16px">
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit1/imagem2.png')); ?>" alt="guia">
                </figure>
            </div>
            <p style="margin-top: 16px">
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit1/imagem3.png')); ?>" alt="guia">
                </figure>
            </div>
            <p style="margin-top: 16px">
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit1/imagem4.png')); ?>" alt="guia">
                </figure>
            </div>
            <p style="margin-top: 16px">
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit1/imagem5.png')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit1/imagem6.png')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit1/imagem7.png')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit1/imagem8.png')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit1/imagem9.png')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit1/imagem10.png')); ?>" alt="guia">
                </figure>
            </div>
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit1/imagem11.png')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit1/imagem12.png')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit1/imagem13.png')); ?>" alt="guia">
                </figure>
            </div>
            <p style="margin-top:16px;">Outra forma será através da opção Recent Files do menu arquivo.</p>                        
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit1/imagem14.png')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit1/imagem15.png')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit1/imagem16.png')); ?>" alt="guia">
                </figure>
            </div>
            <p style="margin-top:16px;">Ferramenta Zoom e suas propriedades – A ferramenta Zoom</p>
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit1/imagem17.png')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit1/imagem18.png')); ?>" alt="guia">
                </figure>
            </div>
            <p style="margin-top:16px;"><b>a.</b> 
            <img style="display: inline-block;" src="<?php echo e(asset('assets/img/photoshop/unit1/imagem19.png')); ?>" alt="guia">
            ...
            <img style="display: inline-block;" src="<?php echo e(asset('assets/img/photoshop/unit1/imagem20.png')); ?>" alt="guia">
            100% - Permite ajustar para 100% do tamanho de ampliação.</p>
            <p style="margin-top:16px;"><b>c.</b> 
            <img style="display: inline-block;" src="<?php echo e(asset('assets/img/photoshop/unit1/imagem21.png')); ?>" alt="guia">
            ...
            <img style="display: inline-block;" src="<?php echo e(asset('assets/img/photoshop/unit1/imagem22.png')); ?>" alt="guia">
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit1/imagem23.png')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit1/imagem24.png')); ?>" alt="guia">
                </figure>
            </div>
            <p style="margin-top:16px;">Outra forma de alterar o modo de tela é através do botão Change Screen Mode situado na barra de ferramentas.</p>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/unidade1/aula1.blade.php ENDPATH**/ ?>
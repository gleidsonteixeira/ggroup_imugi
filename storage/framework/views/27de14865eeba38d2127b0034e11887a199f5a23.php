...
<main>
    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade13" data-etapa="listening">
            <h3 class="barlow">UNIT 13</h3>
            <h5 class="barlow">5 - LISTENING</h5>
            <span class="play-audio">( Aperte o play )</span>
            <audio controls="" controlslist="nodownload" class="suave">
                <source src="<?php echo e(asset('assets/audio/apostila2/UNIT 13/5. LISTENING/LISTENING.ogg')); ?>" type="audio/ogg">
            </audio>
            <div class="clear"></div>
            ...
            <form class="metade" id="unidade13listening159" method="post">
                ...
                <input type="hidden" name="atividade_id" value="159">
...
<script>
    ...
    $("#unidade13listening159").submit(function(e) {
        e.preventDefault();
        $(this).find('button').prop('disabled', true);
        var respostas = '{';
        $('#unidade13listening159 input[type="text"]').each(function(index) {
            if (($('#unidade13listening159 input[type="text"]').length - 1) == index) {
                respostas += '"' + $(this).attr("name") + '":"' + $(this).val() + '"}';
            } else {
                respostas += '"' + $(this).attr("name") + '":"' + $(this).val() + '",';
            }
        });
        if ($('#unidade13listening159 input[name="resposta_id"').val() != 0) {
            atualizarAtividade($('#unidade13listening159'), respostas);
        } else {
            enviarAtividade($('#unidade13listening159'), respostas);
        }
    });
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila2/unidade13/listening.blade.php ENDPATH**/ ?>
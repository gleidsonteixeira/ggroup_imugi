	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila3" data-unidade="unidade26" data-etapa="conversation">
			...
			<audio controls="" controlslist="nodownload" class="suave">
                <source src="<?php echo e(asset('assets/audio/apostila3/LESSON 26/02_CONVERSATION/CONVERSATION_26.mp3')); ?>" type="audio/mp3">
            </audio>
            <div class="clear"></div>
            ...
            <figure class="umterco">
                <img src="<?php echo e(asset('assets/img/masteroflanguage/unit26/conversation1.png')); ?>" alt="eletrônicos">
            </figure>
            <figure class="umterco">
                <img src="<?php echo e(asset('assets/img/masteroflanguage/unit26/conversation2.png')); ?>" alt="eletrônicos">
            </figure>
            <figure class="umterco">
                <img src="<?php echo e(asset('assets/img/masteroflanguage/unit26/conversation3.png')); ?>" alt="eletrônicos">
            </figure>
		</div>
	</div>
</main>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila3/unidade26/conversation.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('titulo','Unit 13 | Understanding'); ?>
...
<main>
    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade13" data-etapa="understanding">
            ...
            <form class="metade" id="unidade13understanding160" method="post">
                ...
                <input type="hidden" name="atividade_id" value="160">
...
<script>
    ...
    $("#unidade13understanding160").submit(function(e) {
        e.preventDefault();
        $(this).find('button').prop('disabled', true);
        var respostas = '{';
        $('#unidade13understanding160 input[type="text"]').each(function(index) {
            if (($('#unidade13understanding160 input[type="text"]').length - 1) == index) {
                respostas += '"' + $(this).attr("name") + '":"' + $(this).val() + '"}';
            } else {
                respostas += '"' + $(this).attr("name") + '":"' + $(this).val() + '",';
            }
        });
        if ($('#unidade13understanding160 input[name="resposta_id"').val() != 0) {
            atualizarAtividade($('#unidade13understanding160'), respostas);
        } else {
            enviarAtividade($('#unidade13understanding160'), respostas);
        }
    });
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila2/unidade13/understanding.blade.php ENDPATH**/ ?>
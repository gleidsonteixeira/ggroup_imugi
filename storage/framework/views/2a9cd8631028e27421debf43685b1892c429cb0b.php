...
<?php $__env->startSection('titulo','Unit 9 | Aula 21 – Edição de vídeos I'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila4" data-unidade="unidade9" data-etapa="aula21">
			<h3 class="barlow">UNIT 9</h3>
			<h5 class="barlow upper">Aula 21 – Edição de vídeos I</h5>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem24.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem25.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem26.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem27.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem28.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem29.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem30.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem31.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem32.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem33.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem34.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/unidade9/aula21.blade.php ENDPATH**/ ?>
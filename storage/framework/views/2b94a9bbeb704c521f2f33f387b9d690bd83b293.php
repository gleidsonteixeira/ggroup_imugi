...
<section class="wow fadeIn bem_vindo_img"  id="matricula" style="background-image: url(<?php echo e(asset('assets/site/images/bg-code.jpg')); ?>); background-repeat:no-repeat; background-position: center;">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-12 col-lg-6 text-center md-margin-50px-bottom sm-margin-30px-bottom">
                            <div class="text-center text-lg-left md-no-padding-lr">
                                <img src="<?php echo e(asset('assets/site/images/logo-codeblock.png')); ?>" alt="" class="logo-curso">
...
internacional
                    ...
                    <img src="<?php echo e(asset('assets/site/images/modulos-robotica.png')); ?>" alt="" class="modulos" style="position:absolute; width:60%; right:0px;">
                </div>
        ...
        <section class="p-0 wow fadeIn" style="padding-top:80px!important;">
                <div class="container">
                    <div class="row"> 
                            <div class="col-12 col-lg-6 cover-background md-height-400px wow fadeInRight" style="background-image:url(<?php echo e(asset('assets/site/images/robotica.png')); ?>);"></div>
...
<?php echo $__env->make('layouts.site.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/site/cursos/codeblock.blade.php ENDPATH**/ ?>
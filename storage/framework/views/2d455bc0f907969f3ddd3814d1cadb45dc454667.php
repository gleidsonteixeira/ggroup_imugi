...
<?php $__env->startSection('titulo','Unit 11 |  Layer 3D, Luz e Câmera'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila6" data-unidade="unidade11" data-etapa="layer_luz_camera">
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit11/imagem_unit11_1.png')); ?>" alt="guia1">
				</figure>
			</div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila6/unidade11/layer_luz_camera.blade.php ENDPATH**/ ?>
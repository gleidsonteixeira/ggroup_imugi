...
<?php $__env->startSection('titulo','Unit 2 | Ajuste de audio'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila6" data-unidade="unidade2" data-etapa="ajuste_de_audio">
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit2/imagem_unit2_45.png')); ?>" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit2/imagem_unit2_46.png')); ?>" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit2/imagem_unit2_47.png')); ?>" alt="guia1">
				</figure>
			</div>
			...
			<p>
				1. Clicar no ícone 
				<img style="display: inline-block;" src="<?php echo e(asset('assets/img/video_edition/unit2/imagem_unit2_49.png')); ?>" alt="guia"> 
			...
			<p>
				...
				<div class="container">
					<figure>
						<img src="<?php echo e(asset('assets/img/video_edition/unit2/imagem_unit2_52.png')); ?>" alt="guia1">
					</figure>
				</div>
			...
			<p>
				...
				<div class="container">
					<figure>
						<img src="<?php echo e(asset('assets/img/video_edition/unit2/imagem_unit2_53.png')); ?>" alt="guia1">
					</figure>
				</div>
			...
			<p>
				...
				<div class="container">
					<figure>
						<img src="<?php echo e(asset('assets/img/video_edition/unit2/imagem_unit2_54.png')); ?>" alt="guia1">
					</figure>
				</div>

				<div class="container">
					<figure>
						<img src="<?php echo e(asset('assets/img/video_edition/unit2/imagem_unit2_55.png')); ?>" alt="guia1">
					</figure>
				</div>
			</p>
			...
			<p>
				...
				<div class="container">
					<figure>
						<img src="<?php echo e(asset('assets/img/video_edition/unit2/imagem_unit2_56.png')); ?>" alt="guia1">
					</figure>
				</div>
			</p>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit2/imagem_unit2_57.png')); ?>" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit2/imagem_unit2_58.png')); ?>" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit2/imagem_unit2_59.png')); ?>" alt="guia1">
				</figure>
			</div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila6/unidade2/ajuste_de_audio.blade.php ENDPATH**/ ?>
...
<header>
                        ...
                        <div class="navbar-collapse collapse justify-content-end" id="navbar-collapse-toggle-1">
                            <ul id="accordion" class="nav navbar-nav no-margin alt-font text-normal">
                                ...
                                <li class="<?php if(Route::current()->getName() == 'siteContato'): ?> ativo <?php endif; ?>">
                                    <a href="<?php echo e(route('siteContato')); ?>"> Contato </a>          
                                </li>
                                
                                <li class="<?php if(Route::current()->getName() == 'franquia'): ?> ativo <?php endif; ?>">
                                    <a href="<?php echo e(route('franquia')); ?>">Seja Franqueado</a>
                                </li>
        ...
        <!-- end header --><?php /**PATH C:\xampp\htdocs\apostila-imugi\resources\views/layouts/site/menus/header.blade.php ENDPATH**/ ?>
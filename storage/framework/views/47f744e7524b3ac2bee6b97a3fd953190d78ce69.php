...
<?php $__env->startSection('titulo','Unit 20 | Iluminação'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade20" data-etapa="iluminacao">
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit20/imagem_unit20_2.png')); ?>" alt="guia2">
				</figure>
			</div>
			<p>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit20/imagem_unit20_3.png')); ?>" alt="guia3">
				</figure>
			</div>
			...
			<div>
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit20/imagem_unit20_4.png')); ?>" alt="guia4">
				</figure>
			</div>
			<p>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade20/iluminacao.blade.php ENDPATH**/ ?>
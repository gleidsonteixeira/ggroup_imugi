...
<?php $__env->startSection('titulo','Unit 4 | Censura de Vídeo'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila6" data-unidade="unidade4" data-etapa="censura_de_video">
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit4/imagem_unit4_8.png')); ?>" alt="Wave Form do áudio">
				</figure>
			</div><br>
			<p>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit4/imagem_unit4_9.png')); ?>" alt="Wave Form do áudio">
				</figure>
			</div><br>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit4/imagem_unit4_10.png')); ?>" alt="Wave Form do áudio">
				</figure>
			</div><br>
			<p>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit4/imagem_unit4_11.png')); ?>" alt="Wave Form do áudio">
				</figure>
			</div><br>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit4/imagem_unit4_12.png')); ?>" alt="Wave Form do áudio">
				</figure>
			</div><br>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila6/unidade4/censura_de_video.blade.php ENDPATH**/ ?>
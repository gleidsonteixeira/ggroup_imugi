<?php $__env->startSection('titulo','Unit 44 | Formas dos Personagens e Poses'); ?>
...
em relaxamento.</p>
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit44/imagem01.png')); ?>" alt="guia1" style="width:100%;">
</figure>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit44/imagem02.png')); ?>" alt="guia1" style="width:60px;">
</figure>
</div>
...
<div class="metade direita">
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit44/imagem03.png')); ?>" alt="guia1" style="width:100px;">
</figure>
</div>
...
<div class="metade esquerda">
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit44/imagem04.png')); ?>" alt="guia1" style="width:160px; float: right;">
</figure>
</div>
<div class="clear"></div>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit44/imagem05.png')); ?>" alt="guia1" style="width:70%;">
</figure>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade44/personagens_poses.blade.php ENDPATH**/ ?>
<?php $__env->startSection('titulo','Unit 33 | Interface do Unity Editor'); ?>
...
na imagem a seguir:</p>
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit33/imagem6.png')); ?>" alt="guia1" style="width:75%;">
				</figure>
...
o tamanho do nosso objeto</li>
               ...
               <figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit33/imagem7.png')); ?>" alt="guia1" style="width:15%;">
				</figure>
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit33/imagem8.png')); ?>" alt="guia1" style="width:75%;">
				</figure>
...
<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit33/imagem9.png')); ?>" alt="guia1" style="width:30%;">
				</figure>
...
<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit33/imagem10.png')); ?>" alt="guia1" style="width:25%;">
				</figure>
...
<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit33/imagem11.png')); ?>" alt="guia1" style="width:25%;">
				</figure>
		</div>
    </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade33/interface.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('titulo','Unit 06 | Listening'); ?>
...
<!-- WRAPPER ALL -->
	...
	<main>
		...
		<div class="dashboard">
			<div id="unidade" class="box" data-apostila="apostila3" data-unidade="unidade6" data-etapa="listening">
				<h3 class="barlow">UNIT 6</h3>
                <h5 class="barlow">5 - LISTENING</h5>
                <span class="play-audio">( Aperte o play )</span>
				<audio controls="" controlslist="nodownload" class="suave">
                    <source src="<?php echo e(asset('assets/audio/apostila3/LESSON 06/06_LISTENING/LISTENING_06.mp3')); ?>" type="audio/mp3">
                </audio>
                <div class="clear"></div>
    ...
    <script>
        ...
        $("#unidade6listening528").submit(function(e){
            e.preventDefault();
            $(this).find('button').prop('disabled', true);
            var respostas = '{';
            $('#unidade6listening528 input[type="text"]').each(function(index){
                if(($('#unidade6listening528 input[type="text"]').length - 1) == index){
                    respostas += '"'+$(this).attr("name")+'":"'+$(this).val()+'"}';
                }else{
                    respostas += '"'+$(this).attr("name")+'":"'+$(this).val()+'",';
                }
            });
            if($('#unidade6listening528 input[name="resposta_id"').val() != 0){
                atualizarAtividade($('#unidade6listening528'), respostas);
            }else{
                enviarAtividade($('#unidade6listening528'), respostas);
            }
        });
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila3/unidade6/listening.blade.php ENDPATH**/ ?>
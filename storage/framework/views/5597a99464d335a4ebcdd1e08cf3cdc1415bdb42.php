...
<section class="wow fadeIn bg_cota_img"
    style="background-image: url(<?php echo e(asset('assets/site/images/socio-cota.png')); ?>); background-repeat:no-repeat; background-position: center top;">
    <div class="container">
        <div class="row">
...
<!-- <img src="<?php echo e(asset('assets/site/images/seta.png')); ?>" alt="" class="seta_franquia"> -->
        ...
        <div class="row align-items-center">
            <div class="col-12 col-lg-5 wow fadeInRight last-paragraph-no-margin" data-wow-delay="0.2s">
                ...
                <p class="mt-4 desc-somos">
                    Fazemos parte do Grupo Gracom que possui mais de 10 anos administrando redes com escolas próprias e
                    franqueadas por todas as regiões do Brasil.
                </p>
                </p>
                <p class="mt-4 desc-somos">
                    A Imugi é uma escola de Tecnologia e Educação que utiliza uma metodologia de ensino única abordando
                    interdisciplinarmente conteúdos das áreas de: Robótica, game, programação, inglês e computação
                    gráfica.
            ...
            <div class="col-12 col-lg-7 text-center wow fadeInLeft">
                <!-- <img src="<?php echo e(asset('assets/site/images/qum_somos_franquia.png')); ?>" alt="" class="w-100"> -->
...
<div style="height:80px;"></div>
<section class="wow fadeIn bg_cota_img"
    style="background-image: url(<?php echo e(asset('assets/site/images/bg-modalidade.png')); ?>); background-repeat:no-repeat; background-size: cover;">
    <div class="container">
        <div class="row">
            <div class="md-margin-50px-bottom sm-margin-30px-bottom">
                <div class="md-no-padding-lr">
        ...
        <div class="row box-franquia">
            ...
            <!-- <div class="col-12 col-md-6 sm-margin-30px-bottom text-center text-md-left wow fadeInUp last-paragraph-no-margin" style="visibility: visible; animation-name: fadeInUp;">
                        <div class="row m-0">
                            <div class="col-12 col-lg-3 col-md-4 pl-0 sm-no-padding-lr float-left sm-margin-15px-bottom">
                                <img src="<?php echo e(asset('assets/site/images/icones/cotista.png')); ?>" alt="">
                            </div>
            ...
            <!-- end feature box -->
            <!-- start feature box -->
            <div class="col-12 col-md-6 sm-margin-30px-bottom text-center text-md-left wow fadeInUp last-paragraph-no-margin"
                data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                <div class="row m-0">
                    <div class="col-12 col-lg-3 col-md-4 pl-0 sm-no-padding-lr float-left sm-margin-15px-bottom">
                        <img src="<?php echo e(asset('assets/site/images/icones/franqueado.png')); ?>" alt="">
                    </div>
                    <div class="col-12 col-lg-9 col-md-8 p-0">
                        <span
                            class="margin-5px-bottom d-block  sm-margin-10px-bottom titulo-investidor">FRANQUEADO</span>
        ...
        <div class="row align-items-center">
            <div class="col-12 col-lg-6 wow fadeInRight last-paragraph-no-margin" data-wow-delay="0.2s">
                <div class="padding-eight-lr text-center text-lg-left sm-no-padding w-100">
                    ...
                    <div class="row">
                        <!-- start feature box -->
                        <div class="col-12 col-md-12 sm-margin-30px-bottom text-center text-md-left wow fadeInUp last-paragraph-no-margin"
                            style="visibility: visible; animation-name: fadeInUp;">
                            <div class="row m-0">
                                <div
                                    class="col-12 col-lg-2 col-md-4 pl-0 sm-no-padding-lr float-left sm-margin-15px-bottom">
                                    <img src="<?php echo e(asset('assets/site/images/icones/previsao_faturamento.png')); ?>" alt=""
                                        class="mt-4">
                                </div>
                                <div class="col-12 col-lg-9 col-md-8 p-0">
                                    <p class="desc-sucesso lg-width-100 mt-4">Previsão de Faturamento: <br>
                                        <span class="desc-sucesso-desc"> R$150 Mil Reais Mensais </span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-12 sm-margin-30px-bottom text-center text-md-left wow fadeInUp last-paragraph-no-margin"
                            ...
                            <div class="row m-0">
                                <div
                                    class="col-12 col-lg-2 col-md-4 pl-0 sm-no-padding-lr float-left sm-margin-15px-bottom">
                                    <img src="<?php echo e(asset('assets/site/images/icones/faturamento.png')); ?>" alt=""
                                        class="mt-4">
                                </div>
                                <div class="col-12 col-lg-9 col-md-8 p-0">
                                    <p class="desc-sucesso lg-width-100 mt-4">Lucro: <br>
                                        <span class="desc-sucesso-desc"> 25% </span>
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-12 col-lg-6 text-center wow fadeInLeft">
                <img src="<?php echo e(asset('assets/site/images/img_franquia.png')); ?>" alt="" class="w-100">
            </div>
    ...
    <div class="container-fluid position-relative">
        ...
        <div class="row align-items-center">
            <div class="col-12 col-lg-6 text-center md-margin-50px-bottom sm-margin-30px-bottom wow fadeIn"
                ...
                <img src="<?php echo e(asset('assets/site/images/investimento.png')); ?>" alt="" class="investimento">
            </div>
                ...
                <div class="width-75 lg-width-100">
                    <div class="row m-0">
                        <div class="col-12 col-lg-2 col-md-4 pl-0 sm-no-padding-lr float-left sm-margin-15px-bottom">
                            <img src="<?php echo e(asset('assets/site/images/icones/franqueado-1.png')); ?>" alt=""
                                class="mt-4 mg-mobile">
                        </div>
                        <div class="col-12 col-lg-9 col-md-8 p-0">
                    ...
                    <ul class="p-0 list-style-4 margin-30px-bottom list-style-color">
                        <li><span class="item-lista">Taxa de franquia R$50.000.00 </span></li>
                        ...
                        <li> <span class="item-lista"> Investimento total estimado: 200 MIL </span> </li>
                    </ul>
                </div>
                <!-- <div class="width-75 lg-width-100 padding-three-lr sm-no-padding-lr box-socio-cotista">
                                <div class="row m-0">
                                    <div class="col-12 col-lg-2 col-md-4 pl-0 sm-no-padding-lr float-left sm-margin-15px-bottom">
                                        <img src="<?php echo e(asset('assets/site/images/icones/cotista-1.png')); ?>" alt="" class="mt-4 mg-mobile">
                                    </div>
                                    <div class="col-12 col-lg-9 col-md-8 p-0">
                                ...
                                <ul class="p-0 list-style-4 margin-30px-bottom list-style-color">
                                    <li><span class="item-lista">10% por R$40 MIL Reais </span> </li>
            ...
            <div class="col-12 col-lg-12 text-center md-margin-50px-bottom sm-margin-30px-bottom">
                <div class="text-center md-no-padding-lr">
                    ...
                    <div class="faturamentos">
                        <h5 class="text-white faturamento-unidade"><i class="fas fa-coins"></i> Royalties:<br>6% do
                            faturamento<h5>
                                <h5 class="text-white faturamento-unidade"><i class="fas fa-bullhorn"></i>
                                    Publicidade:<br>2% do faturamento<h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row margin-100px-top md-margin-70px-top sm-margin-50px-top">
            <div class="col-12 col-lg-4 col-md-6  last-paragraph-no-margin wow fadeInUp">
                <div>
                    <div>
                        <img src="<?php echo e(asset('assets/site/images/razoes/1.png')); ?>" alt=""
                            class="width-40 vantagens_suporte">
                    </div>
            ...
            <div class="col-12 col-lg-4 col-md-6 last-paragraph-no-margin wow fadeInUp">
                <div>
                    <div>
                        <img src="<?php echo e(asset('assets/site/images/razoes/2.png')); ?>" alt=""
                            class="width-40 vantagens_suporte">
                    </div>
                    <div class="post-details">
            ...
            <div class="col-12 col-lg-4 col-md-6  last-paragraph-no-margin wow fadeInUp">
                <div>
                    <div>
                        <img src="<?php echo e(asset('assets/site/images/razoes/3.png')); ?>" alt=""
                            class="width-40 vantagens_suporte">
                    </div>
                    <div class="post-details">
        ...
        <div class="row margin-100px-top md-margin-70px-top sm-margin-50px-top">
            <div
                class="col-12 col-lg-4 col-md-6 md-margin-50px-bottom sm-margin-30px-bottom last-paragraph-no-margin wow fadeInUp">
                <div>
                    <div>
                        <img src="<?php echo e(asset('assets/site/images/razoes/4.png')); ?>" alt=""
                            class="width-40 vantagens_suporte">
                    </div>
                    <div class="post-details">
                        <h6 class="mt-4 text-center diferenciais_itens">SELEÇÃO E CONTRATAÇÃO <br> DA PRIMEIRA EQUIPE
                        </h6>
            ...
            <!-- <div class="col-12 col-lg-4 col-md-6 md-margin-50px-bottom sm-margin-30px-bottom last-paragraph-no-margin wow fadeInUp">
                        <div>
                            <div>
                                    <img src="<?php echo e(asset('assets/site/images/razoes/5.png')); ?>" alt="" class="width-40 vantagens_suporte">
                            </div>
                            <div class="post-details">
            ...
            <div
                ...
                <div>
                    <div>
                        <img src="<?php echo e(asset('assets/site/images/razoes/6.png')); ?>" alt=""
                            class="width-40 vantagens_suporte">
                    </div>
                    <div class="post-details">
...
<section class="wow fadeIn">
    <div class="container">
        ...
        <div class="row">
            ...
            <div
                class="col-12 col-md-6 md-margin-four-bottom text-center sm-margin-twelve-bottom wow fadeInRight last-paragraph-no-margin">
                <div>
                    <img src="<?php echo e(asset('assets/site/images/michell.png')); ?>" alt="">
                </div>
                <p class="mt-4">
                ...
                <span
                    class="text-extra-dark-gray mt-4 font-weight-600 text-small text-uppercase d-block line-height-10 alt-font">MICHELL
                    BEZERRA</span>
                <span class="text-light-gray2 text-extra-small text-uppercase text-medium-gray">Franqueado - Unidade
                    Macéio - AL</span>
            </div>
            ...
            <div class="col-sm-6 col-lg-8 md-margin-50px-bottom sm-margin-30px-bottom">
                <div class="md-no-padding-lr">
                    ...
                    <p class="obs_lead">
                        ...
                        equipe entrar em contrato com você
                    </p>
                    ...
                    <?php endif; ?>
                    <form method="POST" action="<?php echo e(route('contatoFranquia')); ?>">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                <select name="estado" id="estado" class="form-control">
                                    ...
                                    <option value="<?php echo e($estado->id_estados); ?>"><?php echo e($estado->estado_nome); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="col-12 col-lg-6">
...
<?php echo $__env->make('layouts.site.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\imugi\resources\views/site/franquia/index.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('conteudo'); ?>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <?php endif; ?>
                                        <form method="POST" action="<?php echo e(route('recuperarSenha')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input id="email" type="email" class="form-control bg-transparent text-white border-color-medium-dark-gray medium-input <?php $__errorArgs = ['email'];
                            ...
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-success btn-rounded btn-large margin-20px-top sm-no-margin-to">
                                    <?php echo e(__('Recuperar Senha')); ?>
                                        ...
                                        <br>
                                        <span class="mt-4 mostrar">Já possue conta? <a href="<?php echo e(url('login')); ?>" class="ocultar" style="background:none; border:none; color:#fff;">Login</a> </span>        <br>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.site.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/auth/passwords/email.blade.php ENDPATH**/ ?>
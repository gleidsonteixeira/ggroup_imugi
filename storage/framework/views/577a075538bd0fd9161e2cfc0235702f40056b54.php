...
<?php $__env->startSection('titulo','Unit 6 | Aula 13 – Composição Temática II'); ?>
		...
		<div id="unidade" class="box" data-apostila="apostila4" data-unidade="unidade6" data-etapa="aula13">
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit6/imagem2.PNG')); ?>" alt="guia">
                </figure>
            </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/unidade6/aula13.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('titulo','Unit 05 | Grammar'); ?>
    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila3" data-unidade="unidade5" data-etapa="grammar">
            ...
            <audio controls="" controlslist="nodownload" class="suave">
                <source src="<?php echo e(asset('assets/audio/apostila3/LESSON 05/03_GRAMMAR/GRAMMAR_05.mp3')); ?>" type="audio/mp3">
            </audio>
            <div class="clear"></div>
            ...
            <figure class="metade esquerda">
                <img src="<?php echo e(asset('assets/img/masteroflanguage/unit5/grammar1.png')); ?>" alt="vr">
            </figure>
            <figure class="metade direita">
                <img src="<?php echo e(asset('assets/img/masteroflanguage/unit5/grammar2.png')); ?>" alt="jogos">
            </figure>
        </div>
    </div>
</main>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila3/unidade5/grammar.blade.php ENDPATH**/ ?>
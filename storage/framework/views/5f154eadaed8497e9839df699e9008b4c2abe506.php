    ...
    <ul class="nav">
        ...
        <li class="item apostila-PHOTOSHOP" data-apostila="photoshop-corel">
            ...
            <ul>
                ...
                <li class="item" data-unidade="unidade1">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['photoshop', 'intro'])); ?>" data-etapa="intro"><i class="material-icons suave">bookmarks</i> INTRODUCTION</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['photoshop', 'aula1'])); ?>" data-etapa="aula1" class="titulo"><i class="material-icons suave">assignment</i>AULA 01 - CONHECENDO O ADOBE PHOTOSHOP</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['photoshop', 'aula2'])); ?>" data-etapa="aula2" class="titulo"><i class="material-icons suave">assignment</i>AULA 02 - FERRAMENTAS DE SELEÇÃO E RECORTE</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['photoshop', 'aula3'])); ?>" data-etapa="aula3" class="titulo"><i class="material-icons suave">assignment</i>AULA 03 - CAMADAS E SELEÇÃO COM A CANETA LAYERS PANEL</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['photoshop', 'aula4'])); ?>" data-etapa="aula4" class="titulo"><i class="material-icons suave">assignment</i>AULA 04 - SMART OBJECTS E SMART FILTERS</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['photoshop', 'aula5'])); ?>" data-etapa="aula5" class="titulo"><i class="material-icons suave">assignment</i>AULA 05 - AJUSTES DESTRUTIVOS E HISTÓRICO</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['photoshop', 'aula6'])); ?>" data-etapa="aula6" class="titulo"><i class="material-icons suave">assignment</i>AULA 06 - CAMADAS DE AJUSTE E MÁSCARAS DE CAMADA</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['photoshop', 'aula7'])); ?>" data-etapa="aula7" class="titulo"><i class="material-icons suave">assignment</i>AULA 07 - BLENDING MODES E MÁSCARA DE CORTE</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['photoshop', 'aula8'])); ?>" data-etapa="aula8" class="titulo"><i class="material-icons suave">assignment</i>AULA 08 - COMPOSIÇÃO TEMÁTICA</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['photoshop', 'aula9'])); ?>" data-etapa="aula9" class="titulo"><i class="material-icons suave">assignment</i>AULA 09 - DISTORÇÕES E PERSPECTIVAS</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['photoshop', 'aula10'])); ?>" data-etapa="aula10" class="titulo"><i class="material-icons suave">assignment</i>AULA 10 - DISTORÇÕES E PERSPECTIVAS II  </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['photoshop', 'aula11'])); ?>" data-etapa="aula11" class="titulo"><i class="material-icons suave">assignment</i>AULA 11 - RETOQUE E RESTAURAÇÃO DE IMAGENS</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['photoshop', 'aula12'])); ?>" data-etapa="aula12"><i class="material-icons suave">assignment</i>AULA 12 - PINTURA DIGITAL</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['photoshop', 'aula13'])); ?>" data-etapa="aula13"><i class="material-icons suave">assignment</i>AULA 13 - EDIÇÃO DE VÍDEOS</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['photoshop', 'aula14'])); ?>" data-etapa="aula14"><i class="material-icons suave">assignment</i>AULA 14 - ACTIONS</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['photoshop', 'aula15'])); ?>" data-etapa="aula15"><i class="material-icons suave">assignment</i>AULA 15 - MOCKUPS</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['photoshop', 'aula16'])); ?>" data-etapa="aula16"><i class="material-icons suave">lightbulb</i>AVALIAÇÃO PRATICA</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['photoshop', 'aula17'])); ?>" data-etapa="aula17"><i class="material-icons suave">lightbulb</i>AVALIAÇÃO TEORICA</a>
                        </li>
                    </ul>
                </li>
                 <!--UNIDADE 12-->
                 <li class="item" data-unidade="unidade2">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['corel-draw', 'intro'])); ?>" data-etapa="intro"><i class="material-icons suave">bookmarks</i>INTRO</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['corel-draw', 'aula18'])); ?>" data-etapa="aula18"><i class="material-icons suave">assignment</i>Aula 18 - ESPAÇO DE TRABALHO </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['corel-draw', 'aula19'])); ?>" data-etapa="aula19" class="titulo"><i class="material-icons suave">assignment</i>Aula 19 - RECURSOS BÁSICOS DO COREL DRAW </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['corel-draw', 'aula20'])); ?>" data-etapa="aula20" class="titulo"><i class="material-icons suave">assignment</i>Aula 20 - COPIAR, DUPLICAR E EXCLUIR </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['corel-draw', 'aula21'])); ?>" data-etapa="aula21"><i class="material-icons suave">assignment</i>Aula 21 - LINHAS </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['corel-draw', 'aula22'])); ?>" data-etapa="aula22"><i class="material-icons suave">assignment</i>Aula 22 - SIMETRIA </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['corel-draw', 'aula23'])); ?>" data-etapa="aula23"><i class="material-icons suave">assignment</i>Aula 23 - TEXTO </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['corel-draw', 'aula24'])); ?>" data-etapa="aula24"><i class="material-icons suave">assignment</i>Aula 24 - CAMADAS </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['corel-draw', 'aula25'])); ?>" data-etapa="aula25"><i class="material-icons suave">assignment</i>Aula 25 - MODELAR OBJETOS </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['corel-draw', 'aula26'])); ?>" data-etapa="aula26"><i class="material-icons suave">assignment</i>Aula 26 - OBJETOS E SÍMBOLOS </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['corel-draw', 'aula27'])); ?>" data-etapa="aula27" class="titulo"><i class="material-icons suave">assignment</i>Aula 27 - PREENCHIMENTOS E TRANSPARÊNCIAS </a>
                        </li>
                         <li>
                            <a href="<?php echo e(route('apostila4', ['corel-draw', 'aula28'])); ?>" data-etapa="aula28"><i class="material-icons suave">assignment</i>Aula 28 - CORES </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['corel-draw', 'aula29'])); ?>" data-etapa="aula29"><i class="material-icons suave">assignment</i>Aula 29 - EFEITOS VISUAIS </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['corel-draw', 'aula30'])); ?>" data-etapa="aula30" class="titulo"><i class="material-icons suave">assignment</i>Aula 30 - ESTILOS E CONJUNTOS DE ESTILOS </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['corel-draw', 'aula31'])); ?>" data-etapa="aula31"><i class="material-icons suave">assignment</i>Aula 31 - PÁGINAS E LAYOUT </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['corel-draw', 'aula32'])); ?>" data-etapa="aula32"><i class="material-icons suave">assignment</i>Aula 32 - RASTREAR BITMAPS </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['corel-draw', 'aula33'])); ?>" data-etapa="aula33"><i class="material-icons suave">assignment</i>Aula 33 - POWERTRACE </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['corel-draw', 'aula34'])); ?>" data-etapa="aula34" class="titulo"><i class="material-icons suave">assignment</i>Aula 34 - CÓDIGOS DE BARRA E QR </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila4', ['corel-draw', 'aula35'])); ?>" data-etapa="aula35"><i class="material-icons suave">lightbulb</i>Atividade Prática </a>
                        </li>
                    </ul>
                </li>
            </ul>
        ...
        <li class="item apostila-games" data-apostila="apostila5">
            ...
            <ul>
                ...
                <!-- Intro Unity -->
                <li class="item" data-unidade="intro5">
                    <a href="<?php echo e(route('apostila5', ['intro-unity', 'intro'])); ?>" data-etapa="intro-unity"><i class="material-icons suave">bookmarks</i> INTRODUCTION UNITY</a>
                </li>
                <!-- Unity Cap 01 -->
                 <!--UNIDADE 33-->
                 <li class="item" data-unidade="unidade33">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade33', 'novo_projeto'])); ?>" data-etapa="novo_projeto"><i class="material-icons suave">assignment</i>Criando um novo projeto 2D</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade33', 'interface'])); ?>" data-etapa="interface"><i class="material-icons suave">assignment</i>Interface do Unity Editor</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade33', 'scene_view'])); ?>" data-etapa="scene"><i class="material-icons suave">assignment</i>Scene View</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade33', 'game_view'])); ?>" data-etapa="game_view"><i class="material-icons suave">assignment</i>Game View</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade33', 'definindo_favoritos'])); ?>" data-etapa="definindo_favoritos"><i class="material-icons suave">assignment</i>Definindo Favoritos</a>
                        </li>
                    </ul>
                </li>
                 <!--UNIDADE 34-->
                 <li class="item" data-unidade="unidade34">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade34', 'hierarchy'])); ?>" data-etapa="hierarchy"><i class="material-icons suave">assignment</i>Hierarchy</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade34', 'inspector'])); ?>" data-etapa="inspector"><i class="material-icons suave">assignment</i>Inspector Window</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade34', 'asset_store'])); ?>" data-etapa="asset_store"><i class="material-icons suave">assignment</i>Asset Store</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade34', 'importando_asset'])); ?>" data-etapa="importando_asset"><i class="material-icons suave">assignment</i>Importando Asset</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="item" data-unidade="unidade35">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade35', 'asset'])); ?>" data-etapa="asset"><i class="material-icons suave">assignment</i>Asset</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="item" data-unidade="unidade36">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade36', 'game_object'])); ?>" data-etapa="game_object"><i class="material-icons suave">assignment</i>GameObject</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade36', 'componentes'])); ?>" data-etapa="componentes"><i class="material-icons suave">assignment</i>Componentes</a>
                        </li>
                    </ul>
                </li>
                <!--UNIDADE 37-->
                <li class="item" data-unidade="unidade37">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade37', 'importacao_asset'])); ?>" data-etapa="importacao_asset"><i class="material-icons suave">assignment</i>Importacao de Assets</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="item" data-unidade="unidade38">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade38', 'scenes'])); ?>" data-etapa="scenes"><i class="material-icons suave">assignment</i>Scenes</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="item" data-unidade="unidade39">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade39', 'sprite_renderer'])); ?>" data-etapa="sprite_renderer"><i class="material-icons suave">assignment</i>Sprite Renderer</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade39', 'sprite_creator'])); ?>" data-etapa="sprite_creator"><i class="material-icons suave">assignment</i>Sprite Creator</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade39', 'sprite_inspetor'])); ?>" data-etapa="sprite_inspetor"><i class="material-icons suave">assignment</i>Sprite Inspetor</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="item" data-unidade="unidade40">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade40', 'asset_gameobject'])); ?>" data-etapa="asset_gameobject"><i class="material-icons suave">assignment</i>Asset ao GameObject</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade40', 'tilemap'])); ?>" data-etapa="tilemap"><i class="material-icons suave">assignment</i>Tilemap</a>
                        </li>
                    </ul>
                </li>
                 ...
                 <li class="item" data-unidade="unidade41">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade41', 'tile_palette'])); ?>" data-etapa="tile_palette"><i class="material-icons suave">assignment</i>Tile Palette</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade41', 'tilemap_collider'])); ?>" data-etapa="tilemap_collider"><i class="material-icons suave">assignment</i>Tilemap Collider</a>
                        </li>
                    </ul>
                </li>
                <!--UNIDADE 42-->
                <li class="item" data-unidade="unidade42">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade42', 'prefab'])); ?>" data-etapa="prefab"><i class="material-icons suave">assignment</i>Prefab</a>
                        </li>
                    </ul>
                </li>
                 ...
                 <li class="item" data-unidade="unidade43">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade43', 'game_art'])); ?>" data-etapa="game_art"><i class="material-icons suave">assignment</i>Game Art</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade43', 'composicao_dinamica'])); ?>" data-etapa="composicao_dinamica"><i class="material-icons suave">assignment</i>Composição Dinâmica</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="item" data-unidade="unidade44">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade44', 'personagens_poses'])); ?>" data-etapa="personagens_poses"><i class="material-icons suave">assignment</i>Personagens e Poses</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade44', 'poses_dinamicas'])); ?>" data-etapa="poses_dinamicas"><i class="material-icons suave">assignment</i>Poses Dinâmicas</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="item" data-unidade="unidade45">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade45', 'linhas_movimento'])); ?>" data-etapa="linhas_movimento"><i class="material-icons suave">assignment</i>Linhas de Movimento</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('apostila5', ['unidade45', 'velocidade_tensao_movimento'])); ?>" data-etapa="velocidade_tensao_movimento"><i class="material-icons suave">assignment</i>Velocidade Movimento</a>
                        </li>
                    </ul>
                </li>
            </ul>
...
</script><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/layouts/menus/mSidebar.blade.php ENDPATH**/ ?>
<?php $__env->startSection('titulo','Unit 41 | Tile Palette'); ?>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit41/imagem01.png')); ?>" alt="guia1" style="width:55%;">
</figure>
<p style="margin-top:20px;">Da esquerda para a direita, vamos conhecer as ferramentas da janela Tile Palette</p>
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit41/imagem02.png')); ?>" alt="guia1" style="width:55%;">
</figure>
<p style="margin-top:20px;"><strong>Selection</strong>: Permite selecionar um tile na janela Paleta de tiles para ver as
configurações do tile. <img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit41/imagem03.png')); ?>" alt="guia1" style="width:50px; display:inline;"></p>
<p><strong>Move</strong>: Permite mover os tiles pela visualização da cena. <img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit41/imagem04.png')); ?>" alt="guia1" style="width:50px; display:inline;"></p>
<p><strong>Brush</strong>: Permite pintar na Scene com o tile selecionado na janela Tile Palette. <img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit41/imagem05.png')); ?>" alt="guia1" style="width:50px; display:inline;"></p>
<p><strong>Fill Selection</strong>: permite definir uma área a ser preenchida com um Tile selecionado. <img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit41/imagem06.png')); ?>" alt="guia1" style="width:50px; display:inline;"></p>
<p><strong>Tile Sampler</strong>: permite que você selecione tiles da cena; funciona como qualquer conta-gotas
em sotware de manipulação de imagens. <img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit41/imagem07.png')); ?>" alt="guia1" style="width:50px; display:inline;"></p>
<p> <strong>Eraser</strong>: apaga os tiles na visualização da Scene. <img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit41/imagem08.png')); ?>" alt="guia1" style="width:50px; display:inline;"></p>
...
computador. <img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit41/imagem09.png')); ?>" alt="guia1" style="width:50px; display:inline;"></p>
...
pré-existente.</p>
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit41/imagem10.png')); ?>" alt="guia1" style="width:55%;">
</figure>
<p style="margin-top:20px;">Dê um nome à sua nova palette/paleta. Isso criará uma nova tile palette para você usar.</p>
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit41/imagem11.png')); ?>" alt="guia1" style="width:55%;">
</figure>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade41/tile_palette.blade.php ENDPATH**/ ?>
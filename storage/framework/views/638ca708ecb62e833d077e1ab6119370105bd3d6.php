        ...
        <div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade6" data-etapa="grammar">
            ...
            <div style="margin-top: 16px">
                ...
                <div style="margin-top: 36px">
                    <figure>
                        <img src="<?php echo e(asset('assets/img/dominating/unit6/grammar.png')); ?>" alt="jogos">
                    </figure>
                </div>
                <div class="clear"></div>
                ...
                <div style="margin-top: 36px">
                    <figure>
                        <img src="<?php echo e(asset('assets/img/dominating/unit6/grammar4.jpg')); ?>" alt="rapper">
                    </figure>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila2/unidade6/grammar.blade.php ENDPATH**/ ?>
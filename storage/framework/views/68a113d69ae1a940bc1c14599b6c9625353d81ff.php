<?php $__env->startSection('titulo','Unit 33 | Scene View'); ?>
...
transformar nossos GameObjects. A captura de tela a seguir exibe nossa Scene View:
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit33/imagem12.png')); ?>" alt="guia1" style="width:75%; margin: 0 auto;">
				</figure>
			</div>
...
em pastas, conforme mostrado na seguinte captura de tela:</p>
                <figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit33/imagem13.png')); ?>" alt="guia1" style="width:75%;">
				</figure>
...
você não encontrá-la, pode abri-la via <strong> Window> General> Project. </strong></p>
                <figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit33/imagem14.png')); ?>" alt="guia1" style="width:55%;">
				</figure>
...
seu tipo (por exemplo, script, material, subpasta).</p>
                <figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit33/imagem15.png')); ?>" alt="guia1" style="width:55%;">
				</figure>
...
<p>Barra de ferramentas da janela do projeto</p>
                <figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit33/imagem16.png')); ?>" alt="guia1" style="width:55%;">
				</figure>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade33/scene_view.blade.php ENDPATH**/ ?>
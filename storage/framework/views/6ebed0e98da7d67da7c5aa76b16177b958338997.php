    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila3" data-unidade="unidade14" data-etapa="grammar">
            ...
            <audio controls="" controlslist="nodownload" class="suave">
                <source src="<?php echo e(asset('assets/audio/apostila3/LESSON 14/03_GRAMMAR/GRAMMAR_14.mp3')); ?>" type="audio/mp3">
            </audio>
            <div class="clear"></div>
            ...
            <div style="margin-top:32px">
				<figure>
					<img src="<?php echo e(asset('assets/img/masteroflanguage/unit14/grammar.jpg')); ?>" alt="x-men">
				</figure>
			</div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila3/unidade14/grammar.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('titulo','Unit 23 | Grammar'); ?>
    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade23" data-etapa="grammar">
            ...
            <audio controls="" controlslist="nodownload" class="suave">
                <source src="<?php echo e(asset('assets/audio/apostila2/UNIT 23/3. GRAMMAR/GRAMMAR.ogg')); ?>" type="audio/ogg">
            </audio>
            <div class="clear"></div>
            ...
            <h5 class="barlow" style="margin-top:16px"><b>EXERCISES</b></p>
                ...
                <figure class="umterco">
                    <img src="<?php echo e(asset('assets/img/dominating/unit23/grammar1.png')); ?>" alt="dev">
                </figure>
                <figure class="umterco">
                    <img src="<?php echo e(asset('assets/img/dominating/unit23/grammar2.png')); ?>" alt="dev">
                </figure>
                <figure class="umterco">
                    <img src="<?php echo e(asset('assets/img/dominating/unit23/grammar3.png')); ?>" alt="dev">
                </figure>
                <div class="clear"></div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila2/unidade23/grammar.blade.php ENDPATH**/ ?>
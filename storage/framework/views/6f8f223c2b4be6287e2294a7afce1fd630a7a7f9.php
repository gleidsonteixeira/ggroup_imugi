<?php $__env->startSection('titulo','Corel Draw | Aula 7 – Camadas'); ?>
...
o exemplo de uma laranja simples.</p>
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem5.jpg')); ?>" alt="guia" style="width:95%!important;" >
                </figure>
...
devem ser refeitos os desenhos ou pinturas.</p>
            ...
            <div class="metade direita">
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem6.jpg')); ?>" alt="guia" style="width:95%!important;" >
                </figure>
                <figure style="margin-bottom:16px;">
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem7.jpg')); ?>" alt="guia" style="width:95%!important;" >
                </figure>
                <p><img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem8.jpg')); ?>" alt=""  style="display: inline-block; width:50px;"> Exibir páginas, camadas e objetos. </p>
                <p><img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem9.jpg')); ?>" alt=""  style="display: inline-block; width:50px;"> Exibir camadas e objetos. </p>
                <p><img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem10.jpg')); ?>" alt=""  style="display: inline-block; width:50px;"> Exibir páginas. <p>
                <p> <img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem11.jpg')); ?>" alt=""  style="display: inline-block; width:50px;">  Nova Camada </p>
                <p> <img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem12.jpg')); ?>" alt=""  style="display: inline-block; width:50px;">  Nova camada principal (todas as páginas) </p>
                <p> <img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem13.jpg')); ?>" alt=""  style="display: inline-block; width:50px;">   Adicionar efeito </p>
                <p> <img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem14.jpg')); ?>" alt=""  style="display: inline-block; width:50px;"> Excluir Atividades</p>
            </div>
            <div class="clear"></div>
            <div style="margin-top:40px;">
                <div class="metade esquerda">
                    <figure>
                        <img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem15.jpg')); ?>" alt="guia" style="width:95%!important;" >
                    </figure>
                </div>
                <div class="metade direita">
                    <figure>
                        <img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem16.jpg')); ?>" alt="guia" style="width:95%!important;" >
                    </figure>
                 </div>
            </div>
            <div class="clear"></div>
...
<img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem17.jpg')); ?>" alt=""  style="display: inline-block; width:50px;">
...
<p>Outro modo é apertando o botão direito do mouse no objeto bloqueado que irá surgir o menu ao abaixo.</p>
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem18.jpg')); ?>" alt="guia" style="width:25%!important;" >
                </figure>
                <p style="margin-top:20px;">Ao selecionar um ou mais objetos a barra de propriedades muda adicionando <img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem19.jpg')); ?>" alt=""  style="display: inline-block; width:50px;"> botão de alinhar e
...
objetos, onde modificamos as camadas e também aparece as opções de formato descrita na imagem abaixo.</p>
            ...
            <div style="margin-top:40px;">
                <div class="metade esquerda">
                    <figure>
                        <img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem20.jpg')); ?>" alt="guia" style="width:95%!important;" >
                    </figure>
                </div>
                <div class="metade direita">
                    <figure>
                        <img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem21.jpg')); ?>" alt="guia" style="width:95%!important;" >
                    </figure>
                 </div>
            </div>
            <div class="clear"></div>
            <div style="margin-top:40px;">
                <div class="metade esquerda">
                    <figure>
                        <img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem22.jpg')); ?>" alt="guia" style="width:70%!important;" >
                    </figure>
                </div>
                <div class="metade direita">
                    <figure>
                        <img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem23.jpg')); ?>" alt="guia" style="width:95%!important;" >
                    </figure>
                 </div>
            </div>
            <div class="clear"></div>
            <div style="margin-top:40px;">
                <div class="metade esquerda">
                    <figure>
                        <img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem24.jpg')); ?>" alt="guia" style="width:70%!important;" >
                    </figure>
                </div>
                <div class="metade direita">
...
adicionar cor ou detalhes de traçado para aplicar no painel de artes ou mural de trabalhos.</p>
               <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem25.jpg')); ?>" alt="guia" style="width:50%!important; margin: 0 auto;" >
                </figure>
...
trabalhos ou projetos.</p>
            ...
            <div style="margin-top:40px;">
                <div class="metade esquerda">
                    <figure>
                        <img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem26.jpg')); ?>" alt="guia" style="width:60%!important;" >
                    </figure>
                </div>
                <div class="metade direita">
...
<figure>
                        <img src="<?php echo e(asset('assets/img/photoshop/corel/aula06/imagem27.jpg')); ?>" alt="guia" style="width:60%!important; margin: 0 auto;" >
                    </figure>
            </div>
        </div>
</main>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/corel-draw/aula24.blade.php ENDPATH**/ ?>
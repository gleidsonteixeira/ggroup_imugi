...
<?php $__env->startSection('titulo','Unit 9 | Aula 20 – Animação Quadro-a-Quadro'); ?>
		...
		<div id="unidade" class="box" data-apostila="apostila4" data-unidade="unidade9" data-etapa="aula20">
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem1.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem2.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem3.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <p>Podemos duplicar o frame atual clicando no botão Duplicaté Selected Frame<i><img class="iconex" src="<?php echo e(asset('assets/img/photoshop/unit9/icone1.png')); ?>" alt="guia"></i></p>
            <p>Para criar um novo frame, podemos clicar no botão do menu do painel Timeline e escolher a opção New Frame</p>
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem4.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem5.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem6.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem7.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem8.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            <p style="margin-top:32px">
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem9.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem10.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem11.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem12.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem13.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem14.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>   
            <p style="margin-top:32px">
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem15.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem16.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem17.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem18.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            <p style="margin-top:32px">
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem19.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            <p style="margin-top:32px">
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem20.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem21.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem22.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <p>
                ...
                <i><img class="iconex" src="<?php echo e(asset('assets/img/photoshop/unit9/icone2.png')); ?>" alt="guia"></i>
            </p>
            ...
            <p>
                ...
                <i><img class="iconex" src="<?php echo e(asset('assets/img/photoshop/unit9/icone3.png')); ?>" alt="guia"></i>
            </p>
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem23.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            <p style="margin-top:32px">
                2. Para alternar a visualização de todas as composições de camada, use os botões
                Anterior <i><img class="iconex" src="<?php echo e(asset('assets/img/photoshop/unit9/icone4.png')); ?>" alt="guia"></i> 
                e Próximo na parte inferior do painel. <i><img class="iconex" src="<?php echo e(asset('assets/img/photoshop/unit9/icone5.png')); ?>" alt="guia"></i>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/unidade9/aula20.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('titulo','Aprimorar'); ?>
...
<main>
    ...
    <section id="aprimorar-banner">
        <img src="<?php echo e(asset('assets/site/images/banner-aprimorar.png')); ?>" alt="Bem-vindo" />
        <div class="content">
            <img src="<?php echo e(asset('assets/site/images/logo_aprimorar.png')); ?>" alt="Aprimorar" />
    ...
    <section id="aprimorar-vantagens">
        <div class="item">
            <img src="<?php echo e(asset('assets/site/images/aluna2-imugi.png')); ?>" alt="Aluna" data-aos="fade" data-aos-once="true" />
            <div class="bandeiras">
                <img src="<?php echo e(asset('assets/site/images/bandeira1.png')); ?>" alt="Inglaterra" data-aos="fade-right" data-aos-delay="300" data-aos-once="true" />
                <img src="<?php echo e(asset('assets/site/images/bandeira2.png')); ?>" alt="EUA" data-aos="fade-right" data-aos-delay="500" data-aos-once="true" />
                <img src="<?php echo e(asset('assets/site/images/bandeira3.png')); ?>" alt="Espanhol" data-aos="fade-right" data-aos-delay="700" data-aos-once="true" />
            </div>
        </div>
        <div class="item">
    ...
    <section id="aprimorar-conquistas">
        ...
        <img src="<?php echo e(asset('assets/site/images/conquista-banner.png')); ?>" alt="conquista" data-aos="fade-right" data-aos-delay="300" data-aos-once="true">
        <ul class="numeros">
            <li data-aos="fade-left" data-aos-delay="1200" data-aos-once="true">
...
<?php echo $__env->make('layouts.site.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\imugi2\resources\views/site/aprimorar.blade.php ENDPATH**/ ?>
...
<section class="wow fadeIn depoimento_img"  id="matricula" style="margin-top:60px; background-image: url(<?php echo e(asset('assets/site/images/bg-depoimento.jpg')); ?>); background-repeat:no-repeat; background-position: center bottom; background-size:100% heigth:100%;">
                <div class="container">
            ...
            <section class="wow fadeIn bg_bvd"  style="background-image: url(<?php echo e(asset('assets/site/images/bg-video-depoimento.jpg')); ?>); background-repeat:no-repeat; background-position: center bottom; background-size:100% heigth:100%;">
            <div class="container ">
                <div class="row align-items-center"> 
                    <div class="col-12 col-lg-12 text-center">
                        <a class="popup-youtube" href="https://www.youtube.com/watch?v=oS2BG66RVic">
                            <img src="<?php echo e(asset('assets/site/images/depoimento-video.jpg')); ?>" alt="" style="width:80%;">
                            <div class="icon-play">
            ...
            <div class="container">
                <div class="row" >
                    ...
                    <div class="col-12 col-md-4 md-margin-four-bottom text-center sm-margin-twelve-bottom wow fadeInRight last-paragraph-no-margin">
                        <img src="<?php echo e(asset('assets/site/images/depoimentos/1.jpg')); ?>" class="rounded-circle width-30 margin-30px-bottom" alt=""/>
                    ...
                    <div class="col-12 col-md-4 md-margin-four-bottom text-center sm-margin-twelve-bottom wow fadeInRight last-paragraph-no-margin" data-wow-delay="0.2s">
                        <img src="<?php echo e(asset('assets/site/images/depoimentos/2.jpg')); ?>" class="rounded-circle width-30 margin-30px-bottom" alt=""/>
                        <p class="width-90 mx-auto">
                    ...
                    <div class="col-12 col-md-4 md-margin-four-bottom text-center wow fadeInRight last-paragraph-no-margin" data-wow-delay="0.4s">
                        <img src="<?php echo e(asset('assets/site/images/depoimentos/3.jpg')); ?>" class="rounded-circle width-30 margin-30px-bottom" alt=""/>
                        <p class="width-90 mx-auto">
        ...
        <section class="wow fadeIn">
            <div class="container">
                <div class="row">
                    <!-- start testimonial item -->
                    <div class="col-12 col-md-4 md-margin-four-bottom text-center sm-margin-twelve-bottom wow fadeInRight last-paragraph-no-margin">
                        <img src="<?php echo e(asset('assets/site/images/depoimentos/4.jpg')); ?>" class="rounded-circle width-30 margin-30px-bottom" alt=""/>
                        <p class="width-90 mx-auto">
                    ...
                    <!-- start testimonial item -->
                    <div class="col-12 col-md-4 md-margin-four-bottom text-center sm-margin-twelve-bottom wow fadeInRight last-paragraph-no-margin" data-wow-delay="0.2s">
                        <img src="<?php echo e(asset('assets/site/images/depoimentos/5.jpg')); ?>" class="rounded-circle width-30 margin-30px-bottom" alt=""/>
                        <p class="width-90 mx-auto">
                    ...
                    <!-- start testimonial item -->
                    <div class="col-12 col-md-4 md-margin-four-bottom text-center wow fadeInRight last-paragraph-no-margin" data-wow-delay="0.4s">
                        <img src="<?php echo e(asset('assets/site/images/depoimentos/6.jpg')); ?>" class="rounded-circle width-30 margin-30px-bottom" alt=""/>
                        <p class="width-90 mx-auto">
...
<?php echo $__env->make('layouts.site.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/site/depoimento/index.blade.php ENDPATH**/ ?>
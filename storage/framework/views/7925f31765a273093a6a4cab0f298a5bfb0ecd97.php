		...
		<div class="dashboard">
			<div id="unidade" class="box" data-apostila="apostila1" data-unidade="unidade16" data-etapa="conversation">
				...
				<audio controls="" controlslist="nodownload" class="suave">
					<source src="<?php echo e(asset('assets/audio/unit16/conversation/completo.ogg')); ?>" type="audio/ogg">
				</audio>
				<div class="clear"></div>
				...
				<figure>
					<img src="<?php echo e(asset('assets/img/playgo/unit16/ilust_16.jpg')); ?>" alt="New class" class=img-e>
				</figure>
				<div class="video-pratica">
					<video controls="" poster="<?php echo e(asset('assets/portal/images/play-video.jpg')); ?>"  controlslist="nodownload" disablepictureinpicture="" src="https://fpeduc.com/assets/videos/playgo16.mp4"></video>
				</div>
			</div>
		</div>
	</main>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila1/unidade16/conversation.blade.php ENDPATH**/ ?>
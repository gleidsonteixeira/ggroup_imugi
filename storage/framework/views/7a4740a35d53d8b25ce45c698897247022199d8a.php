...
<?php $__env->startSection('titulo','Unit 32 | Cenário e Ambiente'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade32" data-etapa="cenario_ambiente">
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit32/imagem_unit32_1.png')); ?>" alt="guia1">
				</figure>
			</div>
			<h5>Portas</h5>
			<p>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit32/imagem_unit32_2.png')); ?>" alt="guia2">
				</figure>
			</div>
			<h5>Iluminação</h5>
			<p>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit32/imagem_unit32_3.png')); ?>" alt="guia3">
				</figure>
			</div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade32/cenario_ambiente.blade.php ENDPATH**/ ?>
<?php $__env->startSection('titulo','Unit 35 | Asset'); ?>
...
a Animator Controller ou Render Texture.
			...
			<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit35/imagem01.png')); ?>" alt="guia1" style="width:75%;">
				</figure>
...
disponível no Unity asset store. Os packages/pacotes de assets permitem que você compartilhe e reutilize projetos e coleções de assets do Unity.</p>
            ...
            <figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit35/imagem02.png')); ?>" alt="guia1" style="width:75%;">
				</figure>
            </div>
...
assets diretamente para o seu projeto.</p>
            ...
            <div class="clear"></div>
            <figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit35/imagem03.png')); ?>" alt="guia1" style="width:75%;">
			</figure>
...
<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit35/imagem04.png')); ?>" alt="guia1" style="width:75%;">
			</figure>
<ul>
...
<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit35/imagem05.png')); ?>" alt="guia1" style="width:75%;">
			</figure>
<ul>
...
<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit35/imagem06.png')); ?>" alt="guia1" style="width:75%;">
			</figure>
		</div>
    </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade35/asset.blade.php ENDPATH**/ ?>
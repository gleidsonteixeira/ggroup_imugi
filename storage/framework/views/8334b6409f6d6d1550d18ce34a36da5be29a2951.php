...
<?php $__env->startSection('titulo','Unit 11 | Animações'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade11" data-etapa="animacoes">
			...
			<div>
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit11/imagem_unit11_1.png')); ?>" alt="guia1">
				</figure>
			</div>
			<div>
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit11/imagem_unit11_2.png')); ?>" alt="guia2">
				</figure>
			</div>
			<p>
			...
			<div>
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit11/imagem_unit11_3.png')); ?>" alt="guia3">
				</figure>
			</div>
			<p>
			...
			<div>
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit11/imagem_unit11_4.png')); ?>" alt="guia4">
				</figure>
			</div>
			<p>
			...
			<div>
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit11/imagem_unit11_5.png')); ?>" alt="guia5">
				</figure>
			</div>
			<div class="container">
				...
				<div class="metade direita">
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit11/imagem_unit11_6.png')); ?>" alt="guia6">
					</figure>
				</div>
			</div>
			<div class="clear"></div>
			<div class="metade">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit11/imagem_unit11_7.png')); ?>" alt="guia7">
				</figure>
			</div>
			<br>
			<div class="container">
				<div class="elemento4">
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit11/imagem_unit11_8.png')); ?>" alt="guia8">
					</figure>
				</div>
				<div class="elemento">
					<p>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade11/animacoes.blade.php ENDPATH**/ ?>
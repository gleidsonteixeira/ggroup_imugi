...
<?php $__env->startSection('titulo','Unit 4 | Aula 09 – Seleção canais e Seleção máscara rápida'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila4" data-unidade="unidade4" data-etapa="aula9">
			...
			<p>I. Clicar no botão Edit in Quick Mask Mode<img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit4/imagem1.PNG')); ?>" alt="guia">.</p>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit4/imagem2.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit4/imagem3.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit4/imagem4.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit4/imagem5.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit4/imagem6.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit4/imagem7.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit4/imagem8.PNG')); ?>" alt="guia">
                </figure>
            </div>
			<p>II. Na janela que surgir, selecione Alpha1 na opção Channel.</p>
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit4/imagem9.PNG')); ?>" alt="guia">
                </figure>
            </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/unidade4/aula9.blade.php ENDPATH**/ ?>
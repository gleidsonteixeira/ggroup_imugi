...
<!-- WRAPPER ALL -->
	...
	<main>
		...
		<div class="dashboard">
			<div id="unidade" class="box" data-apostila="apostila1" data-unidade="unidade27" data-etapa="understanding">
                ...
                <div class="metade">
                    <form id="unidade27understanding70" method="post">
                        ...
                        <input type="hidden" name="atividade_id" value="70">
    ...
    <script>
        ...
        $("#unidade27understanding70").submit(function(e){
            e.preventDefault();
            $(this).find('button').prop('disabled', true);
            var respostas = '{';
            $('#unidade27understanding70 input[type="text"]').each(function(index){
                if(($('#unidade27understanding70 input[type="text"]').length - 1) == index){
                    respostas += '"'+$(this).attr("name")+'":"'+$(this).val()+'"}';
                }else{
                    respostas += '"'+$(this).attr("name")+'":"'+$(this).val()+'",';
                }
            });
            if($('#unidade27understanding70 input[name="resposta_id"').val() != 0){
                atualizarAtividade($('#unidade27understanding70'), respostas);
            }else{
                enviarAtividade($('#unidade27understanding70'), respostas);
            }
        });
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila1/unidade27/understanding.blade.php ENDPATH**/ ?>
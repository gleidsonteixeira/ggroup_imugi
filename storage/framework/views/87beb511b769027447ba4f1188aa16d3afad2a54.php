<?php $__env->startSection('titulo','Unit 1 | Listening'); ?>
		...
		<div class="dashboard">
			<div id="unidade" class="box" data-apostila="apostila1" data-unidade="unidade1" data-etapa="listening">
				...
				<audio controls="" controlslist="nodownload" class="suave">
					<source src="<?php echo e(asset('assets/audio/unit1/listining/listining_a.ogg')); ?>" type="audio/ogg">
                </audio>
                <div class="clear"></div>
                ...
                <span class="play-audio">( Aperte o play )</span>
                <audio controls="" controlslist="nodownload" class="suave">
                    <source src="<?php echo e(asset('assets/audio/unit1/listining/listining_b.ogg')); ?>" type="audio/ogg">
                </audio>
                <div class="clear"></div>
                <div class="espacamento">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila1/unidade1/listening.blade.php ENDPATH**/ ?>
<?php $__env->startSection('titulo','Corel Draw | Aula 9 – Objetos e Símbolos'); ?>
...
o mesmo vale para o uso do botão direito com o objeto selecionado como na imagem a seguir.</p>
                <figure style="margin-bottom:40px;">
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula09/imagem1.jpg')); ?>" alt="guia" style="width:75%!important;" >
                </figure>
...
temas disponibilizado pelo professor(a).</p>
               <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula09/imagem2.jpg')); ?>" alt="guia" style="width:65%!important; margin: 0 auto;" >
                </figure>
            </div>
            <div style="margin-top:16px">
...
criadas utilizando-se modelos e paletas de cores.</p>
              <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula09/imagem3.jpg')); ?>" alt="guia" style="width:45%!important; margin: 0 auto;" >
                </figure>
...
veja abaixo os exemplos.</p>
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula09/imagem4.jpg')); ?>" alt="guia" style="width:45%!important; margin: 0 auto;" >
                </figure>
...
tamanho, resolução e profundidade de bits.</p>
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula09/imagem5.jpg')); ?>" alt="guia" style="width:45%!important; margin: 0 auto;" >
                </figure>
...
ainda mover seu centro para criar efeitos mais dinamicos em seus projetos.
                ...
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula09/imagem6.jpg')); ?>" alt="guia" style="width:45%!important; margin: 0 auto;" >
                </figure>
                <p style="margin-top:20px;">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/corel-draw/aula26.blade.php ENDPATH**/ ?>
...
<section class="wow fadeIn bem_vindo_img"  id="matricula" style="background-image: url(<?php echo e(asset('assets/site/images/bg-curso.png')); ?>); background-repeat:no-repeat; background-position: center;">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-12 col-lg-6 text-center md-margin-50px-bottom sm-margin-30px-bottom">
                            <div class="text-center text-lg-left md-no-padding-lr">
                                <img src="<?php echo e(asset('assets/site/images/logo-cgfly.png')); ?>" alt="" class="logo-curso">
            ...
            <img src="<?php echo e(asset('assets/site/images/seta.png')); ?>" alt="" class="seta">
            ...
            <div class="container ">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-3 col-md-6 text-center md-margin-50px-bottom sm-margin-30px-bottom wow fadeInUp last-paragraph-no-margin">
                       <img src="<?php echo e(asset('assets/site/images/icones/modulos.png')); ?>" alt="" width="160">
                        <p class="">
                        3. Módulos
                        </p>
                    </div>
                    ...
                    <!-- start features box item -->
                    <div class="col-12 col-lg-3 col-md-6 text-center md-margin-50px-bottom sm-margin-30px-bottom wow fadeInUp last-paragraph-no-margin">
                          <img src="<?php echo e(asset('assets/site/images/icones/calendario.png')); ?>" alt="" width="160">
                        <p class="">
                            32. Meses
                            </p>
                        </div>
                    ...
                    <!-- start features box item -->
                    <div class="col-12 col-lg-3 col-md-6 text-center md-margin-50px-bottom sm-margin-30px-bottom wow fadeInUp last-paragraph-no-margin">
                            <img src="<?php echo e(asset('assets/site/images/icones/horas.png')); ?>" alt="" width="160">
                            <p class="">384. Horas</p>
                        </div>
                        <div class="col-12 col-lg-3 col-md-6 text-center md-margin-50px-bottom sm-margin-30px-bottom wow fadeInUp last-paragraph-no-margin">
                            <img src="<?php echo e(asset('assets/site/images/icones/idade-minima.png')); ?>" alt="" width="160">
...
internacional
                    ...
                    <img src="<?php echo e(asset('assets/site/images/modulos.png')); ?>" alt="" class="modulos" style="position:absolute; width:60%; absolute; right:0px;">
                </div>
        ...
        <section class="p-0 wow fadeIn" style="padding-top:80px!important;">
                <div class="container">
                    <div class="row"> 
                            <div class="col-12 col-lg-6 cover-background md-height-400px wow fadeInRight" style="background-image:url(<?php echo e(asset('assets/site/images/cg.png')); ?>);"></div>
                        <div class="col-12 col-lg-6 wow fadeInLeft padding-four-all md-padding-eight-all md-padding-15px-lr sm-padding-50px-tb">
                            <div class="row m-0">
                                <div class="col-12 col-xl-10 margin-six-bottom lg-margin-six-bottom md-margin-30px-bottom sm-no-margin-bottom">
                                 <h2 class="titulo-curso">Computação Gráfica</h2>
                                 <p>
                                 Vivemos em um mundo digital, onde a interatividade está cada vez mais presente
                                na vida das pessoas. Com as ferramentas certas do CG você irá dominar esse universo.
                                    </p>
        ...
        <section class="p-0 wow fadeIn" style="padding:60px 0px!important;">
            <div class="container">
                <div class="row"> 
                    ...
                    <div class="col-12 col-lg-6 cover-background md-height-400px wow fadeInRight" style="background-image:url(<?php echo e(asset('assets/site/images/ingles.png')); ?>)"></div>
                </div>
            </div>
        </section>
        </div>
        <section class="wow fadeIn" style="padding:10px 0px 0px 0px!important;">
                <div class="container"> 
                    <div class="row align-items-center">
                        <div class="col-12 col-lg-5 text-center wow fadeInLeft">
                                <img src="<?php echo e(asset('assets/site/images/aluno.png')); ?>" alt="" class="w-100">
                        </div> 
            ...
            <img src="<?php echo e(asset('assets/site/images/divisor.png')); ?>" alt="" class="w-100">
            ...
            <div class="row mb-4">
                ...
                <div class="row">
                    <!-- start features box item -->
                    <div class="col-12 col-lg-3 col-md-6 text-center md-margin-50px-bottom sm-margin-30px-bottom wow fadeInUp last-paragraph-no-margin">
                       <img src="<?php echo e(asset('assets/site/images/icones/material-didatico.png')); ?>" alt="" width="160">
                    ...
                    <!-- end features box item -->
                    <div class="col-12 col-lg-3 col-md-6 text-center md-margin-50px-bottom sm-margin-30px-bottom wow fadeInUp last-paragraph-no-margin">
                       <img src="<?php echo e(asset('assets/site/images/icones/central-estagio.png')); ?>" alt="" width="160">
...
e o mercado de trabalho.
                    ...
                    <!-- start features box item -->
                    <div class="col-12 col-lg-3 col-md-6 text-center md-margin-50px-bottom sm-margin-30px-bottom wow fadeInUp last-paragraph-no-margin">
                       <img src="<?php echo e(asset('assets/site/images/icones/aprimorar.png')); ?>" alt="" width="160">
                    ...
                    <div class="col-12 col-lg-3 col-md-6 text-center md-margin-50px-bottom sm-margin-30px-bottom wow fadeInUp last-paragraph-no-margin">
                       <img src="<?php echo e(asset('assets/site/images/icones/reposicao.png')); ?>" alt="" width="160">
...
de reposição para faltas justificadas e todo um acompanhamento pedagógico no decorrer do curso.
        ...
        <section class="wow fadeIn" style="background-image: url(<?php echo e(asset('assets/site/images/depoimentos.png')); ?>); background-repeat:no-repeat; background-position: bottom; background-position-x: top; padding:50px 0px;">
            <div class="container">
...
<?php echo $__env->make('layouts.site.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/site/cursos/cgfly.blade.php ENDPATH**/ ?>
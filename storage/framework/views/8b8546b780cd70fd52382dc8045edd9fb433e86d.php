<?php $__env->startSection('titulo','Portal do Aluno | Home'); ?>
        ...
        <div class="carousel slide">
			...
			<div class="carousel slide">
				<section class="carousel-inner">
					<div class="item active">
					    <img src="<?php echo e(asset('assets/portal/images/portal.png')); ?>" alt="Portal do Aluno">
					</div>
                </section>
                ...
                <section class="header-hero-section" id="hero-section">
                    <div class="hero-section-inner-wrap">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                            <img src="<?php echo e(asset('assets/portal/images/sucesso.jpg')); ?>" alt="Portal do Aluno">
                            </div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="hero-section-inner-wrap">
                        <div class="hero-section-inner">
                            <div class="carousel slide">
                                <div class="carousel-inner">
                                    <div class="item active">
                                        <img src="<?php echo e(asset('assets/portal/images/conhecendo.jpg')); ?>" alt="Portal do Aluno">
                                    </div>
                            </div>
                        </div>
                    </div>
               ...
               <section class="header-hero-section" id="hero-section" style="padding-top: ">
               	    <div class="header-hero-custom-section">
               		    <div class="hero-section-wrap be-section  full-no be-bg-cover be-bg-parallax  be-bg-overlay  clearfix" style="background: url('<?php echo e(asset('assets/portal/images/bg.png')); ?>') no-repeat fixed center center; height: 520px !important;">
	        ...
	        <div class="be-section-pad clearfix" style="padding-top:10px;padding-bottom:60px; background-color: #ffffff;">
               	<div class="be-row be-wrap clear">
					<div class="col-lg-12" style="margin-top: 80px;">
						...
						<div class="col-lg-6">
							<img src="<?php echo e(asset('assets/portal/images/logo_curso/code_block.jpg')); ?>" style="width: 200px">
							<img src="<?php echo e(asset('assets/portal/images/logo_curso/cg_fly.jpg')); ?>" style="width: 200px">
						</div>
					</div>
				</div>
            </div>
            <div class="carousel slide">
				<div class="carousel-inner">
					<div class="item active">
					      <img src="<?php echo e(asset('assets/portal/images/footer.png')); ?>" alt="Portal do Aluno">
					</div>
				</div>
...
<?php echo $__env->make('layouts.portal.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/portal/home/index.blade.php ENDPATH**/ ?>
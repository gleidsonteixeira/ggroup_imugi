...
<?php $__env->startSection('titulo','Unit 6 | Criando Objetos'); ?>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade6" data-etapa="criando_objetos">
			...
			<div class="container">
				...
				<div>
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit6/imagem_unit6_05.png')); ?>" alt="guia1">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit6/imagem_unit6_06.png')); ?>" alt="guia1">
					</figure>
				</div>
				<p>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade6/criando_objetos.blade.php ENDPATH**/ ?>
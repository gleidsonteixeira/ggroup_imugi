<?php $__env->startSection('titulo','Unit 37 | Componentes'); ?>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit37/imagem01.png')); ?>" alt="guia1" style="width:35%;">
</figure>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit37/imagem02.png')); ?>" alt="guia1" style="width:55%;">
</figure>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit37/imagem03.png')); ?>" alt="guia1" style="width:45%;">
</figure>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit37/imagem04.png')); ?>" alt="guia1" style="width:45%;">
</figure>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit37/imagem05.png')); ?>" alt="guia1" style="width:45%;">
</figure>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit37/imagem06.png')); ?>" alt="guia1" style="width:65%;">
</figure>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit37/imagem07.png')); ?>" alt="guia1" style="width:65%;">
</figure>
<p style="margin-top:20px;">Aguarde o Unity fazer o download dos seus assets.</p>
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit37/imagem08.png')); ?>" alt="guia1" style="width:65%;">
</figure>
<p style="margin-top:70px;">Após a conclusão do download, clique em <strong> import</strong>.</p>
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit37/imagem09.png')); ?>" alt="guia1" style="width:65%;">
</figure>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit37/imagem10.png')); ?>" alt="guia1" style="width:75%;">
</figure>
</div>
<div class="metade direita">
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit37/imagem11.png')); ?>" alt="guia1" style="width:65%;">
</figure>
</div>
<div class="clear"></div>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit37/imagem12.png')); ?>" alt="guia1" style="width:45%;">
</figure>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade37/importacao_asset.blade.php ENDPATH**/ ?>
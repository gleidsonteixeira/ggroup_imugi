...
<?php $__env->startSection('titulo','Unit 3 | Aula 08 – Retoque profissional'); ?>
		...
		<div id="unidade" class="box" data-apostila="apostila4" data-unidade="unidade3" data-etapa="aula8">
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit3/imagem21.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit3/imagem22.PNG')); ?>" alt="guia">
                </figure>
            </div>
			<p>III. Clicar no controle deslizante Radius da janela Gaussian Blur, para aumentar o percentual de desfoque.</p>
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit3/imagem23.PNG')); ?>" alt="guia">
                </figure>
            </div>
			<p>Observe o resultado:</p>
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit3/imagem24.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit3/imagem25.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit3/imagem26.PNG')); ?>" alt="guia">
                </figure>
            </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/unidade3/aula8.blade.php ENDPATH**/ ?>
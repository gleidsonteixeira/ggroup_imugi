    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade32" data-etapa="grammar">
            ...
            <figure class="metade esquerda">
                <img src="<?php echo e(asset('assets/img/dominating/unit32/grammar1.jpg')); ?>" alt="animal kingdom">
            </figure>
            <figure class="metade direita">
                <img src="<?php echo e(asset('assets/img/dominating/unit32/grammar2.jpg')); ?>" alt="Disney">
            </figure>
        </div>
    </div>
</main>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila2/unidade32/grammar.blade.php ENDPATH**/ ?>
<?php $__env->startSection('titulo','Corel Draw | Aula 11 – Cores'); ?>
		...
		<div id="unidade" class="box" data-apostila="photoshop-corel" data-unidade="unidade2" data-etapa="aula28">
            ...
            <p><strong> Conta Gotas </strong></p>
                <figure style="margin-bottom:40px;">
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula11/imagem1.jpg')); ?>" alt="guia" style="width:15%!important;" >
                </figure>
                <div style="margin-top:16px">
            <div class="metade esquerda">
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula11/imagem2.jpg')); ?>" alt="guia" style="width:95%!important;" >
                </figure>
            </div>
            <div class="metade direita">
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula11/imagem3.jpg')); ?>" alt="guia" style="width:55%!important;" >
                </figure>
            </div>
            <div class="clear"></div>
...
incrivel.</p>
            ...
            <div class="metade esquerda">
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula11/imagem5.jpg')); ?>" alt="guia" style="width:50%!important;" >
                </figure>
            </div>
            <div class="metade direita">
...
pele de elefante, plástico e escultura em relevo.</p>
            ...
            <p><strong> Mídia artística: </strong> Permite aplicar técnicas de pintura à mão</p>
              <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula11/imagem6.jpg')); ?>" alt="guia" style="width:55%!important;" >
                </figure>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/corel-draw/aula28.blade.php ENDPATH**/ ?>
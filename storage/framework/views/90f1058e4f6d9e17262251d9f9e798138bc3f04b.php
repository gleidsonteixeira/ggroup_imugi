<?php $__env->startSection('titulo','Unit 34 | Inspector Window'); ?>
...
campos e seus respectivos valores no Inspector.</p>
            ...
            <figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit34/imagem2.png')); ?>" alt="guia1" style="width:75%;">
				</figure>
            </div>
...
que podemos criar, conforme mostrado na imagem a seguir:</p>
                <figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit34/imagem3.png')); ?>" alt="guia1" style="width:75%;">
				</figure>
...
Inspetor e selecionando Remova o componente.</p>
                <figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit34/imagem4.png')); ?>" alt="guia1" style="width:35%;">
				</figure>
		</div>
    </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade34/inspector.blade.php ENDPATH**/ ?>
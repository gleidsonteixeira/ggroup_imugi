	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade20" data-etapa="conversation">
			...
			<audio controls="" controlslist="nodownload" class="suave">
				<source src="<?php echo e(asset('assets/audio/apostila2/UNIT 20/2. CONVERSATION/CONVERSATION.ogg')); ?>" type="audio/ogg">
			</audio>
			...
			<figure class="umterco">
				<img src="<?php echo e(asset('assets/img/dominating/unit20/conversation1.png')); ?>" alt="Garotos festejando">
			</figure>
			<figure class="umterco">
				<img src="<?php echo e(asset('assets/img/dominating/unit20/conversation2.png')); ?>" alt="Garotos festejando">
			</figure>
			<figure class="umterco">
				<img src="<?php echo e(asset('assets/img/dominating/unit20/conversation3.png')); ?>" alt="Garotos festejando">
			</figure>
		</div>
	</div>
</main>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila2/unidade20/conversation.blade.php ENDPATH**/ ?>
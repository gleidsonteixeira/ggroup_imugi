    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade2" data-etapa="grammar">
            ...
            <audio controls="" controlslist="nodownload" class="suave">
                <source src="<?php echo e(asset('assets/audio/apostila2/UNIT 2/3. GRAMMAR/GRAMMAR.ogg')); ?>" type="audio/ogg">
            </audio>
            <div class="clear"></div>
            ...
            <audio controls="" controlslist="nodownload" class="suave">
                <source src="<?php echo e(asset('assets/audio/apostila2/UNIT 2/3. GRAMMAR/GRAMMAR B E C.ogg')); ?>" type="audio/ogg">
            </audio>
            ...
            <figure class="center-align" style="margin-top:16px">
                <img src="<?php echo e(asset('assets/img/dominating/unit2/grammar.jpg')); ?>" alt="super man e batman">
            </figure>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila2/unidade2/grammar.blade.php ENDPATH**/ ?>
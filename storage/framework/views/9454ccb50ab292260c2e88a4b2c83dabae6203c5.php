	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade4" data-etapa="conversation">
			...
			<audio controls="" controlslist="nodownload" class="suave">
				<source src="<?php echo e(asset('assets/audio/apostila2/UNIT 4/2. CONVERSATION/CONVERSATION.ogg')); ?>" type="audio/ogg">
			</audio>
			...
			<figure class="center-align" style="margin-top:16px">
				<img src="<?php echo e(asset('assets/img/dominating/unit4/conversation.png')); ?>" alt="super man e batman">
			</figure>
		</div>
	</div>
</main>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila2/unidade4/conversation.blade.php ENDPATH**/ ?>
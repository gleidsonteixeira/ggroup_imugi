<?php $__env->startSection('titulo','Unit 40 | Atribuindo o asset ao GameObject'); ?>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit40/imagem01.png')); ?>" alt="guia1" style="width:35%;">
</figure>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit40/imagem02.png')); ?>" alt="guia1" style="width:55%;">
</figure>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit40/imagem03.png')); ?>" alt="guia1" style="width:55%;">
</figure>
...
captura de tela:</p>
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit40/imagem04.png')); ?>" alt="guia1" style="width:55%;">
</figure>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit40/imagem05.png')); ?>" alt="guia1" style="width:55%;">
</figure>
...
<p>A maneira mais rápida e simples de criar um Sprite GameObject é simplesmente arrastar o
 ...
 <figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit40/imagem06.png')); ?>" alt="guia1" style="width:55%;">
</figure>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade40/asset_gameobject.blade.php ENDPATH**/ ?>
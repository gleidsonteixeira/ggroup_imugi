...
<?php $__env->startSection('titulo','Unit 14 | Animação'); ?>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade14" data-etapa="animacao">
			...
			<div class="container">
				...
				<div>
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit14/imagem_unit14_1.png')); ?>" alt="guia1">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit14/imagem_unit14_2.png')); ?>" alt="guia2">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit14/imagem_unit14_3.png')); ?>" alt="guia3">
					</figure>
				</div>
				...
				<div>
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit14/imagem_unit14_4.png')); ?>" alt="guia4">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit14/imagem_unit14_5.png')); ?>" alt="guia5">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit14/imagem_unit14_6.png')); ?>" alt="guia6">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit14/imagem_unit14_7.png')); ?>" alt="guia7">
					</figure>
				</div>
				...
				<div>
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit14/imagem_unit14_8.png')); ?>" alt="guia8">
					</figure>
				</div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade14/animacao.blade.php ENDPATH**/ ?>
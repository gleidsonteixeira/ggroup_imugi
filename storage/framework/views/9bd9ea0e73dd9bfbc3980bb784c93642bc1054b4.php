...
<?php $__env->startSection('titulo','Unit 16 | PUPPET PIN'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila6" data-unidade="unidade16" data-etapa="puppet_pin">
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit16/imagem_unit16_1.png')); ?>" alt="guia1">
				</figure>
			</div><br>
			<p>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila6/unidade16/puppet_pin.blade.php ENDPATH**/ ?>
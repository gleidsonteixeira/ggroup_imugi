<?php $__env->startSection('titulo','Unit 38 | Scenes'); ?>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit38/imagem01.png')); ?>" alt="guia1" style="width:55%;">
</figure>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit38/imagem02.png')); ?>" alt="guia1" style="width:55%;">
</figure>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit38/imagem03.png')); ?>" alt="guia1" style="width:45%;">
</figure>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit38/imagem04.png')); ?>" alt="guia1" style="width:45%;">
</figure>
...
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit38/imagem05.png')); ?>" alt="guia1" style="width:65%;">
</figure>
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit38/imagem06.png')); ?>" alt="guia1" style="width:65%;">
</figure>
<p style="margin-top:40px;">Na janela Project você pode visualizar a scene/cena que foi criada.</p>
<figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit38/imagem07.png')); ?>" alt="guia1" style="width:65%;">
</figure>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade38/scenes.blade.php ENDPATH**/ ?>
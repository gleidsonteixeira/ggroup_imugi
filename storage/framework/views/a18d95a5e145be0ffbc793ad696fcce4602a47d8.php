...
<?php $__env->startSection('titulo','Unit 8 | Aula 17 - Pintura Digital I - Colorindo'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila4" data-unidade="unidade8" data-etapa="aula17">
			<h3 class="barlow">UNIT 8</h3>
			<h5 class="barlow upper">Aula 17 – Pintura Digital I - Colorindo</h5>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem1.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem2.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem3.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            <p style="margin-top:32px"><b>Pintar com a Brush Tool ou com a Pencil Tool</b><i><img class="iconex" src="<?php echo e(asset('assets/img/photoshop/unit8/icone1.png')); ?>" alt="guia"></i></p>
            ...
            <p><b>Toggle the Brush Panel</b><i><img class="iconex" src="<?php echo e(asset('assets/img/photoshop/unit8/icone2.png')); ?>" alt="guia"></i></p>
            <p>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem4.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            <p style="margin-top:32px"><b>Set Opacity for Stroke</b><i><img class="iconex" src="<?php echo e(asset('assets/img/photoshop/unit8/icone3.png')); ?>" alt="guia"></i><p>
            <p> 
            ...
            <p><b>Flow</b><i><img class="iconex" src="<?php echo e(asset('assets/img/photoshop/unit8/icone4.png')); ?>" alt="guia"></i></p>
            <p>
            ...
            <p><b>Seleção de uma preferência</b><i><img class="iconex" src="<?php echo e(asset('assets/img/photoshop/unit8/icone5.png')); ?>" alt="guia"></i></p> 
            <p>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem5.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem6.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <p><b>Flip Y</b></p>
            <p>Altera a direção de uma ponta de pincel em seu eixo y.<i><img class="iconex" src="<?php echo e(asset('assets/img/photoshop/unit8/icone6.png')); ?>" alt="guia"></i></p>
            <p><b>Angle</b></p>
            <p>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem7.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem8.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem9.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem10.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div class="metade esquerda">
                <p>Size</p>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem11.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="metade direita">
                <p>Flip X</p>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem12.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div class="metade esquerda" style="margin-top:16px">
                <p>Flip Y</p>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem13.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="metade direita" style="margin-top:16px">
                <p>Angle</p>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem14.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div class="metade esquerda" style="margin-top:16px">
                <p>Roundness</p>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem15.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="metade direita" style="margin-top:16px">
                <p>Harness</p>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem16.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            <br>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem17.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem18.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            <p style="margin-top:32px">
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem19.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem20.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            <p style="margin-top:32px">
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem21.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            <p style="margin-top:32px">
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem22.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <p>
                Use o Eyedropper tool <i><img class="iconex" src="<?php echo e(asset('assets/img/photoshop/unit8/icone7.png')); ?>" alt="guia"></i> para coletar amostras de uma imagem de referências para
                sua pintura digital.
            </p>
            <p>
            ...
            <figure class="metade esquerda">
                <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem23.png')); ?>" alt="guia">
            </figure>
            <figure class="metade direita">
                <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem24.png')); ?>" alt="guia">
            </figure>
            <div class="clear"></div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit8/imagem25.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/unidade8/aula17.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('titulo','Unit 22 | Camera Ativa'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade22" data-etapa="camera_ativa">
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit22/imagem_unit22_1.png')); ?>" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit22/imagem_unit22_2.png')); ?>" alt="guia2">
				</figure>
			</div>
			<p>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit22/imagem_unit22_3.png')); ?>" alt="guia3">
				</figure>
			</div>
			<p>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit22/imagem_unit22_4.png')); ?>" alt="guia4">
				</figure>
			</div>
			<p>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade22/camera_ativa.blade.php ENDPATH**/ ?>
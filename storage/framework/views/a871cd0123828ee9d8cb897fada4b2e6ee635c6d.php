<?php $__env->startSection('titulo','PHOTOSHOP | Aula 4 - Smart Objects e Smart Filters'); ?>
		...
		<div id="unidade" class="box" data-apostila="photoshop-corel" data-unidade="unidade1" data-etapa="aula4">
            ...
            <div>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit7/imagem1.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style=margin-top:16px>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit7/imagem2.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style=margin-top:16px>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit7/imagem3.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style=margin-top:16px>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit7/imagem4.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style=margin-top:16px>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit7/imagem5.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style=margin-top:16px>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit7/imagem6.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style=margin-top:16px>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit7/imagem7.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style=margin-top:16px>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit7/imagem8.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style=margin-top:16px>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit7/imagem9.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
            ...
            <div style=margin-top:16px>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit7/imagem10.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="clear"></div>
        </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/photoshop/aula4.blade.php ENDPATH**/ ?>
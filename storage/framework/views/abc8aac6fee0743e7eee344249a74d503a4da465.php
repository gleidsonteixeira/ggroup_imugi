<?php $__env->startSection('titulo','Corel Draw | Aula 16 – PowerTRACE'); ?>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="photoshop-corel" data-unidade="unidade2" data-etapa="aula33">
            ...
            <h5 class="barlow">Aula 16 – PowerTRACE </h5>
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula16/imagem1.jpg')); ?>" alt="guia" style="width:55%!important; margin: 0 auto;" >
                </figure>
            <div style="margin-top:30px">
            <div class="metade esquerda">
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula16/imagem2.jpg')); ?>" alt="guia" style="width:75%!important;" >
                </figure>
            </div>
...
o seu Código QR criando preenchimentos personalizados.</p>
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula16/imagem3.jpg')); ?>" alt="guia" style="width:75%!important;" >
                </figure>
            ...
            <div class="metade esquerda">
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula16/imagem4.jpg')); ?>" alt="guia" style="width:95%!important;" >
                </figure>
            </div>
            <div class="metade direita">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/corel-draw/aula33.blade.php ENDPATH**/ ?>
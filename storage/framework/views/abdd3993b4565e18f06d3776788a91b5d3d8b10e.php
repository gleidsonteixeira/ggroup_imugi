...
<?php $__env->startSection('titulo','Unit 5 | Aula 10 – Distorções e Perspectivas'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila4" data-unidade="unidade5" data-etapa="aula10">
			<h3 class="barlow">UNIT 5</h3>
			<h5 class="barlow upper">Aula 10 – Distorções e Perspectivas</h5>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit5/imagem1.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<p><b>Edit Plane tool</b><img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem2.PNG')); ?>" alt="guia"> - Seleciona, edita, move e redimensiona planos.</p>
			<p><b>Creaté Plane tool</b><img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem3.PNG')); ?>" alt="guia"> - Define os quatro nós de canto de um plano, ajusta o tamanho e
			a forma do plano e rasga um novo plano.</p>
			<p><b>Marque tool</b><img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem4.PNG')); ?>" alt="guia"> - Faz seleções quadradas ou retangulares, move ou clona seleções.</p>
			<p><b>Stamp tool</b><img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem5.PNG')); ?>" alt="guia"> - Pinta com uma amostra da imagem. Ao contrário da ferramenta Clone
			Stamp, a ferramenta Stamp no Vanishing Point não pode clonar elementos de outra imagem.</p>
			<p><b>Brush tool</b><img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem6.PNG')); ?>" alt="guia"> - Pinta uma cor selecionada em um plano.</p>
			<p><b>Transform tool</b><img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem7.PNG')); ?>" alt="guia"> - Escalona, gira e move uma seleção flutuante movendo as alças da
			caixa delimitadora. Seu comportamento é semelhante ao uso do comando Free Transform em uma seleção de retângulo.</p>
			<p><b>Eyedropper tool</b><img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem8.PNG')); ?>" alt="guia"> - Seleciona uma cor para pintar quando você clica na imagem de
			visualização.</p>
			<p><b>Measure tool</b><img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem9.PNG')); ?>" alt="guia"> - Mede distâncias e ângulos de um item em um plano. Ver também
			Measure in Vanishing Point</p>
			<p><b>Hand tool</b><img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem10.PNG')); ?>" alt="guia"> - Move a imagem na janela de visualização.</p>
			<p><b>Zoom tool</b><img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem11.PNG')); ?>" alt="guia"> - Amplia ou reduz a visualização da imagem na janela de visualização.
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit5/imagem12.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit5/imagem13.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<p>Vejamos algumas:</p>
			<p>• <b>Forward Warp tool</b> <img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem14.PNG')); ?>" alt="guia"> - Empurra os pixels para frente à medida que você
			arrasta.</p>
			<p>• <b>Reconstruct tool</b> <img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem15.PNG')); ?>" alt="guia"> - Inverte a distorção que você já adicionou, enquanto
			segura o botão do mouse e arrasta.</p>
			<p>• <b>Twirl Clockwise tool</b><img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem16.PNG')); ?>" alt="guia"> - Gira pixels no sentido horário, mantendo pressionado o botão do mouse ou arrastando. Para girar os pixels no sentido anti -horário,
			mantenha pressionada a tecla Alt enquanto mantém pressionado o botão do mouse ou
			arrasta.</p>
			<p>• <b>Pucker tool</b><img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem17.PNG')); ?>" alt="guia"> - Move os pixels em direção ao centro da área do pincel ao
			manter pressionado o botão do mouse ou arrastar.</p>
			<p>• <b>Bloat tool</b><img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem18.PNG')); ?>" alt="guia"> - Move os pixels para longe do centro da área do pincel ao manter pressionado o botão do mouse ou arrastar.</p>
			<p>• <b>Push Left tool</b><img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem19.PNG')); ?>" alt="guia"> - Move os pixels para a esquerda quando você arrasta a
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit5/imagem20.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			a ferramenta Freeze Mask <img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem21.PNG')); ?>" alt="guia">. Podemos também usar uma máscara existente,
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit5/imagem22.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit5/imagem23.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit5/imagem24.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit5/imagem25.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit5/imagem26.PNG')); ?>" alt="guia">
                </figure>
            </div>
			<h5 class="barlaw">Descongelar áreas</h5>
			<p>Para tornar áreas congeladas em editáveis, faça o seguinte:</p>
			<p>I. Selecione a ferramenta Thaw Mask <img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem27.PNG')); ?>" alt="guia"> e arraste sobre a área. Clique com a tecla Shift pressionada para descongelar em uma linha reta entre o ponto atual e o ponto
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit5/imagem28.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit5/imagem29.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<p><b>• Replace Selection</b> <img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem30.PNG')); ?>" alt="guia"> - Mostra a seleção, máscara ou transparência na imagem
			original.</p>
			<p><b>• Add To Selection</b> <img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem31.PNG')); ?>" alt="guia"> - Mostra a máscara na imagem original, para que você possa
			adicionar à seleção usando a ferramenta Freeze Mask.</p>
			<p><b>• Subtract From Selection</b> <img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem32.PNG')); ?>" alt="guia"> - Subtrai pixels no canal da área congelada atual.</p>
			<p><b>• Intersect With Selection</b> <img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem33.PNG')); ?>" alt="guia"> - Usa somente pixels selecionados e atualmente congelados.</p>
			<p><b>• Invert Selection</b> <img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit5/imagem34.PNG')); ?>" alt="guia"> - Utiliza pixels selecionados para inverter a área congelada
			atual.</p>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit5/imagem35.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit5/imagem36.PNG')); ?>" alt="guia">
                </figure>
            </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/unidade5/aula10.blade.php ENDPATH**/ ?>
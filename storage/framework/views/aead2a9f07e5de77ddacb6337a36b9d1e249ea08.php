<?php $__env->startSection('titulo','Corel Draw | Aula 15 – Rastrear Bitmaps'); ?>
...
de rastreio adequado e um estilo predefinido e, então, use os controles do PowerTRACE® para visualizar e ajustar os resultados rastreados.</p>    
            ...
            <div class="metade esquerda">
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula15/imagem1.jpg')); ?>" alt="guia" style="width:55%!important;" >
                </figure>
            </div>
            <div class="metade direita">
                ...
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula15/imagem2.jpg')); ?>" alt="guia">
                </figure>
                <p style="margin-top:10px"><strong> Rastreio por contorno</strong></p>
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula15/imagem3.jpg')); ?>" alt="guia">
                </figure>
                <p><strong> Rastreio por linha central</strong></p>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/corel-draw/aula32.blade.php ENDPATH**/ ?>
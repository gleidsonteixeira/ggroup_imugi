<?php $__env->startSection('titulo','Unit 3 | Aula 07 – Retoque e restauração de imagens'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila4" data-unidade="unidade3" data-etapa="aula7">
			<h3 class="barlow">UNIT 3</h3>
			<h5 class="barlow upper">Aula 07 – Retoque e restauração de imagens</h5>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit3/imagem1.PNG')); ?>" alt="guia">
                </figure>
            </div>
			<h5 class="barlaw">Spot Healing Brush tool<img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit3/imagem2.PNG')); ?>" alt="guia"></h5>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit3/imagem3.PNG')); ?>" alt="guia">
                </figure>
            </div>
			<h5 class="barlaw">Healing Brush tool<img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit3/imagem4.PNG')); ?>" alt="guia"></h5>
			...
			<h5 class="barlaw">Patch tool<img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit3/imagem5.PNG')); ?>" alt="guia"></h5>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit3/imagem6.PNG')); ?>" alt="guia">
                </figure>
            </div>
			<p>II. Em seguida, mover essa seleção para uma área que desejamos usar para clonar
			no lugar desta.</p>
			<h5 class="barlaw">Clone Stamp Tool<img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit3/imagem7.PNG')); ?>" alt="guia"></h5>
			...
			<p>Alinhado.<img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit3/imagem8.PNG')); ?>" alt="guia"></p>
			...
			<p>I. Acionar a ferramenta Crop na barra de ferramentas.<img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit3/imagem9.PNG')); ?>" alt="guia"></p>
			<p>II. Desenhar uma área usando as alças de dimensionamento para ajustar corretamente.</p>
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit3/imagem10.PNG')); ?>" alt="guia">
                </figure>
            </div>
			<p>III. Clicar no botão Commit Current Crop Operation <img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit3/imagem11.PNG')); ?>" alt="guia">, na barra de propriedades
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit3/imagem12.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit3/imagem13.PNG')); ?>" alt="guia">
                </figure>
            </div>
			<p>II. Clicar em Edit e escolher a opção Fill. Ou combinando as teclas SHIFT+F5.</p>
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit3/imagem14.PNG')); ?>" alt="guia">
                </figure>
            </div>
			<p>III. Na janela Fill, escolher Content-Aware no menu drop-down Contents.</p>
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit3/imagem15.PNG')); ?>" alt="guia">
                </figure>
            </div>
			<p>Observe o resultado:</p>
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit3/imagem16.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<p>I. Acionar a ferramenta Content Aware Move na barra de ferramentas.<img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit3/imagem17.PNG')); ?>" alt="guia"></p>
			<p>II. Desenhar uma seleção em volta da área que deseja mover para outra parte da
			imagem.</p>
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit3/imagem18.PNG')); ?>" alt="guia">
                </figure>
            </div>
			<p>III. Ainda com a ferramenta ativa, mover o conteúdo para a área desejada.</p>
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit3/imagem19.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit3/imagem20.PNG')); ?>" alt="guia">
                </figure>
            </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/unidade3/aula7.blade.php ENDPATH**/ ?>
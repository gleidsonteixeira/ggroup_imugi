<?php $__env->startSection('titulo','Unit 2 | Aula 2 – Ferramentas de Seleção e Recorte'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila4" data-unidade="unidade2" data-etapa="aula2">
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem1.png')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem2.png')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem3.png')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem4.png')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem5.png')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem6.png')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem7.png')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem8.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem9.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem10.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem11.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem12.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem13.PNG')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem14.PNG')); ?>" alt="guia">
                </figure>
            </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/unidade2/aula2.blade.php ENDPATH**/ ?>
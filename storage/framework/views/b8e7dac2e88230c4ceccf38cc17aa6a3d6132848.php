...
<?php $__env->startSection('titulo','Unit 8 | Aula 22 – Edição de vídeos II'); ?>
		...
		<div id="unidade" class="box" data-apostila="apostila4" data-unidade="unidade9" data-etapa="aula22">
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem35.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem36.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem37.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem38.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			<p style="margin-top:32px">
				• Na janela que surgir, certifique-se que o ícone do simbolo de vídeo <i><img class="iconex" src="<?php echo e(asset('assets/img/photoshop/unit9/icone6.png')); ?>" alt="guia"></i> econtra-se marcado. Isto lhe dará acesso aos controles deslizantes Duration e Speed. Arraste
				o controle deslizante Duration para definir a duração do vídeo
			</p>
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem39.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem40.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			<p style="margin-top:32px">
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem41.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			<p style="margin-top:32px">
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem42.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			<p style="margin-top:32px">
				Cada propriedade de camada tem um ícone de cronômetro Enable Keyframe Animation <i><img class="iconex" src="<?php echo e(asset('assets/img/photoshop/unit9/icone7.png')); ?>" alt="guia"></i>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem43.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			<p style="margin-top:32px">
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem44.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem45.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem46.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem47.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem48.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			<p style="margin-top:32px">
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem49.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem50.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem51.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			<p style="margin-top:32px">
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem52.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem53.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem54.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem55.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit9/imagem56.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/unidade9/aula22.blade.php ENDPATH**/ ?>
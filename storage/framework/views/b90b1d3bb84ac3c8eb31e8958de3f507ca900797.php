...
<main>
    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade14" data-etapa="grammar">
            ...
            <figure>
                <img src="<?php echo e(asset('assets/img/dominating/unit14/grammar.png')); ?>" alt="campeonato gamer">
            </figure>
        </div>
    </div>
</main>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila2/unidade14/grammar.blade.php ENDPATH**/ ?>
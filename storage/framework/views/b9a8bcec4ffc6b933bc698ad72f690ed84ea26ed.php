...
<?php $__env->startSection('titulo','Unit 27 | Texturas'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade27" data-etapa="texturas">
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit27/imagem_unit27_1.png')); ?>" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit27/imagem_unit27_2.png')); ?>" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit27/imagem_unit27_3.png')); ?>" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit27/imagem_unit27_4.png')); ?>" alt="guia1">
				</figure>
			</div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade27/texturas.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('titulo','Unit 10 | Understanding'); ?>
...
<!-- WRAPPER ALL -->
	...
	<main>
		...
		<div class="dashboard">
			<div id="unidade" class="box" data-apostila="apostila1" data-unidade="unidade10" data-etapa="understanding">
    ...
    <script>
        ...
        $("#unidade10understanding32").submit(function(e){
            e.preventDefault();
            $(this).find('button').prop('disabled', true);
            var respostas = '{';
            $('#unidade10understanding32 input[type="text"]').each(function(index){
                if(($('#unidade10understanding32 input[type="text"]').length - 1) == index){
                    respostas += '"'+$(this).attr("name")+'":"'+$(this).val()+'"}';
                }else{
                    respostas += '"'+$(this).attr("name")+'":"'+$(this).val()+'",';
                }
            });
            if($('#unidade10understanding32 input[name="resposta_id"').val() != 0){
                atualizarAtividade($('#unidade10understanding32'), respostas);
            }else{
                enviarAtividade($('#unidade10understanding32'), respostas);
            }
        });
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila1/unidade10/understanding.blade.php ENDPATH**/ ?>
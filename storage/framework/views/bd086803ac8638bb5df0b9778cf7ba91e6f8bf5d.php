...
<?php $__env->startSection('titulo','Unit 15 | EXPRESSIONS'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila6" data-unidade="unidade15" data-etapa="expressions">
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit15/imagem_unit15_1.png')); ?>" alt="guia1">
				</figure>
			</div><br>
			<p>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit15/imagem_unit15_2.png')); ?>" alt="guia1">
				</figure>
			</div><br>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit15/imagem_unit15_3.png')); ?>" alt="guia1">
				</figure>
			</div><br>
			<p>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila6/unidade15/expressions.blade.php ENDPATH**/ ?>
<?php $__env->startSection('titulo','Corel Draw | Aula 2 – Recursos básicos do Corel Draw'); ?>
		...
		<div id="unidade" class="box" data-apostila="photoshop-corel" data-unidade="unidade2" data-etapa="aula19">
            ...
            <div class="umquarto">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula02/imagem1.png')); ?>" alt="guia" style="width:25%!important;" >
                </figure>
            </div>
            <div class="metade esquerda">
                ...
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula02/imagem2.png')); ?>" alt="guia" >
                </figure>
...
serviços gráficos.</p>
        ...
        <p style="margin-top:16px;">Controles básicos ao utilizar a ferramenta seleção</p>
            <div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula02/imagem3.png')); ?>" alt="guia">
                </figure>
...
<figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula02/imagem4.png')); ?>" alt="guia">
                </figure>
            </div>
            <div style="margin-top:16px;">
...
<figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula02/imagem5.png')); ?>" alt="guia">
                </figure>
...
<figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula02/imagem6.png')); ?>" alt="guia">
                </figure>
            </div>
            ...
            <div class="umquarto">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula02/imagem7.png')); ?>" alt="guia">
                </figure>
            </div>
            <div class="metade esquerda">
                <div style="margin-top:16px">
...
pressionada a tecla Shift .</p>
            <div class="umquarto">
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula02/imagem8.png')); ?>" alt="guia" style="width:90%;">
                </figure>
            </div>
            <div class="metade esquerda">
                <div style="margin-top:16px">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/corel-draw/aula19.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('titulo','Unit 4 | Criando Objetos'); ?>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade4" data-etapa="criando_objetos">
			...
			<div class="container">
				...
				<div>
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit4/imagem_unit4_04.png')); ?>" alt="guia4">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit4/imagem_unit4_05.png')); ?>" alt="guia5">
					</figure>
				</div>
				<br>
				<p>
				...
				<div class="esquerda">
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit4/imagem_unit4_06.png')); ?>" alt="guia6">
					</figure>
				</div>
				<div class="clear"></div>
				<p>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade4/criando_objetos.blade.php ENDPATH**/ ?>
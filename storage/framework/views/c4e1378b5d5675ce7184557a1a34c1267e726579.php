		...
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade1" data-etapa="apresentacao">
			...
			<div>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/games_and_animation/unit1/imagem_unit1_01.png')); ?>" alt="guia1">
                </figure>
			</div>
			<p>
			...
			<div class="caixa2">
                <figure>
                    <img src="<?php echo e(asset('assets/img/games_and_animation/unit1/imagem_unit1_02.png')); ?>" alt="guia2">
                </figure>
			</div>
			<p>
			...
			<div class="caixa2">
                <figure>
                    <img  src="<?php echo e(asset('assets/img/games_and_animation/unit1/imagem_unit1_03.png')); ?>" alt="guia3">
                </figure>
			</div>
		</div>
    </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade1/apresentacao.blade.php ENDPATH**/ ?>
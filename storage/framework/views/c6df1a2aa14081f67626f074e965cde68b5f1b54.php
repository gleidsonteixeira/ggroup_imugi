...
<?php $__env->startSection('titulo','Unit 2 | Aula 06 – Blending modes e máscara de corte'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila4" data-unidade="unidade2" data-etapa="aula6">
			<h3 class="barlow">UNIT 2</h3>
			<h5 class="barlow upper">Aula 06 – Blending modes e máscara de corte</h5>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem100.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem101.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem102.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem103.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem104.PNG')); ?>" alt="guia">
                </figure>
            </div>
			<p>Em seguida, posicione o cursor na linha entre as duas camadas e ao aparecer o ícone,
			<img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit2/imagem105.PNG')); ?>" alt="guia">clique com o botão esquerdo do mouse.</p>
			...
			<p><img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit2/imagem106.PNG')); ?>" alt="guia">. E em seguida clicando no botão This adjustment clips to the Layer.</p>
			<p><img style="display: inline;" src="<?php echo e(asset('assets/img/photoshop/unit2/imagem107.PNG')); ?>" alt="guia">.</p>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem108.PNG')); ?>" alt="guia">
                </figure>
            </div>
			...
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem109.PNG')); ?>" alt="guia">
                </figure>
            </div>
			<p>V. Escolha Panorama para um ajuste automático que combine as duas imagens.</p>
			<div style="margin-top:16px">
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit2/imagem110.PNG')); ?>" alt="guia">
                </figure>
            </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/unidade2/aula6.blade.php ENDPATH**/ ?>
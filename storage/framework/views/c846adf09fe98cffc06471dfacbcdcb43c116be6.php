...
<?php $__env->startSection('titulo','Unit 43 | Grammar'); ?>
    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade43" data-etapa="grammar">
            ...
            <audio controls="" controlslist="nodownload" class="suave">
                <source src="<?php echo e(asset('assets/audio/apostila2/UNIT 43/3. GRAMMAR/GRAMMAR.ogg')); ?>" type="audio/ogg">
            </audio>
            <div class="clear"></div>
            ...
            <figure class="umterco">
                <img src="<?php echo e(asset('assets/img/dominating/unit43/grammar1.png')); ?>" alt="Garotos festejando">
            </figure>
            <figure class="umterco">
                <img src="<?php echo e(asset('assets/img/dominating/unit43/grammar2.png')); ?>" alt="Garotos festejando">
            </figure>
            <figure class="umterco">
                <img src="<?php echo e(asset('assets/img/dominating/unit43/grammar3.png')); ?>" alt="Garotos festejando">
            </figure>
            <div class="clear"></div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila2/unidade43/grammar.blade.php ENDPATH**/ ?>
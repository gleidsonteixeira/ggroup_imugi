...
<!-- WRAPPER ALL -->
    ...
    <script>
        ...
        $("#unidade20understanding56").submit(function(e){
            e.preventDefault();
            $(this).find('button').prop('disabled', true);
            var respostas = '{';
            $('#unidade20understanding56 input[type="text"]').each(function(index){
                if(($('#unidade20understanding56 input[type="text"]').length - 1) == index){
                    respostas += '"'+$(this).attr("name")+'":"'+$(this).val()+'"}';
                }else{
                    respostas += '"'+$(this).attr("name")+'":"'+$(this).val()+'",';
                }
            });
            if($('#unidade20understanding56 input[name="resposta_id"').val() != 0){
                atualizarAtividade($('#unidade20understanding56'), respostas);
            }else{
                enviarAtividade($('#unidade20understanding56'), respostas);
            }
        });
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila1/unidade20/understanding.blade.php ENDPATH**/ ?>
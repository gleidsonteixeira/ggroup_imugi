...
<?php $__env->startSection('titulo','Unit 47 | Grammar'); ?>
...
<main>
    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade47" data-etapa="grammar">
            ...
            <figure>
				<img src="<?php echo e(asset('assets/img/dominating/unit47/grammar.png')); ?>" alt="preocupada">
            </figure>
            <div class="clear"></div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila2/unidade47/grammar.blade.php ENDPATH**/ ?>
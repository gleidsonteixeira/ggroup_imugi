...
<main>
    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade25" data-etapa="grammar">
            ...
            <figure>
                <img src="<?php echo e(asset('assets/img/dominating/unit25/grammar.png')); ?>" alt="guarda-chuva">
            </figure>
            <div class="clear"></div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila2/unidade25/grammar.blade.php ENDPATH**/ ?>
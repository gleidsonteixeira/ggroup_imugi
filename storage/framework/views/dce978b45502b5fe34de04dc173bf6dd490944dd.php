...
<h5 class="barlow">Conheça alguns Mods da Unity:</h5>
                <figure>
                    <img src="<?php echo e(asset('assets/img/games_and_animation/unity/intro/imagem1.png')); ?>" alt="guia" style="width:95%!important; margin: 0 auto;" >
                </figure>
				<figure>
                    <img src="<?php echo e(asset('assets/img/games_and_animation/unity/intro/imagem2.png')); ?>" alt="guia" style="width:95%!important; margin: 0 auto;" >
                </figure>
					</div>
				</div>
			</div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/intro-unity/intro.blade.php ENDPATH**/ ?>
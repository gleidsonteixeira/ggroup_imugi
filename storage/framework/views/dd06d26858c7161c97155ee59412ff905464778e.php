	...
	<main>
		...
		<div class="dashboard">
			<div id="unidade" class="box" data-apostila="apostila1" data-unidade="unidade7" data-etapa="understanding">
                ...
                <div class="metade">
                    <figure>
                        <img src="<?php echo e(asset('assets/img/playgo/unit7/U7.jpg')); ?>" alt="">
                    </figure>
                </div>
			</div>
		</div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila1/unidade7/understanding.blade.php ENDPATH**/ ?>
<?php $__env->startSection('titulo','Unit 41 | Tilemap Collider'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade41" data-etapa="tilemap_collider">
            ...
            <figure>
	<img src="<?php echo e(asset('assets/img/games_and_animation/unity/unit41/imagem12.png')); ?>" alt="guia1" style="width:45%;">
</figure>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade41/tilemap_collider.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('titulo','Unit 5 |  Alteração do tempo e Camera Lenta'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila6" data-unidade="unidade5" data-etapa="tempo_camera">
			...
			<div class="container">
					<figure>
							<img src="<?php echo e(asset('assets/img/video_edition/unit5/imagem_unit5_15.png')); ?>" alt="guia1">
					</figure>
			</div>
			...
			<div class="container">
					<figure>
							<img src="<?php echo e(asset('assets/img/video_edition/unit5/imagem_unit5_16.png')); ?>" alt="guia1">
					</figure>
			</div>
			<p>
			...
			<p>
				...
				<img style="display: inline-block;" src="<?php echo e(asset('assets/img/video_edition/unit5/imagem_unit5_17.png')); ?>" alt="guia">
			...
			<p>
				...
				<img style="display: inline-block;" src="<?php echo e(asset('assets/img/video_edition/unit5/imagem_unit5_18.png')); ?>" alt="">
				...
				<p>
					...
					<div class="container">
					<figure>
							<img src="<?php echo e(asset('assets/img/video_edition/unit5/imagem_unit5_19.png')); ?>" alt="guia1">
					</figure>
			</div>
			<p>
				...
				<div class="container">
					<figure>
							<img src="<?php echo e(asset('assets/img/video_edition/unit5/imagem_unit5_20.png')); ?>" alt="guia1">
					</figure>
			</div>
			<h5>Twixtor</h5>
				<p>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila6/unidade5/tempo_camera.blade.php ENDPATH**/ ?>
<?php $__env->startSection('titulo','Corel Draw | Aula 10 – Preenchimentos e transparências'); ?>
		...
		<div id="unidade" class="box" data-apostila="photoshop-corel" data-unidade="unidade2" data-etapa="aula27">
            ...
            <h5 class="barlow">Aula 10 – Preenchimentos e transparências </h5>
                <figure style="margin-bottom:40px;">
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula10/imagem1.jpg')); ?>" alt="guia" style="width:75%!important; margin: 0 auto;" >
                </figure>
...
<figure style="margin-bottom:40px;">
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula10/imagem2.jpg')); ?>" alt="guia" style="width:75%!important; margin: 0 auto;" >
                </figure>
...
colunas e linhas da grade e também os pontos de interseção contidos na grade.
                ...
                <figure style="margin-bottom:40px;">
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula10/imagem3.jpg')); ?>" alt="guia" style="width:75%!important; margin: 0 auto;" >
                </figure>
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula10/imagem4.jpg')); ?>" alt="guia" style="width:95%!important; margin: 0 auto;" >
                </figure>
                <figure style="margin-top:20px;">
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula10/imagem5.jpg')); ?>" alt="guia" style="width:95%!important; margin: 0 auto;" >
                </figure>
...
e linhas. Utilizando os proenchimentos crie alguns modelos e adicione ao objeto criado no exercicio anterior.</p>
            ...
            <div class="metade esquerda">
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula10/imagem6.jpg')); ?>" alt="guia" style="width:75%!important;" >
                </figure>
            </div>
...
uma foto em preto e branco.</p>
            ...
            <div class="metade esquerda">
                <figure>
                    <img src="<?php echo e(asset('assets/img/photoshop/corel/aula10/imagem7.jpg')); ?>" alt="guia" style="width:65%!important;" >
                </figure>
            </div>
            <div class="metade direita">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/corel-draw/aula27.blade.php ENDPATH**/ ?>
...
<main>
    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade19" data-etapa="understanding">
            ...
            <form class="metade" id="unidade19understanding185" method="post">
                ...
                <input type="hidden" name="atividade_id" value="185">
...
<script>
    ...
    $("#unidade19understanding185").submit(function(e) {
        e.preventDefault();
        $(this).find('button').prop('disabled', true);
        var respostas = '{';
        $('#unidade19understanding185 input[type="text"]').each(function(index) {
            if (($('#unidade19understanding185 input[type="text"]').length - 1) == index) {
                respostas += '"' + $(this).attr("name") + '":"' + $(this).val() + '"}';
            } else {
                respostas += '"' + $(this).attr("name") + '":"' + $(this).val() + '",';
            }
        });
        if ($('#unidade19understanding185 input[name="resposta_id"').val() != 0) {
            atualizarAtividade($('#unidade19understanding185'), respostas);
        } else {
            enviarAtividade($('#unidade19understanding185'), respostas);
        }
    });
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila2/unidade19/understanding.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('titulo','Unit 05 | Conversation'); ?>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila3" data-unidade="unidade5" data-etapa="conversation">
			...
			<audio controls="" controlslist="nodownload" class="suave">
                <source src="<?php echo e(asset('assets/audio/apostila3/LESSON 05/02_CONVERSATION/CONVERSATION_05.mp3')); ?>" type="audio/mp3">
            </audio>
			<div class="clear"></div>
			...
			<div style="margin-top: 36px">
				<figure>
					<img src="<?php echo e(asset('assets/img/masteroflanguage/unit5/conversation.png')); ?>" alt="design">
				</figure>
			</div>
		</div>
	</div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila3/unidade5/conversation.blade.php ENDPATH**/ ?>
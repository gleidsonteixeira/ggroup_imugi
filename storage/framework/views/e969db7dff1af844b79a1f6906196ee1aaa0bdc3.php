...
<?php $__env->startSection('titulo','Unit 3 | Cinema 4D'); ?>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade3" data-etapa="cinema_4D">
			...
			<div class="conteiner">
				...
				<div>
					<figure class="caixa2">
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit3/imagem_unit3_01.png')); ?>" alt="guia1">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure class="caixa2">
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit3/imagem_unit3_02.png')); ?>" alt="guia2">
					</figure>
				</div>
				<p class="elemento">
				...
				<div class="elemento3">
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit3/imagem_unit3_03.png')); ?>" alt="guia3">
					</figure>
				</div>
				<div class="clear"></div>
				<div>
					<figure class="caixa2">
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit3/imagem_unit3_04.png')); ?>" alt="guia4">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure class="caixa2">
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit3/imagem_unit3_05.png')); ?>" alt="guia5">
					</figure>
				</div>
			</div>
		</div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade3/cinema_4D.blade.php ENDPATH**/ ?>
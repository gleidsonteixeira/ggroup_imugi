...
<?php $__env->startSection('titulo','Unit 4 | Correção de Cores'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila6" data-unidade="unidade4" data-etapa="correcao_de_cores">
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit4/imagem_unit4_13.png')); ?>" alt="Wave Form do áudio">
				</figure>
			</div><br>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit4/imagem_unit4_14.png')); ?>" alt="Wave Form do áudio">
				</figure>
			</div><br>
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit4/imagem_unit4_15.png')); ?>" alt="Wave Form do áudio">
				</figure>
			</div><br>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit4/imagem_unit4_16.png')); ?>" alt="Wave Form do áudio">
				</figure>
			</div><br>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit4/imagem_unit4_17.png')); ?>" alt="painel Lumetri Color">
				</figure>
			</div><br>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit4/imagem_unit4_18.png')); ?>" alt="menu Blend Mode">
				</figure>
			</div><br>
			<p>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit4/imagem_unit4_19.png')); ?>" alt="Adjustment Layer">
				</figure>
			</div><br>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila6/unidade4/correcao_de_cores.blade.php ENDPATH**/ ?>
<?php $__env->startSection('titulo','Unit 5 | Understanding'); ?>
		...
		<div class="dashboard">
			<div id="unidade" class="box" data-apostila="apostila1" data-unidade="unidade5" data-etapa="understanding">
                ...
                <div class="metade">
                    <form id="unidade5understanding20" method="post">
                        <p>
                            ...
                            <input type="text" name="understanding20-1" class="full left-align" placeholder="Responda aqui" required>
                        </p>
                        <p>
                            2 -  Does Beatriz know what the tool is used for?<br>
                            <input type="text" name="understanding20-2" class="full left-align" placeholder="Responda aqui" required>
                        </p>
                        <p>
                            3 -  What is Burn tool used for?<br>
                            <input type="text" name="understanding20-3" class="full left-align" placeholder="Responda aqui" required>
                        </p>
                        <p>
                            4 - Who knows what Burn tool is?<br>
                            <input type="text" name="understanding20-4" class="full left-align" placeholder="Responda aqui" required>
                        </p>
                        <p>
                            5 - What does the tool balance?<br>
                            <input type="text" name="understanding20-5" class="full left-align" placeholder="Responda aqui" required>
                        </p>
                        <p>
                            6 - What picture does Kate need to edit the contrast?<br>
                            <input type="text" name="understanding20-6" class="full left-align" placeholder="Responda aqui" required>
                        </p>
                        <p>
                            7 - What is the problem with Kate’s picture?<br>
                            <input type="text" name="understanding20-7" class="full left-align" placeholder="Responda aqui" required>
                        </p>
                        <p>
                            8 - In what situation do you recommend the use of Burn Tool?<br>
                            <input type="text" name="understanding20-8" class="full left-align" placeholder="Responda aqui" required>
                        </p>
                        <p>
                            9 - Do you know how to use Burn Tool?<br>
                            <input type="text" name="understanding20-9" class="full left-align" placeholder="Responda aqui" required>
                        </p>
                ...
                <div class="metade" style="margin-top: 36px">
					<figure>
						<img src="<?php echo e(asset('assets/img/playgo/unit5/pagina-1.png')); ?>" alt="Garotos festejando">
					</figure>
				</div>
			</div>
		</div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila1/unidade5/understanding.blade.php ENDPATH**/ ?>
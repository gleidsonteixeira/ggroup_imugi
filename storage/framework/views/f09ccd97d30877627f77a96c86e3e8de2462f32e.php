...
<?php $__env->startSection('titulo','Unit 13 | After Effects CC - PARTÍCULAS'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila6" data-unidade="unidade13" data-etapa="particulas">
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit13/imagem_1_unit13.png')); ?>" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit13/imagem_2_unit13.png')); ?>" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit13/imagem_3_unit13.png')); ?>" alt="guia1">
				</figure>
			</div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila6/unidade13/particulas.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('titulo','Unit 19 | Renderização - Propriedades'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade19" data-etapa="renderizacao_propriedades">
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit19/imagem_unit19_1.png')); ?>" alt="guia1">
				</figure>
			</div>
			<p>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/games_and_animation/unit19/imagem_unit19_2.png')); ?>" alt="guia2">
				</figure>
			</div>
			<p>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade19/renderizacao_propriedades.blade.php ENDPATH**/ ?>
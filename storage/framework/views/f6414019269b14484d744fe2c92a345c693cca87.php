...
<?php $__env->startSection('titulo','Unit 7 | After Effects CC - ANIMAÇÃO BÁSICA'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila6" data-unidade="unidade7" data-etapa="animacao_basica">
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit7/imagem_unit7_5.png')); ?>" alt="guia1">
				</figure>
			</div>
			...
			<div class="container">
				<figure>
					<img src="<?php echo e(asset('assets/img/video_edition/unit7/imagem_unit7_6.png')); ?>" alt="guia1">
				</figure>
			</div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila6/unidade7/animacao_basica.blade.php ENDPATH**/ ?>
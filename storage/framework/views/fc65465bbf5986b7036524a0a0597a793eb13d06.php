...
<?php $__env->startSection('titulo','Unit 12 | Animação para jogos'); ?>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila5" data-unidade="unidade12" data-etapa="animacao_jogos">
			...
			<div class="container">
				...
				<div>
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit12/imagem_unit12_1.png')); ?>" alt="guia1">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit12/imagem_unit12_2.png')); ?>" alt="guia2">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit12/imagem_unit12_3.png')); ?>" alt="guia3">
					</figure>
				</div>
				<p>
				...
				<div>
					<figure>
						<img src="<?php echo e(asset('assets/img/games_and_animation/unit12/imagem_unit12_4.png')); ?>" alt="guia4">
					</figure>
				</div>
				<p><b>Menus</b></p>
				<p>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila5/unidade12/animacao_jogos.blade.php ENDPATH**/ ?>
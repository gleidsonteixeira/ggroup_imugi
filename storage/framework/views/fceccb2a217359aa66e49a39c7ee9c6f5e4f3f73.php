...
<?php $__env->startSection('titulo','Unit 7 | Aula 16 - Mockups'); ?>
...
<main>
	...
	<div class="dashboard">
		<div id="unidade" class="box" data-apostila="apostila4" data-unidade="unidade7" data-etapa="aula16">
			<h3 class="barlow">UNIT 7</h3>
			<h5 class="barlow upper">Aula 16 – Mockups</h5>
			...
			<div style=margin-top:16px>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit7/imagem11.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style=margin-top:16px>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit7/imagem12.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style=margin-top:16px>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit7/imagem13.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style=margin-top:16px>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit7/imagem14.png')); ?>" alt="guia">
				</figure>
				<figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit7/imagem15.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style=margin-top:16px>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit7/imagem16.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style=margin-top:16px>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit7/imagem17.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div>
			...
			<div style=margin-top:16px>
                <figure class="otimizarimagem">
                    <img src="<?php echo e(asset('assets/img/photoshop/unit7/imagem18.png')); ?>" alt="guia">
                </figure>
            </div>
			<div class="clear"></div> 
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila4/unidade7/aula16.blade.php ENDPATH**/ ?>
      ...
      <div class="footer-widget-area padding-five-top padding-30px-bottom sm-padding-30px-top" id="footer">
          <div class="container">
              <div class="row">
                  <!-- start about -->
                  <div
                      class="col-lg-2 col-md-6 widget md-margin-30px-bottom text-center text-md-left last-paragraph-no-margin">
                      <div
                  ...
                  <div class="col-lg-2 col-md-6 widget md-margin-30px-bottom">
                      <ul class="latest-post position-relative">
                          ...
                          <li class="media">
                              <a href="<?php echo e(route('privacidade')); ?>" class="text-white menu_rodape">Política de
                                  privacidade</a>
                          </li>
                      </ul>
                  </div>
                      ...
                      <ul class="latest-post position-relative">
                          ...
                          <li class="media mt-4">
                              <span class="text-white">Baixe nosso app <br>
                                  <a href="https://play.google.com/store/apps/details?id=com.pombocriativo.imugi"
                                      target="_blank">
                                      <img src="<?php echo e(asset('assets/site/images/play_store.png')); ?>" alt=""
                                          class="icone_play_footer">
                                  </a>
                              </span>
                          </li>
                      </ul>
      ...
      <div style="background-color: #1e570e;" class="">
          <div class="container">
              <div class="footer-bottom">
                  <div class="row">
                      <!-- start copyright -->
                      <div class="col-lg-12 col-md-12 text-small text-center text-white" style="padding: 10px;"> &copy;
                          Copyright Imugi. Todos os
                          direitos reservados
                      </div>
                  </div>
              </div>
  ...
  <div class="termos" style="width: 90%;padding: 16px;box-sizing: border-box;position: fixed;bottom: 36px;left: 5%;background-color: #FFFFFF;border-radius: 10px;z-index: 1000;display: none;">
    <p style="color: #999999; margin: 0;">Ao clicar em "Aceitar cookies", você concorda com o armazenamento de cookies no seu
          dispositivo para melhorar a navegação no site, analisar o uso do site e ajudar em nossos esforços de
          marketing.</p>
    <button style="background-color: #7aba17;color: white;padding: 0 26px;border-radius: 5px;line-height: 40px;margin-top: 16px;border: 0;cursor: pointer;">Aceitar cookies</button>
  </div>
    <script>
  ...
  <!-- end scroll to top  --><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/layouts/site/footer.blade.php ENDPATH**/ ?>
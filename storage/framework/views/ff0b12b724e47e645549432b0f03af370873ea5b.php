...
<?php $__env->startSection('titulo','Unit 48 | Grammar'); ?>
...
<main>
    ...
    <div class="dashboard">
        <div id="unidade" class="box" data-apostila="apostila2" data-unidade="unidade48" data-etapa="grammar">
            ...
            <figure>
                <img src="<?php echo e(asset('assets/img/dominating/unit48/grammar.png')); ?>" alt="titanic">
            </figure>
            <div class="clear"></div>
            ...
            <figure class="metade esquerda">
                <img src="<?php echo e(asset('assets/img/dominating/unit48/grammar1.png')); ?>" alt="dança">
            </figure>
            <figure class="metade direita">
                <img src="<?php echo e(asset('assets/img/dominating/unit48/grammar2.png')); ?>" alt="coral">
            </figure>
            <div class="clear"></div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/imugi270/site.imugi.com.br/resources/views/apostila2/unidade48/grammar.blade.php ENDPATH**/ ?>